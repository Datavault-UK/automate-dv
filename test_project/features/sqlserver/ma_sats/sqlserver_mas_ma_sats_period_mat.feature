...
############################### CYCLE TESTS ###################################
  ...
  Scenario: [SAT-PERIOD-MAT-BASE-CYCLE] Loading in cycles: waterlevel + identical data into a satellite with one value in rank column
  ...
  @fixture.multi_active_satellite_cycle_sqlserver
  Scenario: [SAT-PERIOD-MAT-BASE-CYCLE-TS] Loading in cycles: waterlevel + identical data into a satellite with one value in rank column
    ...
    When the RAW_STAGE_TS is loaded
      ...
      | 1004        | Dom           | 17-214-233-1217 | 1993-01-01 11:14:54.393 | 1993-01-01 11:14:54.393 | *      |
