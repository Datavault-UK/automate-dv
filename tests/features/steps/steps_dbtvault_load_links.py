...
def step_impl(context):
    context.dbutils.create_schema("DV_PROTOTYPE_DB", "DEMO_TEST_STG")
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_customer_links",
    ...
    context.dbutils.insert_data_from_ct(context.table, "test_stg_customer_links", "DEMO_TEST_STG")


@step("I have an empty LINK_CUSTOMER_NATION table")
def step_impl(context):
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_VLT", "test_link_customer_nation",
...
def step_impl(context):
    context.dbutils.create_schema("DV_PROTOTYPE_DB", "DEMO_TEST_VLT")
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_VLT", "test_link_customer_nation",
                                    ["CUSTOMER_NATION_PK BINARY(16)", "CUSTOMER_FK BINARY(16)", "NATION_FK BINARY(16)",
                                     "LOADDATE DATE", "SOURCE VARCHAR(4)"], connection=context.connection)

    context.dbutils.insert_data_from_ct(context.table, "test_link_customer_nation", "DEMO_TEST_VLT")
...
def step_impl(context):
    ...
    result_df = context.dbutils.get_table_data(full_table_name="DV_PROTOTYPE_DB.DEMO_TEST_VLT.test_link_customer_nation",
                                               binary_columns=['CUSTOMER_NATION_PK', 'CUSTOMER_FK', 'NATION_FK'],
                                               order_by='CUSTOMER_NATION_PK', ignore_columns='SOURCE',
...
def step_impl(context):
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_VLT", "test_link_customer_nation_union",
                                    ["CUSTOMER_NATION_PK BINARY(16)", "CUSTOMER_FK BINARY(16)", "NATION_FK BINARY(16)",
                                     "LOADDATE DATE", "SOURCE VARCHAR(4)"], connection=context.connection)
...
def step_impl(context):
    context.dbutils.create_schema("DV_PROTOTYPE_DB", "DEMO_TEST_STG")
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_sap_customer",
                                    ["CUSTOMER_ID VARCHAR(38)", "NATION_ID VARCHAR(38)", "CUSTOMER_NAME VARCHAR(25)",
                                     "CUSTOMER_DOB DATE", "CUSTOMER_PHONE VARCHAR(15)", "LOADDATE DATE",
                                     "SOURCE VARCHAR(15)"], connection=context.connection)
    context.dbutils.insert_data_from_ct(context.table, "test_stg_sap_customer", "DEMO_TEST_STG")


@step("there are records in the TEST_STG_CRM_CUSTOMER table")
def step_impl(context):
    context.dbutils.create_schema("DV_PROTOTYPE_DB", "DEMO_TEST_STG")
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_crm_customer",
                                    ["CUSTOMER_REF VARCHAR(38)", "NATION_KEY VARCHAR(38)", "CUSTOMER_NAME VARCHAR(25)",
                                     "CUSTOMER_DOB DATE", "CUSTOMER_PHONE VARCHAR(15)", "LOADDATE DATE",
                                     "SOURCE VARCHAR(15)"], connection=context.connection)
    context.dbutils.insert_data_from_ct(context.table, "test_stg_crm_customer", "DEMO_TEST_STG")


@step("there are records in the TEST_STG_WEB_CUSTOMER table")
def step_impl(context):
    context.dbutils.create_schema("DV_PROTOTYPE_DB", "DEMO_TEST_STG")
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_web_customer",
                                    ["CUSTOMER_REF VARCHAR(38)", "NATION_KEY VARCHAR(38)", "CUSTOMER_NAME VARCHAR(25)",
                                     "CUSTOMER_DOB DATE", "CUSTOMER_PHONE VARCHAR(15)", "LOADDATE DATE",
                                     "SOURCE VARCHAR(15)"], connection=context.connection)
    context.dbutils.insert_data_from_ct(context.table, "test_stg_web_customer", "DEMO_TEST_STG")
...
def step_impl(context):
    ...
    context.dbutils.insert_data_from_ct(context.table, "test_link_customer_nation_union", "DEMO_TEST_VLT")
...
def step_impl(context):
    ...
    result_df = context.dbutils.get_table_data(full_table_name="DV_PROTOTYPE_DB.DEMO_TEST_VLT."
