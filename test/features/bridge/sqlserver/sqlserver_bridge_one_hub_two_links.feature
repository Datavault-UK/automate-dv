Feature: [SQLS-BRG-2L] Bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-01] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-02] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-03] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-04] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-05] Base load into a bridge table
