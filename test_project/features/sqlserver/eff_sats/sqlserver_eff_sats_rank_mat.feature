@fixture.set_workdir
Feature: Effectivity Satellites Loaded using Rank Materialization (sqlserver)

  @fixture.eff_satellite_sqlserver
  Scenario: [EFF-SAT-RANK-MAT-BASE] Load data into a non-existent effectivity satellite
  ...
  @fixture.eff_satellite_sqlserver
  Scenario: [EFF-SAT-RANK-MAT-BASE] Load data into an empty effectivity satellite
