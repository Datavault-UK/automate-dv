Feature: [SF-PIT-2SI] Point in Time
  ...
  Scenario: [SF-PIT-2SI-01] Incremental load with the more recent AS OF dates into an already populated pit table from two satellites with dates
  ...
  # TIMESTAMPS
  @fixture.pit_two_sats
  Scenario: [SF-PIT-2SI-02] Incremental load with the more recent AS OF timestamps into an already populated pit table from two satellites with timestamps
  ...
  @fixture.pit_two_sats
  Scenario: [SF-PIT-2SI-03] Incremental load with the more recent AS OF dates into an already populated pit table from two satellites with timestamps
  ...
  @fixture.pit_two_sats
  Scenario: [SF-PIT-2SI-04] Incremental load with the more recent AS OF timestamps into an already populated pit table from two satellites with dates
