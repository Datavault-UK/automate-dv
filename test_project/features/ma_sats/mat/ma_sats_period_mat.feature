...
############################### CYCLE TESTS ###################################
  ...
  Scenario: [SAT-RANK-MAT-BASE-CYCLE] Loading in cycles: waterlevel + identical data into a satellite with one value in rank column
...
#    And I insert by period into the MULTI_ACTIVE_SATELLITE_TS ma_sat by day with date range: 1993-01-01 to 1993-01-02 and LDTS LOAD_DATETIME
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [SAT-RANK-MAT-BASE-CYCLE-TS-02] Loading in cycles: waterlevel + identical data into a satellite with one value in rank column
    With date like datetime stamps
    Given the RAW_STAGE_TS stage is empty
    And the MULTI_ACTIVE_SATELLITE_TS ma_sat is empty
    ...
    When the RAW_STAGE_TS is loaded
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | EFFECTIVE_FROM          | LOAD_DATETIME           | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | 1001        | Alice         | 17-214-233-1224 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | 1002        | Bob           | 17-214-233-1215 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | 1003        | Chad          | 17-214-233-1216 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | 1004        | Dom           | 17-214-233-1217 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | 1004        | Dom           | 17-214-233-1217 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
    And I create the STG_CUSTOMER_TS stage
    And I insert by period into the MULTI_ACTIVE_SATELLITE_TS ma_sat by day with date range: 1993-01-01 to 1993-01-02 and LDTS LOAD_DATETIME
...
#    And I insert by period into the MULTI_ACTIVE_SATELLITE_TS ma_sat by day with date range: 1993-01-01 to 1993-01-02 and LDTS LOAD_DATETIME
    ...
    Then the MULTI_ACTIVE_SATELLITE_TS table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                | CUSTOMER_NAME | CUSTOMER_PHONE  | EFFECTIVE_FROM          | LOAD_DATETIME           | SOURCE |
      | md5('1001') | md5('1001\|\|ALICE\|\|17-214-233-1214') | Alice         | 17-214-233-1214 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | md5('1002') | md5('1002\|\|BOB\|\|17-214-233-1215')   | Bob           | 17-214-233-1215 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | md5('1003') | md5('1003\|\|CHAD\|\|17-214-233-1216')  | Chad          | 17-214-233-1216 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | md5('1004') | md5('1004\|\|DOM\|\|17-214-233-1217')   | Dom           | 17-214-233-1217 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |
      | md5('1001') | md5('1001\|\|ALICE\|\|17-214-233-1224') | Alice         | 17-214-233-1224 | 1993-01-01 00:00:00.000 | 1993-01-01 00:00:00.000 | *      |

  @fixture.multi_active_satellite_cycle
  Scenario: [SAT-RANK-MAT-BASE-CYCLE-TS-03] Loading in cycles: waterlevel + identical data into a satellite with one value in rank column
    Given the RAW_STAGE_TS stage is empty
    And the MULTI_ACTIVE_SATELLITE_TS ma_sat is empty
