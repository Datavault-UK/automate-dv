Feature: [SF-EFF-AU-INC] Effectively satellites, further incremental testing
  ...
  Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
    ...
    | md5('3001\|\|CCC') | md5('3001') | md5('CCC') | 2020-01-09 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-11 00:00:00.000     | 2020-01-12 00:00:00.000 | orders |
    | md5('4000\|\|DDD') | md5('4000') | md5('DDD') | 2020-01-10 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-10 00:00:00.000     | 2020-01-11 00:00:00.000 | orders |
  ...
  Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
    ...
    | md5('2001\|\|BBB') | md5('2001') | md5('BBB') | 2020-01-09 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-10 00:00:00.000     | 2020-01-10 00:00:00.000 | orders |
    | md5('3000\|\|CCC') | md5('3000') | md5('CCC') | 2020-01-09 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-09 00:00:00.000     | 2020-01-09 00:00:00.000 | orders |
  ...
  Scenario: [SF-EFF-AU-INC-10] Load of mixed stage into an already populated eff sat - two cycles
    ...
    Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
      ...
      | md5('2000\|\|BBB') | md5('2000') | md5('BBB') | 2020-01-09 00:00:00.000 | 2020-01-10 00:00:00.000 | 2020-01-10 00:00:00.000     | 2020-01-10 00:00:00.000 | orders |
      | md5('2001\|\|BBB') | md5('2001') | md5('BBB') | 2020-01-09 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-10 00:00:00.000     | 2020-01-10 00:00:00.000 | orders |
      | md5('2001\|\|BBB') | md5('2001') | md5('BBB') | 2020-01-09 00:00:00.000 | 2020-01-11 00:00:00.000 | 2020-01-11 00:00:00.000     | 2020-01-11 00:00:00.000 | orders |
      | md5('2000\|\|BBB') | md5('2000') | md5('BBB') | 2020-01-09 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-11 00:00:00.000     | 2020-01-11 00:00:00.000 | orders |
      | md5('3000\|\|CCC') | md5('3000') | md5('CCC') | 2020-01-09 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-09 00:00:00.000     | 2020-01-09 00:00:00.000 | orders |
      ...
      | md5('3001\|\|CCC') | md5('3001') | md5('CCC') | 2020-01-09 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-11 00:00:00.000     | 2020-01-11 00:00:00.000 | orders |
      | md5('4000\|\|DDD') | md5('4000') | md5('DDD') | 2020-01-10 00:00:00.000 | 9999-12-31 23:59:59.999 | 2020-01-10 00:00:00.000     | 2020-01-10 00:00:00.000 | orders |
