@fixture.set_workdir
Feature: Bridge table - Incremental Bridge behaviour with one hub and one/two links (sqlserver)
  ...
  Scenario: [INCR-LOAD] Bridge on one hub and one link; Test 1
    ...
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1002\|\|100') | md5('1002') | md5('100') | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
      | md5('1002\|\|200') | md5('1002') | md5('200') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1003\|\|300') | md5('1003') | md5('300') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1004\|\|400') | md5('1004') | md5('400') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
    Then the BRIDGE_CUSTOMER_ORDER table should contain expected data
  ...
  Scenario: [INCR-LOAD] Bridge on one hub and one link; Test 2
    ...
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1002\|\|100') | md5('1002') | md5('100') | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      | md5('1002\|\|200') | md5('1002') | md5('200') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1003\|\|300') | md5('1003') | md5('300') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1004\|\|400') | md5('1004') | md5('400') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
  ...
  Scenario: [INCR-LOAD] Bridge on one hub and one link; Test 3
    ...
    Given the RAW_CUSTOMER_ORDER table contains data
      | CUSTOMER_ID | ORDER_ID | LOAD_DATETIME           | END_DATE                | SOURCE |
      | 1001        | 101      | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | *      |
    ...
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1001\|\|100') | md5('1001') | md5('100') | 2018-06-01 00:00:00.000 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
      | md5('1002\|\|100') | md5('1002') | md5('100') | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
      | md5('1011\|\|111') | md5('1011') | md5('111') | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
  ...
  Scenario: [INCR-LOAD] Bridge on one hub and one link; Test 4
    ...
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1002\|\|100') | md5('1002') | md5('100') | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      ...
      | md5('1012\|\|200') | md5('1012') | md5('200') | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
    Then the BRIDGE_CUSTOMER_ORDER table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | LINK_CUSTOMER_ORDER_PK |
      | md5('1001') | 2018-06-01 00:00:00.000 | md5('1001\|\|100')     |
      | md5('1002') | 2018-06-01 00:00:00.000 | md5('1002\|\|200')     |
    ...
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1002\|\|200') | md5('1002') | md5('200') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
    When I load the BRIDGE_CUSTOMER_ORDER bridge
    Then the BRIDGE_CUSTOMER_ORDER table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | LINK_CUSTOMER_ORDER_PK |
      | md5('1001') | 2018-06-01 00:00:00.000 | md5('1001\|\|100')     |
  ...
  Scenario: [INCR-LOAD] Bridge on one hub and two links; Test 5
    ...
    And the RAW_ORDER_PRODUCT table contains data
      ...
      | 101      | AAA        | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | *      |
      | 111      | ABB        | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.996 | *      |
    ...
    Then the EFF_SAT_ORDER_PRODUCT table should contain expected data
      ...
      | md5('100\|\|AAB')  | md5('100') | md5('AAB')  | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      | md5('101\|\|AAA')  | md5('101') | md5('AAA')  | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      | md5('111\|\|ABB')  | md5('111') | md5('ABB')  | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
      ...
      | md5('300\|\|CCA')  | md5('300') | md5('CCA')  | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      ...
      | md5('400\|\|DDDA') | md5('400') | md5('DDDA') | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      | md5('400\|\|DDDB') | md5('400') | md5('DDDB') | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
  ...
  Scenario: [INCR-LOAD] Bridge on one hub and two links; Test 6
    ...
    Then the EFF_SAT_ORDER_PRODUCT table should contain expected data
      ...
      | md5('200\|\|BBBB') | md5('200') | md5('BBBB') | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
      | md5('300\|\|CCC')  | md5('300') | md5('CCC')  | 2018-06-01 00:00:00.000 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      | md5('300\|\|CCA')  | md5('300') | md5('CCA')  | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      | md5('400\|\|DDD')  | md5('400') | md5('DDD')  | 2018-06-01 00:00:00.000 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      | md5('400\|\|DDDA') | md5('400') | md5('DDDA') | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
    ...
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1001\|\|100') | md5('1001') | md5('100') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-02 00:00:00.000 | 2018-06-02 00:00:00.000 | *      |
      ...
      | md5('1002\|\|200') | md5('1002') | md5('200') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-02 00:00:00.000 | 2018-06-02 00:00:00.000 | *      |
    When I load the LINK_ORDER_PRODUCT link
    Then the LINK_ORDER_PRODUCT table should contain expected data
      | ORDER_PRODUCT_PK   | ORDER_FK   | PRODUCT_FK  | LOAD_DATETIME           | SOURCE |
      | md5('100\|\|AAA')  | md5('100') | md5('AAA')  | 2018-06-01 00:00:00.000 | *      |
    ...
    Then the EFF_SAT_ORDER_PRODUCT table should contain expected data
      ...
      | md5('100\|\|AAA')  | md5('100') | md5('AAA')  | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-02 00:00:00.000 | 2018-06-02 00:00:00.000 | *      |
      ...
      | md5('200\|\|BBB')  | md5('200') | md5('BBB')  | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-02 00:00:00.000 | 2018-06-02 00:00:00.000 | *      |
      ...
      | md5('300\|\|CCC')  | md5('300') | md5('CCC')  | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-02 00:00:00.000 | 2018-06-02 00:00:00.000 | *      |
      ...
      | md5('400\|\|DDD')  | md5('400') | md5('DDD')  | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-02 00:00:00.000 | 2018-06-02 00:00:00.000 | *      |
    When I load the BRIDGE_CUSTOMER_ORDER_PRODUCT bridge
    Then the BRIDGE_CUSTOMER_ORDER_PRODUCT table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | LINK_CUSTOMER_ORDER_PK | LINK_ORDER_PRODUCT_PK |
      | md5('1001') | 2018-06-01 00:00:00.000 | md5('1001\|\|100')     | md5('100\|\|AAA')     |
