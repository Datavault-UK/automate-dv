...
# [SF-HUB-015] Union three staging tables to feed a populated hub
  ...
  Scenario: [SF-HUB-IM-01] Load of empty 2nd stage into an non-existent hub - one cycle
  ...
  @fixture.single_source_hub
  Scenario: [SF-HUB-IM-02] Load of stage data into an non-existent hub - one cycle
    Given the HUB table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 1993-01-01 | TPCH   |
  ...
  @fixture.single_source_hub
  Scenario: [SF-HUB-IM-03] Load of stage data into an non-existent hub - two cycles
    Given the HUB table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 1993-01-01 | TPCH   |
...
# todo: add a one cycle test for an empty hub with empty 1st stage
  ...
  @fixture.single_source_hub
  Scenario: [SF-HUB-IM-05] Load of stage data into an empty hub - two cycles
    Given the HUB hub is empty
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 1993-01-01 | TPCH   |
...
# todo: add a one cycle test for a populated hub with empty 1st stage
