...
Feature: Multi Active Satellites Loaded in cycles using separate manual loads - Two DK
  ...
  Scenario: [SAT-CYCLE-LD] MULTI_ACTIVE_SATELLITE load over several cycles
    ...
    When the RAW_STAGE_TWO_CDK is loaded
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE   | EXTENSION | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | 1002        | Beah          | 17-214-233-1212  | 123       | 2019-05-07     | 2019-05-07 | *      |
    ...
    Then the MULTI_ACTIVE_SATELLITE_TWO_CDK table should contain expected data
      ...
      | md5('1002') | md5('1002\|\|BEAH\|\|17-214-233-1212\|\|123')    | 123       | Beah          | 17-214-233-1212   | 2019-05-07     | 2019-05-07 | *      |
  ...
  Scenario: [SAT-CYCLE-TS] MULTI_ACTIVE_SATELLITE load over several cycles with TimeStamps
    ...
    When the RAW_STAGE_TWO_CDK_TS is loaded
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE   | EXTENSION | EFFECTIVE_FROM          | LOAD_DATETIME           | SOURCE |
      | 1002        | Beah          | 17-214-233-1212  | 123       | 2019-05-07 11:14:54.396 | 2019-05-07 11:14:54.396 | *      |
      ...
      | 1010        | Jenny         | 17-214-233-1216  | 123       | 2019-05-07 11:14:54.396 | 2019-05-07 11:14:54.396 | *      |
    ...
    Then the MULTI_ACTIVE_SATELLITE_TWO_CDK_TS table should contain expected data
      ...
      | md5('1002') | md5('1002\|\|BEAH\|\|17-214-233-1212\|\|123')    | 123       | Beah          | 17-214-233-1212   | 2019-05-07 11:14:54.396 | 2019-05-07 11:14:54.396 | *      |
  ...
  Scenario: [SAT-CYCLE-SHA] MULTI_ACTIVE_SATELLITE load over several cycles
    ...
    Then the MULTI_ACTIVE_SATELLITE_TWO_CDK table should contain expected data
      ...
      | sha('1002') | sha('1002\|\|BEAH\|\|17-214-233-1212\|\|123')    | 123       | Beah          | 17-214-233-1212   | 2019-05-07     | 2019-05-07 | *      |
