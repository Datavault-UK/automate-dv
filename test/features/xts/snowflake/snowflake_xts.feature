Feature: [SF-XTS] Extended Record Tracking Satellites
  ...
  @fixture.xts
  Scenario: [SF-XTS-01] Load one stage of records into an empty single satellite XTS
  ...
  @fixture.xts
  Scenario: [SF-XTS-02] Load one stage of data into a non-existent single satellite XTS
  ...
  @fixture.xts
  Scenario: [SF-XTS-03] Load duplicated data in one stage into a non-existent single satellite XTS
    Given the XTS table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_FIRSTNAME | CUSTOMER_LASTNAME | CUSTOMER_DOB | CUSTOMER_PHONE  | CUSTOMER_COUNTY | CUSTOMER_CITY | LOAD_DATE  | SOURCE |
      | 1001        | Alice              | Andrews           | 1997-04-24   | 17-214-233-1214 | Oxfordshire     | Oxford        | 1993-01-01 | *      |
  ...
  @fixture.xts
  Scenario: [SF-XTS-04] Load duplicated data in one stage into a non-existent single satellite XTS
    Given the XTS table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_FIRSTNAME | CUSTOMER_LASTNAME | CUSTOMER_DOB | CUSTOMER_PHONE  | CUSTOMER_COUNTY | CUSTOMER_CITY | LOAD_DATE  | SOURCE |
      | 1001        | Alice              | Andrews           | 1997-04-24   | 17-214-233-1214 | Oxfordshire     | Oxford        | 1993-01-01 | *      |
  ...
  @fixture.xts
  Scenario: [SF-XTS-05] Loads records from a single stage to an XTS linked to two satellites.
  ...
  @fixture.xts
  Scenario: [SF-XTS-06] Loads from a single stage to an XTS linked to two satellites with repeating records in the first satellite
    Given I have an empty RAW_STAGE_2SAT raw stage
    And I have an empty STG_CUSTOMER_2SAT primed stage
    And the XTS_2SAT xts is empty
  ...
  @fixture.xts
  Scenario: [SF-XTS-07] Loads data from a single stage to an XTS linked to two satellites with repeating records in the second satellite
    Given I have an empty RAW_STAGE_2SAT raw stage
    And I have an empty STG_CUSTOMER_2SAT primed stage
    And the XTS_2SAT xts is empty
    And the RAW_STAGE_2SAT table contains data
  ...
  @fixture.xts
  Scenario: [SF-XTS-08] Loads from a single stage to an XTS linked to two satellites with repeating records in the both satellites
    Given I have an empty RAW_STAGE_2SAT raw stage
    And I have an empty STG_CUSTOMER_2SAT primed stage
    And the XTS_2SAT xts is empty
    And the RAW_STAGE_2SAT table contains data
  ...
  @fixture.xts
  Scenario: [SF-XTS-09] Loads records from a single stage to an XTS linked to three satellites
