...
# =============================================================================
  ...
  Scenario: Test several load cycles
    ...
    Then we expect the TEST_SAT_CUST_CUSTOMER_DETAILS table to contain
      ...
      | md5('1003') | md5('1003\|\|CHARLEY\|\|1990-02-03')   | Charley   | 1990-02-03 | 2019-05-05     | 2019-05-05 | *      |
      | md5('1003') | md5('1003\|\|MICHAEL\|\|1990-02-03')   | Michael   | 1990-02-03 | 2019-05-06     | 2019-05-06 | *      |
      | md5('1004') | md5('1004\|\|DAVID\|\|1992-01-30')     | David     | 1992-01-30 | 2019-05-05     | 2019-05-05 | *      |
      | md5('1005') | md5('1005\|\|KEVIN\|\|2001-07-23')     | Kevin     | 2001-07-23 | 2019-05-06     | 2019-05-06 | *      |
      | md5('1006') | md5('1006\|\|CHRIS\|\|1960-01-01')     | Chris     | 1960-01-01 | 2019-05-06     | 2019-05-06 | *      |
      | md5('1007') | md5('1007\|\|ALBERT\|\|1990-02-03')    | Albert    | 1990-02-03 | 2019-05-07     | 2019-05-07 | *      |
      | md5('1008') | md5('1008\|\|WILHEMINA\|\|1998-11-07') | Wilhemina | 1998-11-07 | 2019-05-07     | 2019-05-07 | *      |
      | md5('1009') | md5('1009\|\|PERRY\|\|2006-09-13')     | Perry     | 2006-09-13 | 2019-05-07     | 2019-05-07 | *      |
      | md5('1010') | md5('1010\|\|RONNA\|\|1991-03-21')     | Ronna     | 1991-03-21 | 2019-05-07     | 2019-05-07 | *      |
      | md5('1011') | md5('1011\|\|ANNAMAE\|\|1978-06-16')   | Annamae   | 1978-06-16 | 2019-05-07     | 2019-05-07 | *      |
      | md5('1012') | md5('1012\|\|GREGORIO\|\|2004-08-11')  | Gregorio  | 2004-08-11 | 2019-05-07     | 2019-05-07 | *      |
      | md5('1013') | md5('1013\|\|ROCHEL\|\|2003-02-27')    | Rochel    | 2003-02-27 | 2019-05-07     | 2019-05-07 | *      |
      | md5('1014') | md5('1014\|\|SHAYNE\|\|1999-01-31')    | Shayne    | 1999-01-31 | 2019-05-07     | 2019-05-07 | *      |
      | md5('1015') | md5('1015\|\|FABIOLA\|\|1985-04-02')   | Fabiola   | 1985-04-02 | 2019-05-07     | 2019-05-07 | *      |
    Then we expect the TEST_SAT_BOOK_CUSTOMER_DETAILS table to contain
      ...
      | md5('1001') | md5('1001\|\|BRITISH\|\|17-214-233-1214')    | 17-214-233-1214 | BRITISH     | 2019-05-04     | 2019-05-04 | *      |
      | md5('1002') | md5('1002\|\|DUTCH\|\|17-214-200-1214')      | 17-214-200-1214 | DUTCH       | 2019-05-04     | 2019-05-04 | *      |
      | md5('1003') | md5('1003\|\|AUSTRALIAN\|\|17-214-555-1214') | 17-214-555-1214 | AUSTRALIAN  | 2019-05-05     | 2019-05-05 | *      |
      | md5('1004') | md5('1004\|\|GERMAN\|\|17-214-123-1214')     | 17-214-123-1214 | GERMAN      | 2019-05-05     | 2019-05-05 | *      |
      | md5('1005') | md5('1005\|\|BRITISH\|\|17-214-456-1214')    | 17-214-456-1214 | BRITISH     | 2019-05-06     | 2019-05-06 | *      |
      | md5('1006') | md5('1006\|\|RUSSIAN\|\|17-214-789-1214')    | 17-214-789-1214 | RUSSIAN     | 2019-05-06     | 2019-05-06 | *      |
      | md5('1007') | md5('1007\|\|TURKISH\|\|17-214-577-1215')    | 17-214-577-1215 | TURKISH     | 2019-05-07     | 2019-05-07 | *      |
      | md5('1008') | md5('1008\|\|UAE\|\|17-214-577-1216')        | 17-214-577-1216 | UAE         | 2019-05-07     | 2019-05-07 | *      |
      | md5('1009') | md5('1009\|\|BOLIVIAN\|\|17-214-577-1217')   | 17-214-577-1217 | BOLIVIAN    | 2019-05-07     | 2019-05-07 | *      |
      | md5('1010') | md5('1010\|\|POLISH\|\|17-214-577-1218')     | 17-214-577-1218 | POLISH      | 2019-05-07     | 2019-05-07 | *      |
      | md5('1011') | md5('1011\|\|HUNGARIAN\|\|17-214-577-1219')  | 17-214-577-1219 | HUNGARIAN   | 2019-05-07     | 2019-05-07 | *      |
      | md5('1012') | md5('1012\|\|ECUADORIAN\|\|17-214-577-1220') | 17-214-577-1220 | ECUADORIAN  | 2019-05-07     | 2019-05-07 | *      |
      | md5('1013') | md5('1013\|\|INDONESIAN\|\|17-214-577-1221') | 17-214-577-1221 | INDONESIAN  | 2019-05-07     | 2019-05-07 | *      |
      | md5('1014') | md5('1014\|\|ANGOLAN\|\|17-214-577-1222')    | 17-214-577-1222 | ANGOLAN     | 2019-05-07     | 2019-05-07 | *      |
      | md5('1015') | md5('1015\|\|TAIWANESE\|\|17-214-577-1223')  | 17-214-577-1223 | TAIWANESE   | 2019-05-07     | 2019-05-07 | *      |
    Then we expect the TEST_SAT_BOOK_BOOKING_DETAILS table to contain
      ...
      | md5('10034') | md5('10034\|\|2019-05-03\|\|2019-09-17\|\|100\|\|GBR')    | 100.0  | 2019-05-03   | 2019-09-17     | GBR         | 2019-05-04     | 2019-05-04 | *      |
      | md5('10035') | md5('10035\|\|2019-05-03\|\|2019-09-16\|\|80\|\|NLD')     | 80.0   | 2019-05-03   | 2019-09-16     | NLD         | 2019-05-04     | 2019-05-04 | *      |
      | md5('10036') | md5('10036\|\|2019-05-04\|\|2019-09-13\|\|70\|\|AUS')     | 70.0   | 2019-05-04   | 2019-09-13     | AUS         | 2019-05-05     | 2019-05-05 | *      |
      | md5('10037') | md5('10037\|\|2019-05-04\|\|2019-09-18\|\|810\|\|DEU')    | 810.0  | 2019-05-04   | 2019-09-18     | DEU         | 2019-05-05     | 2019-05-05 | *      |
      | md5('10038') | md5('10038\|\|2019-05-05\|\|2019-09-19\|\|216.5\|\|ITA')  | 216.5  | 2019-05-05   | 2019-09-19     | ITA         | 2019-05-06     | 2019-05-06 | *      |
      | md5('10039') | md5('10039\|\|2019-05-05\|\|2019-09-20\|\|111.1\|\|NOR')  | 111.1  | 2019-05-05   | 2019-09-20     | NOR         | 2019-05-06     | 2019-05-06 | *      |
      | md5('10039') | md5('10039\|\|2019-05-05\|\|2019-09-20\|\|111.1\|\|AUS')  | 111.1  | 2019-05-05   | 2019-09-20     | AUS         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10040') | md5('10040\|\|2019-05-06\|\|2019-09-28\|\|832.84\|\|CHN') | 832.84 | 2019-05-06   | 2019-09-28     | CHN         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10041') | md5('10041\|\|2019-05-06\|\|2019-10-08\|\|947.79\|\|LUX') | 947.79 | 2019-05-06   | 2019-10-08     | LUX         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10042') | md5('10042\|\|2019-05-06\|\|2019-10-21\|\|58.24\|\|IDN')  | 58.24  | 2019-05-06   | 2019-10-21     | IDN         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10043') | md5('10043\|\|2019-05-06\|\|2019-10-25\|\|393.18\|\|CYM') | 393.18 | 2019-05-06   | 2019-10-25     | CYM         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10044') | md5('10044\|\|2019-05-06\|\|2019-11-03\|\|139.3\|\|SPM')  | 139.3  | 2019-05-06   | 2019-11-03     | SPM         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10045') | md5('10045\|\|2019-05-06\|\|2019-11-07\|\|724.63\|\|LBR') | 724.63 | 2019-05-06   | 2019-11-07     | LBR         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10046') | md5('10046\|\|2019-05-06\|\|2019-11-14\|\|295.81\|\|SEN') | 295.81 | 2019-05-06   | 2019-11-14     | SEN         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10047') | md5('10047\|\|2019-05-06\|\|2019-12-22\|\|259.99\|\|HMD') | 259.99 | 2019-05-06   | 2019-12-22     | HMD         | 2019-05-07     | 2019-05-07 | *      |
      | md5('10048') | md5('10048\|\|2019-05-06\|\|2019-10-16\|\|219.99\|\|JAM') | 219.99 | 2019-05-06   | 2019-10-16     | JAM         | 2019-05-07     | 2019-05-07 | *      |