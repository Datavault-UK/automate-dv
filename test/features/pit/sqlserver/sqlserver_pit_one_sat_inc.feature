Feature: [SQLS-PIT-1SI] Point in Time
  ...
  # DATES
  @fixture.pit_one_sat
  Scenario: [SQLS-PIT-1SI-01] Incremental load with the more recent AS OF dates into an already populated pit table from one satellite with dates
  ...
  # TIMESTAMPS
  @fixture.pit_one_sat
  Scenario: [SQLS-PIT-1SI-02] Incremental load with the more recent AS OF timestamps into an already populated pit table from one satellite with timestamps
  ...
  @fixture.pit_one_sat
  Scenario: [SQLS-PIT-1SI-03] Incremental load with the more recent AS OF dates into an already populated pit table from one satellite with timestamps
  ...
  @fixture.pit_one_sat
  Scenario: [SQLS-PIT-1SI-04] Incremental load with the more recent AS OF timestamps into an already populated pit table from one satellite with dates
  ...
  # AS OF - HIGHER GRANULARITY
  @fixture.pit_one_sat
  Scenario: [SQLS-PIT-1SI-06] Incremental load with the more recent AS OF timestamps into an already populated pit table from one satellite with dates
    Given the PIT_CUSTOMER_HG table does not exist
    And the raw vault contains empty tables
      | HUB          | LINK  | SAT                  | PIT             |
      | HUB_CUSTOMER |       | SAT_CUSTOMER_DETAILS | PIT_CUSTOMER_HG |
