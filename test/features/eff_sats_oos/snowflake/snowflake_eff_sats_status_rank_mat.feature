Feature: [SF-EFF-RM] Effectivity Satellites Loaded using Rank Materialization

  @fixture.eff_satellite_status
  Scenario: [SF-EFF-RM-001] Load data into a non-existent effectivity satellite
    ...
    And I insert by rank into the EFF_SAT eff_sat_oos
  ...
  @fixture.eff_satellite_status
  Scenario: [SF-EFF-RM-002] Load data into an empty effectivity satellite
  ...
  @fixture.eff_satellite_status
  Scenario: [SF-EFF-RM-003] No New Eff Sat Added if Driving Foreign Key is NULL and Latest EFF Sat Remain Open
