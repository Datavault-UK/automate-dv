Feature: [SQLS-PIT] PIT
  ...
  Scenario: [SF-PIT-001] Load into a pit table where the AS OF table is already established with increments of a day
    ...
    And the RAW_STAGE_PROFILE table contains data
      ...
      | 1001        | blue             | ab12         | 2019-01-03 00:00:00.000 | *      |
      | 1001        | brown            | ab12         | 2019-01-04 00:00:00.000 | *      |
    ...
    Then the SAT_CUSTOMER_PROFILE table should contain expected data
      ...
      | md5('1001') | blue             | ab12         | md5('BLUE\|\|AB12') ) | 2019-01-03 00:00:00.000 | 2019-01-03 00:00:00.000 | *      |
      | md5('1001') | brown            | ab12         | md5('BROWN\|\|AB12')  | 2019-01-04 00:00:00.000 | 2019-01-04 00:00:00.000 | *      |
      | md5('1002') | yellow           | cd34         | md5('YELLOW\|\|CD34') | 2019-01-02 00:00:00.000 | 2019-01-02 00:00:00.000 | *      |
      | md5('1002') | yellow           | ef56         | md5('YELLOW\|\|EF56') | 2019-01-03 00:00:00.000 | 2019-01-03 00:00:00.000 | *      |
      | md5('1002') | pink             | ef56         | md5('PINK\|\|EF56')   | 2019-01-04 00:00:00.000 | 2019-01-04 00:00:00.000 | *      |
    Then the PIT_CUSTOMER table should contain expected data
      ...
      | md5('1002') | 2019-01-02 00:00:00.000 | md5('1002')             | 2018-12-01 00:00:00.000   | md5('1002')           | 2019-01-02 00:00:00.000 | md5('1002')             | 2019-01-02 00:00:00.000   |
      | md5('1002') | 2019-01-03 00:00:00.000 | md5('1002')             | 2018-12-01 00:00:00.000   | md5('1002')           | 2019-01-03 00:00:00.000 | md5('1002')             | 2019-01-03 00:00:00.000   |
      ...
      | md5('1002') | 2019-01-05 00:00:00.000 | md5('1002')             | 2018-12-01 00:00:00.000   | md5('1002')           | 2019-01-05 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   |
  ...
  Scenario: [SF-PIT-003] Load into a pit table where the AS OF table is already established and the AS OF table has increments of 30 mins
    ...
    And the RAW_STAGE_LOGIN table contains data
      ...
      | 1001        | 2019-01-01 10:36:00.000 | Phone       | 2019-01-01 10:45:00 | *      |
      | 1001        | 2019-01-01 10:56:00.000 | Laptop      | 2019-01-01 11:15:00 | *      |
    ...
    Then the PIT_CUSTOMER table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE          | SAT_CUSTOMER_DETAILS_PK | SAT_CUSTOMER_DETAILS_LDTS | SAT_CUSTOMER_LOGIN_PK | SAT_CUSTOMER_LOGIN_LDTS | SAT_CUSTOMER_PROFILE_PK | SAT_CUSTOMER_PROFILE_LDTS |
      | md5('1001') | 2019-01-01 10:15:00 | md5('1001')             | 2018-06-01 00:00:00.000   | md5('1001')           | 2019-01-01 10:15:00     | md5('1001')             | 2019-01-01 10:15:00       |
      | md5('1001') | 2019-01-01 10:45:00 | md5('1001')             | 2018-06-01 00:00:00.000   | md5('1001')           | 2019-01-01 10:45:00     | md5('1001')             | 2019-01-01 10:45:00       |
      | md5('1001') | 2019-01-01 11:15:00 | md5('1001')             | 2018-06-01 00:00:00.000   | md5('1001')           | 2019-01-01 11:15:00     | md5('1001')             | 2019-01-01 11:15:00       |
      | md5('1002') | 2019-01-01 10:15:00 | md5('1002')             | 2018-12-01 00:00:00.000   | md5('1002')           | 2019-01-01 10:15:00     | md5('1002')             | 2019-01-01 10:15:00       |
  ...
  Scenario: [SF-PIT-004] Load into a pit table where the AS OF table dates are before the satellites have received any entry's
    ...
    Then the PIT_CUSTOMER table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_PK | SAT_CUSTOMER_DETAILS_LDTS | SAT_CUSTOMER_LOGIN_PK | SAT_CUSTOMER_LOGIN_LDTS | SAT_CUSTOMER_PROFILE_PK | SAT_CUSTOMER_PROFILE_LDTS |
      | md5('1001') | 2017-01-02 00:00:00.000 | 0000000000000000        | 1900-01-01 00:00:00.000   | 0000000000000000      | 1900-01-01 00:00:00.000 | 0000000000000000        | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2017-01-03 00:00:00.000 | 0000000000000000        | 1900-01-01 00:00:00.000   | 0000000000000000      | 1900-01-01 00:00:00.000 | 0000000000000000        | 1900-01-01 00:00:00.000   |
  ...
  Scenario: [SF-PIT-005] Load into a pit table where the AS OF table dates are after the most recent satellite entry's
    ...
    Then the PIT_CUSTOMER table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_PK | SAT_CUSTOMER_DETAILS_LDTS | SAT_CUSTOMER_LOGIN_PK | SAT_CUSTOMER_LOGIN_LDTS | SAT_CUSTOMER_PROFILE_PK | SAT_CUSTOMER_PROFILE_LDTS |
      | md5('1001') | 2019-01-05 00:00:00.000 | md5('1001')             | 2018-06-01 00:00:00.000   | md5('1001')           | 2019-01-04 00:00:00.000 | md5('1001')             | 2019-01-04 00:00:00.000   |
      | md5('1001') | 2019-01-06 00:00:00.000 | md5('1001')             | 2018-06-01 00:00:00.000   | md5('1001')           | 2019-01-04 00:00:00.000 | md5('1001')             | 2019-01-04 00:00:00.000   |
      | md5('1001') | 2019-01-07 00:00:00.000 | md5('1001')             | 2018-06-01 00:00:00.000   | md5('1001')           | 2019-01-04 00:00:00.000 | md5('1001')             | 2019-01-04 00:00:00.000   |
      | md5('1002') | 2019-01-05 00:00:00.000 | md5('1002')             | 2018-12-01 00:00:00.000   | md5('1002')           | 2019-01-04 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   |
  ...
  Scenario: [SF-PIT-006] Load into a pit table over several cycles where new record is introduced on the 3rd day
    ...
    And the RAW_STAGE_DETAILS is loaded
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_ADDRESS         | CUSTOMER_DOB | LOAD_DATE               | SOURCE |
      | 1001        | Alice         | 1 Forrest road Hampshire | 1997-04-24   | 2019-01-03 00:00:00.000 | *      |
    ...
    Then the PIT_CUSTOMER table should contain expected data
      ...
      | md5('1001') | 2019-01-03 00:00:00.000 | md5('1001')             | 2019-01-03 00:00:00.000   | md5('1001')           | 2019-01-03 00:00:00.000 | md5('1001')             | 2019-01-03 00:00:00.000   |
      | md5('1001') | 2019-01-04 00:00:00.000 | md5('1001')             | 2019-01-03 00:00:00.000   | md5('1001')           | 2019-01-04 00:00:00.000 | md5('1001')             | 2019-01-04 00:00:00.000   |
      | md5('1001') | 2019-01-05 00:00:00.000 | md5('1001')             | 2019-01-03 00:00:00.000   | md5('1001')           | 2019-01-05 00:00:00.000 | md5('1001')             | 2019-01-05 00:00:00.000   |
      | md5('1002') | 2019-01-03 00:00:00.000 | md5('1002')             | 2019-01-01 00:00:00.000   | md5('1002')           | 2019-01-03 00:00:00.000 | md5('1002')             | 2019-01-03 00:00:00.000   |
      | md5('1002') | 2019-01-04 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   | md5('1002')           | 2019-01-04 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   |
      | md5('1002') | 2019-01-05 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   | md5('1002')           | 2019-01-05 00:00:00.000 | md5('1002')             | 2019-01-05 00:00:00.000   |
    When the RAW_STAGE_DETAILS is loaded
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_ADDRESS         | CUSTOMER_DOB | LOAD_DATE               | SOURCE |
      | 1003        | Chad          | 4 Forrest road Hampshire | 1998-01-16   | 2019-01-06 00:00:00.000 | *      |
    When the RAW_STAGE_LOGIN is loaded
      | CUSTOMER_ID | LAST_LOGIN_DATE         | DEVICE_USED | LOAD_DATE               | SOURCE |
    ...
    Then the PIT_CUSTOMER table should contain expected data
      ...
      | md5('1001') | 2019-01-04 00:00:00.000 | md5('1001')             | 2019-01-03 00:00:00.000   | md5('1001')           | 2019-01-04 00:00:00.000 | md5('1001')             | 2019-01-04 00:00:00.000   |
      | md5('1001') | 2019-01-05 00:00:00.000 | md5('1001')             | 2019-01-03 00:00:00.000   | md5('1001')           | 2019-01-05 00:00:00.000 | md5('1001')             | 2019-01-05 00:00:00.000   |
      | md5('1001') | 2019-01-06 00:00:00.000 | md5('1001')             | 2019-01-03 00:00:00.000   | md5('1001')           | 2019-01-06 00:00:00.000 | md5('1001')             | 2019-01-06 00:00:00.000   |
      | md5('1002') | 2019-01-04 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   | md5('1002')           | 2019-01-04 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   |
      | md5('1002') | 2019-01-05 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   | md5('1002')           | 2019-01-05 00:00:00.000 | md5('1002')             | 2019-01-05 00:00:00.000   |
      | md5('1002') | 2019-01-06 00:00:00.000 | md5('1002')             | 2019-01-04 00:00:00.000   | md5('1002')           | 2019-01-06 00:00:00.000 | md5('1002')             | 2019-01-06 00:00:00.000   |
      | md5('1003') | 2019-01-04 00:00:00.000 | 0000000000000000        | 1900-01-01 00:00:00.000   | 0000000000000000      | 1900-01-01 00:00:00.000 | 0000000000000000        | 1900-01-01 00:00:00.000   |
