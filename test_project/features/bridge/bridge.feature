...
Feature: Bridge
  ...
  Scenario: Load into a bridge table where the AS_OF table is already established and the AS_OF table has increments of a day
    ...
    Then the BRIDGE_CUSTOMER table should contain expected data
      | CUSTOMER_PK  | AS_OF_DATE                 | LINK_CO_PK         | EFF_CO_END_DATE            | LINK_CN_PK          | EFF_CN_END_DATE            |
      | md5('1001')  | 2018-06-01 00:00:00.000000 | md5('1001\|\|100') | 9999-12-31 00:00:00.000000 | md5('1001\|\|GBR')  | 9999-12-31 00:00:00.000000 |
      | md5('1002')  | 2018-06-01 00:00:00.000000 | md5('1002\|\|200') | 9999-12-31 00:00:00.000000 | md5('1002\|\|POL')  | 9999-12-31 00:00:00.000000 |
      | md5('1003')  | 2018-06-01 00:00:00.000000 | md5('1003\|\|300') | 9999-12-31 00:00:00.000000 | md5('1003\|\|DEU')  | 9999-12-31 00:00:00.000000 |
      | md5('1004')  | 2018-06-01 00:00:00.000000 | md5('1004\|\|400') | 9999-12-31 00:00:00.000000 | md5('1004\|\|ITA')  | 9999-12-31 00:00:00.000000 |