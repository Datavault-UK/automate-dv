...
@pytest.mark.macro
def test_create_ghost_record_with_extra_columns_and_payload_as_list(request, generate_model):
    var_dict = {
        "source_model": "raw_source_sat",
        "src_pk": '"CUSTOMER_PK"',
        "src_hashdiff": '"HASHDIFF"',
...
@pytest.mark.macro
def test_create_ghost_record_with_all_lists_bar_ldts(request, generate_model):
