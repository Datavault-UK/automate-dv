{%- macro t_link(src_pk, src_fk, src_payload, src_additional_columns, src_eff, src_ldts, src_source, source_model) -%}
...
{%- macro default__t_link(src_pk, src_fk, src_payload, src_additional_columns, src_eff, src_ldts, src_source, source_model) -%}
