...
Feature: Multi Active Satellites
  ...
  Scenario: [BASE-LOAD] Load data into a non-existent multi-active satellite
    ...
    Then the MULTI_ACTIVE_SATELLITE_TWO_DK table should contain expected data
      ...
      | md5('1001') | md5('1001\|\|17-214-233-1214\|\|ALICE\|\|123') | Alice         | 17-214-233-1214 | 123       | 1993-01-01     | 1993-01-01 | *      |
      | md5('1002') | md5('1002\|\|17-214-233-1215\|\|BOB\|\|123')   | Bob           | 17-214-233-1215 | 123       | 1993-01-01     | 1993-01-01 | *      |
      | md5('1003') | md5('1003\|\|17-214-233-1216\|\|CHAD\|\|123')  | Chad          | 17-214-233-1216 | 123       | 1993-01-01     | 1993-01-01 | *      |
      | md5('1004') | md5('1004\|\|17-214-233-1217\|\|DOM\|\|123')   | Dom           | 17-214-233-1217 | 123       | 1993-01-01     | 1993-01-01 | *      |
