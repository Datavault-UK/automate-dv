Feature: [BRG] Bridge table
  ...
  New order or changed order are assigned only to existing customers
    ...
    Then the BRIDGE_CUSTOMER_ORDER_AC table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | CUSTOMER_MT_ID | LINK_CUSTOMER_ORDER_PK |
      | md5('1001') | 2018-06-01 00:00:00.000 | TPCH_CUSTOMER  | md5('1001\|\|100')     |
      | md5('1002') | 2018-06-01 00:00:00.000 | TPCH_CUSTOMER  | md5('1002\|\|200')     |
      | md5('1003') | 2018-06-01 00:00:00.000 | TPCH_CUSTOMER  | md5('1003\|\|300')     |
      | md5('1004') | 2018-06-01 00:00:00.000 | TPCH_CUSTOMER  | md5('1004\|\|400')     |
      | md5('1001') | 2018-06-01 12:00:00.000 | TPCH_CUSTOMER  | md5('1001\|\|101')     |
      | md5('1002') | 2018-06-01 12:00:00.000 | TPCH_CUSTOMER  | md5('1002\|\|100')     |
      | md5('1002') | 2018-06-01 12:00:00.000 | TPCH_CUSTOMER  | md5('1002\|\|200')     |
      | md5('1003') | 2018-06-01 12:00:00.000 | TPCH_CUSTOMER  | md5('1003\|\|300')     |
      | md5('1004') | 2018-06-01 12:00:00.000 | TPCH_CUSTOMER  | md5('1004\|\|400')     |
      | md5('1001') | 2018-06-02 00:00:00.000 | TPCH_CUSTOMER  | md5('1001\|\|101')     |
      | md5('1002') | 2018-06-02 00:00:00.000 | TPCH_CUSTOMER  | md5('1002\|\|100')     |
      | md5('1002') | 2018-06-02 00:00:00.000 | TPCH_CUSTOMER  | md5('1002\|\|200')     |
      | md5('1003') | 2018-06-02 00:00:00.000 | TPCH_CUSTOMER  | md5('1003\|\|300')     |
      | md5('1004') | 2018-06-02 00:00:00.000 | TPCH_CUSTOMER  | md5('1004\|\|400')     |
