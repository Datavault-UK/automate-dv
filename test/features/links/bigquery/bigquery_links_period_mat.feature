Feature: [BQ-LNK-PM] Links Loaded using Period Materialization

  @fixture.single_source_link
  Scenario: [BQ-LNK-PM-01] Load a simple stage table into a non-existent link table
  ...
  Scenario: [BQ-LNK-PM-02]  Union three staging tables to feed empty link
