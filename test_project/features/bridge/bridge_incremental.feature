...
# TODO: the bridge macro requires further investigation particularly around the backfill and overlap CTEs

#  @fixture.bridge
#  Scenario: [INCR-LOAD] NOT WORKING! Incremental load with the more recent AS OF dates and an updated order into an already populated bridge table from one hub and one link
#    This scenario is not working because the second cycle does not trigger the insertion of a new record into the EFF_SAT_CUSTOMER_ORDER table
