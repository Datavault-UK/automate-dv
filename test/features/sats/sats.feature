Feature: [SAT] Satellites
  ...
  @fixture.satellite
  Scenario: [SAT-22] Satellite with exclude payload columns flag and no column list and hashdiff aliasing starting with an empty satellite.
    Given I do not exclude any columns from the SATELLITE_HD_ALIAS table
    And the SATELLITE_HD_ALIAS sat is empty
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 1997-04-24   | 17-214-233-1214 | 1993-01-01 | *      |
      | 1002        | Bob           | 2006-04-17   | 17-214-233-1215 | 1993-01-01 | *      |
