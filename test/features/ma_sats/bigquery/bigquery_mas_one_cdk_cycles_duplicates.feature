Feature: [BQ-MAS-1CD-D] Multi Active Satellites
  ...
  Scenario: [BQ-MAS-1CD-D-001] Load over several cycles with a mix of duplicate record change cases
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [BQ-MAS-1CD-D-002] Load over several cycles with no CDK in HASHDIFF and a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [BQ-MAS-1CD-D-003] Load over several cycles with no PK nor CDK in HASHDIFF and a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
