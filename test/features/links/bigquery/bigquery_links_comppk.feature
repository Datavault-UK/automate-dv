Feature: [BQ-COMPPK-LNK] Links with composite src_pk

  @fixture.single_source_comppk_link
  Scenario: [BQ-COMPPK-LNK-01] Load a simple stage table into a non-existent link table
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-COMPPK-LNK-02] Load a simple stage table into an empty link table
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-COMPPK-LNK-03] Load a simple stage table into a populated link table
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-COMPPK-LNK-04] Load a stage table where a primary keys components are all NULL, no link is inserted
    Given the LINK link is already populated with data
      | CUSTOMER_NATION_PK | COMP_PK     | CUSTOMER_FK | NATION_FK  | LOAD_DATE  | SOURCE |
      | md5('1001\|\|GBR') | md5('1001') | md5('1001') | md5('GBR') | 1993-01-01 | CRM    |
      | md5('1002\|\|POL') | md5('1002') | md5('1002') | md5('POL') | 1993-01-01 | CRM    |
