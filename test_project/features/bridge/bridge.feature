...
Feature: Bridge
  ...
  Scenario: Load into a bridge table where the AS_OF table is already established and the AS_OF table has increments of a day
    ...
    Then the EFF_SAT_ORDER_PRODUCT table should contain expected data
      ...
      | md5('100\|\|AAA')  | md5('100') | md5('AAA') | 2018-06-01 00:00:00.000000 | 9999-12-31 00:00:00.000000 | 2018-06-01 00:00:00.000000 | 2018-06-01 00:00:00.000000 | *      |
      | md5('200\|\|BBB')  | md5('200') | md5('BBB') | 2018-06-01 00:00:00.000000 | 9999-12-31 00:00:00.000000 | 2018-06-01 00:00:00.000000 | 2018-06-01 00:00:00.000000 | *      |
      | md5('300\|\|CCC')  | md5('300') | md5('CCC') | 2018-06-01 00:00:00.000000 | 9999-12-31 00:00:00.000000 | 2018-06-01 00:00:00.000000 | 2018-06-01 00:00:00.000000 | *      |
      | md5('400\|\|DDD')  | md5('400') | md5('DDD') | 2018-06-01 00:00:00.000000 | 9999-12-31 00:00:00.000000 | 2018-06-01 00:00:00.000000 | 2018-06-01 00:00:00.000000 | *      |
    Then the BRIDGE_CUSTOMER table should contain expected data
      | CUSTOMER_PK  | AS_OF_DATE                 | LINK_CUSTOMER_ORDER_PK  | EFF_SAT_CUSTOMER_ORDER_END_DATE | LINK_ORDER_PRODUCT_PK | EFF_SAT_ORDER_PRODUCT_END_DATE |
      | md5('1001')  | 2018-06-01 00:00:00.000000 | md5('1001\|\|100')      | 9999-12-31 00:00:00.000000      | md5('100\|\|AAA')     | 9999-12-31 00:00:00.000000     |
      | md5('1002')  | 2018-06-01 00:00:00.000000 | md5('1002\|\|200')      | 9999-12-31 00:00:00.000000      | md5('200\|\|BBB')     | 9999-12-31 00:00:00.000000     |
      | md5('1003')  | 2018-06-01 00:00:00.000000 | md5('1003\|\|300')      | 9999-12-31 00:00:00.000000      | md5('300\|\|CCC')     | 9999-12-31 00:00:00.000000     |
      | md5('1004')  | 2018-06-01 00:00:00.000000 | md5('1004\|\|400')      | 9999-12-31 00:00:00.000000      | md5('400\|\|DDD')     | 9999-12-31 00:00:00.000000     |