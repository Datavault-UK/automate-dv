Feature: [BQ-MAS-1CD-B-Updated] Multi Active Satellites
  Base loads with MAS behaviour with one CDK

### ONE LDTS PER PK

  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-B-Updated-01] Load data into a non-existent multi-active satellite
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-B-Updated-02] Load duplicated CDK & LTDS (with identical payload) into a non-existent multi-active satellite
    Given the MULTI_ACTIVE_SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
...
#  @fixture.multi_active_satellite
#  Scenario: [BQ-MAS-1CD-B-Updated-03] Load duplicated PK & CDK & LDTS (with different payload) into a non-existent multi-active satellite
#    Given the MULTI_ACTIVE_SATELLITE table does not exist
#    And the RAW_STAGE table contains data
#      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
#      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
...
#
#  @fixture.multi_active_satellite
#  Scenario: [BQ-MAS-1CD-B-Updated-04] Load duplicated PK & LDTS (with different CDK & payload) into a non-existent multi-active satellite
#    Given the MULTI_ACTIVE_SATELLITE table does not exist
#    And the RAW_STAGE table contains data
#      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
#      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
...
#########
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-B-Updated-05] Load data into an empty multi-active satellite
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-B-Updated-06] Load duplicated data into an empty multi-active satellite
    Given the MULTI_ACTIVE_SATELLITE ma_sat is empty
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-B-Updated-07] Load data into an empty multi-active satellite where some records have NULL CDK(s) or Attribute(s)
    Given the MULTI_ACTIVE_SATELLITE ma_sat is empty
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-B-Updated-08] Load data with timestamps into a non-existent multi-active satellite
...
#  @fixture.multi_active_satellite
#  Scenario: [BQ-MAS-1CD-B-Updated-09] Load duplicated PK & CDK & LDTS (with different payload) into an empty multi-active satellite
#    Given the MULTI_ACTIVE_SATELLITE ma_sat is empty
#    And the RAW_STAGE table contains data
#      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
#      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
...
#
#  @fixture.multi_active_satellite
#  Scenario: [BQ-MAS-1CD-B-Updated-10] Load duplicated PK & LDTS (with different CDK & payload) into an empty multi-active satellite
#    Given the MULTI_ACTIVE_SATELLITE ma_sat is empty
#    And the RAW_STAGE table contains data
#      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
#      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
