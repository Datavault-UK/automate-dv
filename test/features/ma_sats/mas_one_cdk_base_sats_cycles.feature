Feature: [MAS-1CD-C] Multi Active Satellites
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-04] Load over several cycles with sets of records keeping the group size the same while having one or more records changed
    Given the RAW_STAGE stage is empty
    And the MAS ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-05] Load over several cycles with NULL records
    Given the RAW_STAGE stage is empty
    And the MAS ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-06] Load over several cycles with a mix of record change cases
    Given the RAW_STAGE stage is empty
    And the MAS ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  @fixture.enable_sha
  Scenario: [MAS-1CD-C-07] Load over several cycles
    Given the RAW_STAGE stage is empty
    And the MAS ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-09] 1-day cycle
    Given the RAW_STAGE stage is empty
    And the MAS ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-10] 2-day cycle
    Given the RAW_STAGE stage is empty
    And the MAS ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-11] 3-day cycle
    Given the RAW_STAGE stage is empty
    And the MAS ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-12] 4-day cycle
    Given the RAW_STAGE stage is empty
    And the MAS ma_sat is empty
