Feature: [SF-MAS-2CD-BSC] Multi Active Satellites
  Loading in cycles using separate manual loads with two CDKs

  @fixture.multi_active_satellite_cycle
  Scenario: [SF-MAS-2CD-BCD-001] Load over several cycles
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [SF-MAS-2CD-BCD-002] Load over several cycles with Timestamps
  ...
  @fixture.multi_active_satellite_cycle
  @fixture.enable_sha
  Scenario: [SF-MAS-2CD-BCD-003] Load over several cycles
    Given the RAW_STAGE_TWO_CDK stage is empty
    And the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is empty
