...
# Second load...
  ...
  # 3. HOWEVER, when news CUSTOMER (1011 andd 1012) get multiple ORDERS in the same load (be them at the same LDTS or not),
  # they (i.e. the multiple SKFs) are allowed to coexist;

  # What happens when these new DFKs become existent (in the next load) and they get new SFKs?
