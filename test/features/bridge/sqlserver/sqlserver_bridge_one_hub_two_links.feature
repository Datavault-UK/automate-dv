Feature: [SQLS-BRG-2L] Bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-001] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-002] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-003] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-004] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [SQLS-BRG-2L-005] Base load into a bridge table
