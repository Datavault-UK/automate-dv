Feature: [BQ-PIT] Point in Time
  ...
  @fixture.pit
  Scenario: [BQ-PIT-01] Load into a pit table where the AS OF table is already established with increments of a day
  ...
  @fixture.pit
  Scenario: [BQ-PIT-02] Load into a pit table where the AS OF table is already established but the final pit table will deal with NULL Values as ghosts
    Given the PIT table does not exist
    And the raw vault contains empty tables
      | HUB          | SAT                  | PIT          |
      | HUB_CUSTOMER | SAT_CUSTOMER_DETAILS | PIT_CUSTOMER |
  ...
  @fixture.pit
  Scenario: [BQ-PIT-03] Load into a pit table where the AS OF table is already established and the AS OF table has increments of 30 mins
    Given the PIT table does not exist
    And the raw vault contains empty tables
      | HUB          | SAT                  | PIT          |
      | HUB_CUSTOMER | SAT_CUSTOMER_DETAILS | PIT_CUSTOMER |
  ...
  @fixture.pit
  Scenario: [BQ-PIT-04] Load into a pit table where the AS OF table dates are before the satellites have received any entry's
    Given the PIT table does not exist
  ...
  @fixture.pit
  Scenario: [BQ-PIT-05] Load into a pit table where the AS OF table dates are after the most recent satellite entry's
    Given the PIT table does not exist
    And the raw vault contains empty tables
      | HUB          | SAT                  | PIT          |
      | HUB_CUSTOMER | SAT_CUSTOMER_DETAILS | PIT_CUSTOMER |
  ...
  @fixture.pit
  Scenario: [BQ-PIT-06] Load into a pit table over several cycles where new record is introduced on the 3rd day
    Given the raw vault contains empty tables
      | HUB          | SAT                  | PIT          |
      | HUB_CUSTOMER | SAT_CUSTOMER_DETAILS | PIT_CUSTOMER |
      |              | SAT_CUSTOMER_LOGIN   |              |
  ...
  @fixture.pit
  Scenario: [BQ-PIT-07] Load into a pit table where the as_of_dates table changes
    Given the raw vault contains empty tables
      | HUB          | SAT                  | PIT          |
      | HUB_CUSTOMER | SAT_CUSTOMER_DETAILS | PIT_CUSTOMER |
      |              | SAT_CUSTOMER_LOGIN   |              |
