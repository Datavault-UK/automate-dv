Feature: [BQ-BRG-3L] Bridge table
  Base Bridge behaviour with one hub and three links

  @fixture.bridge
  Scenario: [BQ-BRG-3L-001] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-002] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-003] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-004] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-005] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-006] Base load into a bridge table
