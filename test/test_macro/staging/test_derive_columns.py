...
@pytest.mark.macro
def test_derive_columns_correctly_generates_sql_without_source_columns_concat_escaped(request, generate_model):
    var_dict = {'columns': {'CUSTOMER_DETAILS': ['CUSTOMER_NAME', {'source_column': 'CUSTOMER DOB', 'escape': True}, 'PHONE'], 'SOURCE': "!STG_BOOKING", 'EFFECTIVE_FROM': 'LOAD_DATE'}}
