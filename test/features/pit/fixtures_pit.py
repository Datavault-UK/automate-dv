    ...
    context.seed_config = {
        ...
        "PIT_CUSTOMER": {
            "column_types": {
                ...
                "SAT_CUSTOMER_LOGIN_LDTS": "TIMESTAMPTZ",
                "SAT_CUSTOMER_PROFILE_PK": "BYTEA",
                "SAT_CUSTOMER_PROFILE_LDTS": "TIMESTAMPTZ"
            }
        }
    }
...
@fixture
def pit_one_sat_postgres(context):
    """
    Define the structures and metadata to perform PIT load
    """
    ...
    context.seed_config = {
        ...
        "PIT_CUSTOMER_1S_TS": {
            "column_types": {
                ...
                "SAT_CUSTOMER_DETAILS_TS_LDTS": "TIMESTAMPTZ"
            }
        },
        "PIT_CUSTOMER_TS": {
            "column_types": {
...
@fixture
def pit_two_sats_postgres(context):
    """
    Define the structures and metadata to perform PIT load
    """
    ...
    context.seed_config = {
        ...
        "PIT_CUSTOMER_TS": {
            "column_types": {
                ...
                "SAT_CUSTOMER_LOGIN_TS_LDTS": "TIMESTAMPTZ"
            }
        },
        "PIT_CUSTOMER_LG": {
            "column_types": {
