...
# ------------------------ TWO LINKS ------------------------
  ...
  # todo: Finish defining the test;
  #  Decide on what a "link" is (e.g. customer-order-product or customer-order?) and how the does end-dating works between one-to-many and many-to-many links
  @fixture.bridge
