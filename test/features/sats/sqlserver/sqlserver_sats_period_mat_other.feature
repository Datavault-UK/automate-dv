Feature: [SQLS-SAT-PM-O] Satellites Loaded using Period Materialization for other scenarios

  # ABORTED LOADS

  @fixture.satellite_cycle
  Scenario: [SQLS-SAT-PM-O-01] Simulate a restart of an aborted load
  ...
  @fixture.satellite_cycle
  Scenario: [SQLS-SAT-PM-O-02] Satellite load over several monthly cycles with insert_by_period into empty satellite.
    Given the RAW_STAGE stage is empty
