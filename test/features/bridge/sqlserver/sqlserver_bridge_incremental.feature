Feature: [SQLS-BRG] Bridge table
  ...
  Scenario: [SQLS-BRG-04] Bridge on one hub and one link
    ...
    And the AS_OF_DATE table is created and populated with data
      ...
      | 2018-06-01 00:00:00.000 |
      | 2018-06-01 09:00:00.000 |
      | 2018-06-01 09:00:00.003 |
      | 2018-06-01 18:00:00.000 |
      | 2018-06-01 18:00:00.003 |
      | 2018-06-02 00:00:00.000 |
    When I load the vault
    Then the BRIDGE_CUSTOMER_ORDER table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | LINK_CUSTOMER_ORDER_PK |
      ...
      | md5('1003') | 2018-06-01 09:00:00.000 | md5('1003\|\|300')     |
      | md5('1004') | 2018-06-01 09:00:00.000 | md5('1004\|\|400')     |
      | md5('1002') | 2018-06-01 09:00:00.003 | md5('1002\|\|100')     |
      | md5('1012') | 2018-06-01 09:00:00.003 | md5('1012\|\|200')     |
      | md5('1003') | 2018-06-01 09:00:00.003 | md5('1003\|\|300')     |
      | md5('1004') | 2018-06-01 09:00:00.003 | md5('1004\|\|400')     |
      | md5('1001') | 2018-06-01 18:00:00.000 | md5('1001\|\|100')     |
      | md5('1002') | 2018-06-01 18:00:00.000 | md5('1002\|\|200')     |
      | md5('1003') | 2018-06-01 18:00:00.000 | md5('1003\|\|300')     |
      | md5('1004') | 2018-06-01 18:00:00.000 | md5('1004\|\|400')     |
      | md5('1001') | 2018-06-01 18:00:00.003 | md5('1001\|\|100')     |
      | md5('1002') | 2018-06-01 18:00:00.003 | md5('1002\|\|200')     |
      | md5('1003') | 2018-06-01 18:00:00.003 | md5('1003\|\|300')     |
      | md5('1004') | 2018-06-01 18:00:00.003 | md5('1004\|\|400')     |
