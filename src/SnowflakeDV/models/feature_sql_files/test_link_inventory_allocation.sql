...
SELECT
 ...
 FROM (
    SELECT DISTINCT INVENTORY_ALLOCATION_PK, PART_PK, SUPPLIER_PK, LINEITEM_PK, LOADDATE, SOURCE,
           LAG(SOURCE, 1)
           OVER(PARTITION by INVENTORY_ALLOCATION_PK
           ORDER BY INVENTORY_ALLOCATION_PK) AS FIRST_SOURCE
    FROM (SELECT DISTINCT a.INVENTORY_ALLOCATION_PK, a.PART_PK, a.SUPPLIER_PK, a.LINEITEM_PK, a.LOADDATE, a.SOURCE
        ...
        {%- endif %}
        UNION
        SELECT DISTINCT b.INVENTORY_ALLOCATION_PK, b.PART_PK, b.SUPPLIER_PK, b.LINEITEM_PK, b.LOADDATE, b.SOURCE
        ...
        {%- endif %}
        UNION
        SELECT DISTINCT c.INVENTORY_ALLOCATION_PK, c.PART_PK, c.SUPPLIER_PK, c.LINEITEM_PK, c.LOADDATE, c.SOURCE
