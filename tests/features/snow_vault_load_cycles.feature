...
# =============================================================================
  ...
  Scenario: Test several load cycles
    ...
    Then we expect the TEST_LINK_CUSTOMER_BOOKING table to contain
      ...
      | md5('10034\|\|1001') | md5('1001') | md5('10034') | 2019-05-04 | *      |
      | md5('10035\|\|1002') | md5('1002') | md5('10035') | 2019-05-04 | *      |
      | md5('10036\|\|1003') | md5('1003') | md5('10036') | 2019-05-05 | *      |
      | md5('10037\|\|1004') | md5('1004') | md5('10037') | 2019-05-05 | *      |
      | md5('10038\|\|1005') | md5('1005') | md5('10038') | 2019-05-06 | *      |
      | md5('10039\|\|1006') | md5('1006') | md5('10039') | 2019-05-06 | *      |
      | md5('10040\|\|1007') | md5('1007') | md5('10040') | 2019-05-07 | *      |
      | md5('10041\|\|1008') | md5('1008') | md5('10041') | 2019-05-07 | *      |
      | md5('10042\|\|1009') | md5('1009') | md5('10042') | 2019-05-07 | *      |
      | md5('10043\|\|1010') | md5('1010') | md5('10043') | 2019-05-07 | *      |
      | md5('10044\|\|1011') | md5('1011') | md5('10044') | 2019-05-07 | *      |
      | md5('10045\|\|1012') | md5('1012') | md5('10045') | 2019-05-07 | *      |
      | md5('10046\|\|1013') | md5('1013') | md5('10046') | 2019-05-07 | *      |
      | md5('10047\|\|1014') | md5('1014') | md5('10047') | 2019-05-07 | *      |
      | md5('10048\|\|1015') | md5('1015') | md5('10048') | 2019-05-07 | *      |
      | md5('10070\|\|1040') | md5('1040') | md5('10070') | 2019-05-04 | *      |
