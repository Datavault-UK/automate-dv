Feature: [SQLS-XTS-COMPPK] Extended Record Tracking Satellites with composite PK

  @fixture.xts
  Scenario: [SQLS-XTS-COMPPK-001] Load one stage of records into an empty single satellite XTS
    ...
    When I load the XTS_COMPPK xts
    Then the XTS_COMPPK table should contain expected data
  ...
  @fixture.xts
  Scenario: [SQLS-XTS-COMPPK-002] Load record into a pre-populated XTS
    Given the XTS_COMPPK xts is already populated with data
      | CUSTOMER_PK | CUSTOMER_PHONE  | HASHDIFF                        | SATELLITE_NAME | LOAD_DATE  | SOURCE |
  ...
  @fixture.xts
  Scenario: [SQLS-XTS-COMPPK-003] Load record into a pre-populated XTS
    Given the XTS_COMPPK xts is already populated with data
      | CUSTOMER_PK | CUSTOMER_PHONE  | HASHDIFF                        | SATELLITE_NAME | LOAD_DATE  | SOURCE |
      | md5('1001') | 17-214-233-1214 | md5('ALICE\|\|1001\|\|ANDREWS') | SAT_CUSTOMER   | 1992-12-31 | *      |
      | md5('1002') | 17-214-233-1215 | md5('BOB\|\|1002\|\|BARNS')     | SAT_CUSTOMER   | 1992-12-31 | *      |
