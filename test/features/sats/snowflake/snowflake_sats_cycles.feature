Feature: [SF-SAT-CYC] Satellites Loaded in cycles using separate manual loads

  @fixture.satellite_cycle
  Scenario: [SF-SAT-CYC-001] SATELLITE load over several cycles
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-CYC-002] SATELLITE load over several cycles with NULL records
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-CYC-003] SATELLITE load over several cycles no PK in HASHDIFF and NULL records
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-CYC-004] SATELLITE load over several cycles with a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-CYC-005] SATELLITE load over several cycles with no PK in HASHDIFF and a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  @fixture.enable_sha
  Scenario: [SF-SAT-CYC-006] SATELLITE load over several cycles
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
