...
def test_create_ghost_record_with_all_string_and_no_extra_columns(request, generate_model):
    ...
    dbt_result, dbt_logs = dbt_runner.run_dbt_models(dbt_init, model_names=[request.node.name], args=var_dict)
...
@pytest.mark.macro
def test_create_ghost_record_with_all_string_hashing_with_sha1(request, generate_model):
    var_dict = {
        "source_model": "raw_source_sat",
        "src_pk": 'CUSTOMER_PK',
        "src_hashdiff": 'HASHDIFF',
...
@pytest.mark.macro
def test_create_ghost_record_with_payload_and_extra_columns_as_lists_hashing_with_sha1(request, generate_model):
    var_dict = {
        "source_model": "raw_source_sat",
        "src_pk": 'CUSTOMER_PK',
        "src_hashdiff": 'HASHDIFF',
...
@pytest.mark.macro
def test_create_ghost_record_with_hashdiff_using_alias(request, generate_model):
    var_dict = {
        "source_model": "raw_source_sat",
        "src_pk": 'CUSTOMER_PK',
