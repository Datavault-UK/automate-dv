Feature: Transactional_Links
  ...
  Scenario: [INCREMENTAL-LOAD] Load a populated Transactional Link
    ...
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | TRANSACTION_NUMBER | TRANSACTION_DATE | TYPE | AMOUNT  | LOADDATE   | SOURCE |
      | 1234        | 12345685           | 2019-09-20       | DR   | 3478.5  | 2019-09-22 | SAP    |
      | 1234        | 12345686           | 2019-09-20       | DR   | 10.0    | 2019-09-22 | SAP    |
      | 1235        | 12345687           | 2019-09-20       | DR   | 1734.65 | 2019-09-22 | SAP    |
      | 1236        | 12345688           | 2019-09-20       | DR   | 4832.56 | 2019-09-22 | SAP    |
      | 1237        | 12345689           | 2019-09-20       | DR   | 10000.0 | 2019-09-22 | SAP    |
    ...
    Then the T_LINK table should contain expected data
      ...
      | md5('1236\|\|12345683') | md5('1236') | 12345683           | 2019-09-19       | CR   | 236.55   | 2019-09-19     | 2019-09-21 | SAP    |
      | md5('1237\|\|12345684') | md5('1237') | 12345684           | 2019-09-19       | DR   | 3567.34  | 2019-09-19     | 2019-09-21 | SAP    |
      | md5('1234\|\|12345685') | md5('1234') | 12345685           | 2019-09-20       | DR   | 3478.5   | 2019-09-20     | 2019-09-22 | SAP    |
      | md5('1234\|\|12345686') | md5('1234') | 12345686           | 2019-09-20       | DR   | 10.0     | 2019-09-20     | 2019-09-22 | SAP    |
      ...
      | md5('1237\|\|12345689') | md5('1237') | 12345689           | 2019-09-20       | DR   | 10000.0  | 2019-09-20     | 2019-09-22 | SAP    |
  ...
  Scenario: [INCREMENTAL-LOAD] Load populated Transactional Link
    ...
    Then the T_LINK table should contain expected data
      ...
      | md5('1234\|\|12345693') | md5('1234') | 12345693           | 2019-09-21       | DR   | 30.0     | 2019-09-21     | 2019-09-23 | SAP    |
      ...
      | md5('1237\|\|12345696') | md5('1237') | 12345696           | 2019-09-21       | CR   | 40000.0  | 2019-09-21     | 2019-09-23 | SAP    |
