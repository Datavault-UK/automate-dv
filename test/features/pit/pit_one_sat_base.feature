Feature: [PIT-1SB] Point in Time
  ...
  Scenario: [PIT-1SB-01] Base load into a pit table from one satellite with dates with AS OF dates all in the past
    ...
    Then the PIT_CUSTOMER_1S table should contain expected data
      ...
      | md5('1001') | 2018-05-29 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-05-30 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-05-31 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-29 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-30 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1003') | 2018-05-29 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
  ...
  Scenario: [PIT-1SB-01-BQ] Base load into a pit table from one satellite with dates with AS OF dates all in the past
    ...
    Then the PIT_CUSTOMER_1S table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_PK            | SAT_CUSTOMER_DETAILS_LDTS |
      | md5('1001') | 2018-05-29 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-05-30 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-05-31 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-29 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-30 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1003') | 2018-05-29 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
  ...
  Scenario: [PIT-1SB-05] Base load into a pit table from one satellite with dates with an encompassing range of AS OF dates
    ...
    Then the PIT_CUSTOMER_1S table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_PK          | SAT_CUSTOMER_DETAILS_LDTS |
      | md5('1001') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-06-01 00:00:00.000 | md5('1001')                      | 2018-06-01 00:00:00.000   |
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001')                      | 2018-06-01 00:00:00.000   |
      ...
      | md5('1001') | 2018-06-06 00:00:00.000 | md5('1001')                      | 2018-06-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-06-01 00:00:00.000 | md5('1002')                      | 2018-06-01 00:00:00.000   |
      | md5('1002') | 2018-06-02 00:00:00.000 | md5('1002')                      | 2018-06-01 00:00:00.000   |
  ...
  Scenario: [PIT-1SB-06] Base load into a pit table from one satellite with timestamps with al AS OF timestamps in the past
    ...
    Then the PIT_CUSTOMER_1S_TS table should contain expected data
      ...
      | md5('1001') | 2018-05-31 12:00:00.001 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1001') | 2018-05-31 23:59:59.998 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1001') | 2018-05-31 23:59:59.999 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 12:00:00.001 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 23:59:59.998 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 23:59:59.999 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1003') | 2018-05-31 12:00:00.001 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
  ...
  Scenario: [PIT-1SB-06-BQ] Base load into a pit table from one satellite with timestamps with al AS OF timestamps in the past
    ...
    Then the PIT_CUSTOMER_1S_TS table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_TS_PK         | SAT_CUSTOMER_DETAILS_TS_LDTS |
      | md5('1001') | 2018-05-31 12:00:00.001 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1001') | 2018-05-31 23:59:59.998 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1001') | 2018-05-31 23:59:59.999 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 12:00:00.001 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 23:59:59.998 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 23:59:59.999 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1003') | 2018-05-31 12:00:00.001 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
  ...
  Scenario: [PIT-1SB-12] Base load into a pit table from one satellite with timestamps where AS OF dates are in the past
    ...
    Then the PIT_CUSTOMER_1S_TS table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_TS_PK       | SAT_CUSTOMER_DETAILS_TS_LDTS |
      | md5('1001') | 2018-05-29 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1001') | 2018-05-30 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1001') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-29 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-30 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1003') | 2018-05-29 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
  ...
  Scenario: [PIT-1SB-13] Base load into a pit table from one satellite with timestamps with an encompassing range of AS OF timestamps
    ...
    Then the PIT_CUSTOMER_1S_TS table should contain expected data
      ...
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001')                      | 2018-06-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-06-01 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-06-02 00:00:00.000 | md5('1002')                      | 2018-06-01 00:00:00.001      |
      | md5('1003') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
  ...
  Scenario: [PIT-1SB-13-BQ] Base load into a pit table from one satellite with timestamps with an encompassing range of AS OF timestamps
    ...
    Then the PIT_CUSTOMER_1S_TS table should contain expected data
      ...
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001')                        | 2018-06-01 00:00:00.000      |
      | md5('1002') | 2018-05-31 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-06-01 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1002') | 2018-06-02 00:00:00.000 | md5('1002')                        | 2018-06-01 00:00:00.001      |
      | md5('1003') | 2018-05-31 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1003') | 2018-06-01 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000      |
      | md5('1003') | 2018-06-02 00:00:00.000 | md5('1003')                        | 2018-06-01 00:00:00.002      |
  ...
  Scenario: [PIT-1SB-15] Base load into a pit table from one satellite with dates where AS OF timestamps are in the past
    ...
    Then the PIT_CUSTOMER_1S table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_PK          | SAT_CUSTOMER_DETAILS_LDTS |
      | md5('1001') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-05-31 12:30:00.001 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-05-31 23:59:59.999 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 12:30:00.001 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 23:59:59.999 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1003') | 2018-05-31 00:00:00.000 | 00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
  ...
  Scenario: [PIT-1SB-15-BQ] Base load into a pit table from one satellite with dates where AS OF timestamps are in the past
    ...
    Then the PIT_CUSTOMER_1S table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_PK            | SAT_CUSTOMER_DETAILS_LDTS |
      | md5('1001') | 2018-05-31 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-05-31 12:30:00.001 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1001') | 2018-05-31 23:59:59.999 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 12:30:00.001 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1002') | 2018-05-31 23:59:59.999 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
      | md5('1003') | 2018-05-31 00:00:00.000 | 0x00000000000000000000000000000000 | 1900-01-01 00:00:00.000   |
