Feature: [BQ-LNK-RM] Links Loaded using Rank Materialization

  @fixture.single_source_link
  Scenario: [BQ-LNK-RM-01] Load a simple stage table into a non-existent link table
  ...
  Scenario: [BQ-LNK-RM-02] Union three staging tables to feed empty link
