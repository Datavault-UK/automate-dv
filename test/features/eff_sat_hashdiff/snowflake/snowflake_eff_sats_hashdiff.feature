Feature: [SF-EFH]  Effectivity Satellites with a Hashdiff
  ...
  Scenario: [SF-EFH-004] New Link record Added
    ...
    Then the EFF_SAT table should contain expected data
      ...
      | md5('2000\|\|BBB') | md5('2000') | md5('BBB') | md5('2000\|\|BBB\|\|TRUE\|\|2020-01-09') | 2020-01-09     | TRUE   | 2020-01-10 | orders |
      | md5('3000\|\|CCC') | md5('3000') | md5('CCC') | md5('3000\|\|CCC\|\|TRUE\|\|2020-01-09') | 2020-01-09     | TRUE   | 2020-01-10 | orders |
      | md5('4000\|\|DDD') | md5('4000') | md5('DDD') | md5('4000\|\|DDD\|\|TRUE\|\|2020-01-10') | 2020-01-10     | TRUE   | 2020-01-11 | orders |
      | md5('5000\|\|EEE') | md5('5000') | md5('EEE') | md5('5000\|\|EEE\|\|TRUE\|\|2020-01-10') | 2020-01-10     | TRUE   | 2020-01-11 | orders |
  ...
  Scenario: [SF-EFH-005] Link is Changed
    ...
    Then the EFF_SAT table should contain expected data
      ...
      | md5('2000\|\|BBB') | md5('2000') | md5('BBB') | md5('2000\|\|BBB\|\|TRUE\|\|2020-01-09')  | 2020-01-09     | TRUE   | 2020-01-10 | orders |
      | md5('3000\|\|CCC') | md5('3000') | md5('CCC') | md5('3000\|\|CCC\|\|TRUE\|\|2020-01-09')  | 2020-01-09     | TRUE   | 2020-01-10 | orders |
      | md5('3000\|\|CCC') | md5('3000') | md5('CCC') | md5('3000\|\|CCC\|\|FALSE\|\|2020-01-11') | 2020-01-11     | FALSE  | 2020-01-12 | orders |
      | md5('4000\|\|CCC') | md5('4000') | md5('CCC') | md5('4000\|\|CCC\|\|TRUE\|\|2020-01-11')  | 2020-01-11     | TRUE   | 2020-01-12 | orders |
  ...
  Scenario: [SF-EFH-006] 2 loads, Link is Changed Back Again, driving key is ORDER_PK
    ...
    Then the EFF_SAT table should contain expected data
      ...
      | md5('3000\|\|CCC') | md5('3000') | md5('CCC') | md5('3000\|\|CCC\|\|FALSE\|\|2020-01-11') | 2020-01-11     | FALSE  | 2020-01-12 | orders |
      | md5('4000\|\|CCC') | md5('4000') | md5('CCC') | md5('4000\|\|CCC\|\|TRUE\|\|2020-01-11')  | 2020-01-11     | TRUE   | 2020-01-12 | orders |
      | md5('4000\|\|CCC') | md5('4000') | md5('CCC') | md5('4000\|\|CCC\|\|FALSE\|\|2020-01-12') | 2020-01-12     | FALSE  | 2020-01-13 | orders |
      | md5('5000\|\|CCC') | md5('5000') | md5('CCC') | md5('5000\|\|CCC\|\|TRUE\|\|2020-01-12')  | 2020-01-12     | TRUE   | 2020-01-13 | orders |
  ...
  Scenario: [SF-EFH-008] No New Eff Sat Added if Driving Foreign Key is NULL and Latest EFF Sat is already closed
    Given the EFF_SAT eff_sat_hashdiff is already populated with data
      ...
      | md5('3000\|\|CCC') | md5('3000') | md5('CCC') | md5('3000\|\|CCC\|\|TRUE\|\|2020-01-09')  | 2020-01-09     | TRUE   | 2020-01-10 | orders |
      | md5('4000\|\|DDD') | md5('4000') | md5('DDD') | md5('4000\|\|DDD\|\|TRUE\|\|2020-01-10')  | 2020-01-10     | TRUE   | 2020-01-11 | orders |
      | md5('5000\|\|EEE') | md5('5000') | md5('EEE') | md5('5000\|\|EEE\|\|FASLE\|\|2020-01-10') | 2020-01-10     | FALSE  | 2020-01-11 | orders |
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | ORDER_ID | EFFECTIVE_FROM | LOAD_DATE  | SOURCE | STATUS |
      | 5000        | <null>   | 2020-01-12     | 2020-01-13 | orders | TRUE   |
    And I stage the STG_CUSTOMER data
