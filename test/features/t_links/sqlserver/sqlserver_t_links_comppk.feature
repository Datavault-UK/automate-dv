Feature: [SQLS-TLK_COMPPK] Transactional Links with composite src_pk
  ...
  @fixture.t_link_comppk
  Scenario: [SQLS-TLK-COMPPK-005] Load an a non-existent Transactional Link with the rank materialisation
    Given the T_LINK_COMPPK table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | ORDER_ID | TRANSACTION_NUMBER | TRANSACTION_DATE | TYPE | AMOUNT   | LOAD_DATE  | SOURCE |
      | 1234        | 4321     | 12345678           | 2019-09-19       | DR   | 2340.50  | 2019-09-21 | SAP    |
  ...
  @fixture.t_link_comppk
  Scenario: [SQLS-TLK-COMPPK-006] Load an a non-existent Transactional Link with the incremental materialisation
    Given the T_LINK_COMPPK table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | ORDER_ID | TRANSACTION_NUMBER | TRANSACTION_DATE | TYPE | AMOUNT   | LOAD_DATE  | SOURCE |
      | 1234        | 4321     | 12345678           | 2019-09-19       | DR   | 2340.50  | 2019-09-21 | SAP    |
