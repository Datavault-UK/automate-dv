Feature: [SAT-PM-V] Satellite loads with period materialization using various time scales
  ...
  Scenario: [SAT-PM-V-01] Satellite load with microsecond interval and intra-load duplicates.
    ...
    And I insert by period into the SATELLITE_TZ sat by microsecond with date range: 2019-05-03 01:00:00.000000 to 2019-05-03 01:00:00.000010 and LDTS LOAD_DATE_TZ with type TIMESTAMP
    ...
    Then the SATELLITE_TZ table should contain expected data
      ...
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214')  | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')    | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1003') | md5('1995-08-03\|\|1003\|\|CHARLEY\|\|17-214-233-1216') | Charley       | 1995-08-03   | 17-214-233-1216 | 2019-05-03 01:00:00.000005 | 2019-05-03 01:00:00.000005 | *      |
      | md5('1004') | md5('1995-08-10\|\|1004\|\|DAVID\|\|17-214-233-1217')   | David         | 1995-08-10   | 17-214-233-1217 | 2019-05-03 01:00:00.000005 | 2019-05-03 01:00:00.000005 | *      |
  ...
  Scenario: [SAT-PM-V-02] Satellite load with millisecond interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by millisecond with date range: 2019-05-03 01:00:00.000000 to 2019-05-03 01:00:00.009000 and LDTS LOAD_DATE_TZ with type TIMESTAMP
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-03] Satellite load with second interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by second with date range: 2019-05-03 01:00:00.000000 to 2019-05-03 01:00:10.000000 and LDTS LOAD_DATE_TZ with type TIMESTAMP
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-04] Satellite load with minute interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by minute with date range: 2019-05-03 01:00:00.000000 to 2019-05-03 01:11:00.000000 and LDTS LOAD_DATE_TZ with type TIMESTAMP
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-05] Satellite load with week interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by week with date range: 2019-05-03 01:00:00.000000 to 2019-05-24 01:10:00.000000 and LDTS LOAD_DATE_TZ with type TIMESTAMP
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
    And I insert by period into the SATELLITE_TZ sat by week with date range: 2019-05-03 01:00:00.000000 to 2019-05-24 01:00:00.000000 and LDTS LOAD_DATE_TZ with type TIMESTAMP
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                                | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214')  | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')    | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-06] Satellite load with month interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by month with date range: 2019-05-03 01:00:00.000000 to 2019-07-03 01:00:00.000000 and LDTS LOAD_DATE_TZ with type TIMESTAMP
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
