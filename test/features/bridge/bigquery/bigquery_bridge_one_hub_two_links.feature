Feature: [BQ-BRG-2L] Bridge table
  Base Bridge behaviour with one hub and two links

  @fixture.bridge
  Scenario: [BQ-BRG-2L-001] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-2L-002] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-2L-003] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-2L-004] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-2L-005] Base load into a bridge table
