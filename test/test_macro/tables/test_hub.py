...
def test_hub_macro_correctly_generates_sql_for_single_source(current_test_name):
    process_logs = dbtvault_harness_utils.run_dbt_models(model_names=[current_test_name], full_refresh=True)
