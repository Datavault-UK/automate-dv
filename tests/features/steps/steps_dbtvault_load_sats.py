...
def step_impl(context):
    ...
    context.db_utils.drop_and_create(DATABASE, STG_SCHEMA, f"test_stg_customer_details_{MODE.lower()}",
    ...
    context.db_utils.insert_data_from_ct(context.table, f"test_stg_customer_details_{MODE.lower()}", STG_SCHEMA,
                                         context.connection)
...
def step_impl(context):
    ...
    context.db_utils.insert_data_from_ct(context.table, f"test_sat_customer_details_{MODE.lower()}", VLT_SCHEMA,
                                         context.connection)
...
def step_impl(context):
    context.db_utils.create_schema(DATABASE, VLT_SCHEMA, context.connection)
    context.db_utils.drop_and_create(DATABASE, VLT_SCHEMA, f"test_sat_cust_customer_details_{MODE.lower()}",
