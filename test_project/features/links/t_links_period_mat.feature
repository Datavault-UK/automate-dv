...
Feature: Transactional Links using Period Materialization
  ...
  Scenario: [BASE-LOAD] Load an a non-existent Transactional Link
    ...
    And the RAW_STAGE table contains data
      ...
      | 1234        | 12345679           | 2019-09-19       | CR   | 123.40   | 2019-09-22 | SAP    |
      | 1234        | 12345680           | 2019-09-19       | DR   | 2546.23  | 2019-09-22 | SAP    |
      | 1234        | 12345681           | 2019-09-19       | CR   | -123.40  | 2019-09-23 | SAP    |
      | 1235        | 12345682           | 2019-09-19       | CR   | 37645.34 | 2019-09-24 | SAP    |
      | 1236        | 12345683           | 2019-09-19       | CR   | 236.55   | 2019-09-25 | SAP    |
      | 1237        | 12345684           | 2019-09-19       | DR   | 3567.34  | 2019-09-26 | SAP    |
    ...
    Then the T_LINK table should contain expected data
      ...
      | md5('1234\|\|12345679') | md5('1234') | 12345679           | 2019-09-19       | CR   | 123.40   | 2019-09-19     | 2019-09-22 | SAP    |
      | md5('1234\|\|12345680') | md5('1234') | 12345680           | 2019-09-19       | DR   | 2546.23  | 2019-09-19     | 2019-09-22 | SAP    |
      | md5('1234\|\|12345681') | md5('1234') | 12345681           | 2019-09-19       | CR   | -123.40  | 2019-09-19     | 2019-09-23 | SAP    |
      | md5('1235\|\|12345682') | md5('1235') | 12345682           | 2019-09-19       | CR   | 37645.34 | 2019-09-19     | 2019-09-24 | SAP    |
      | md5('1236\|\|12345683') | md5('1236') | 12345683           | 2019-09-19       | CR   | 236.55   | 2019-09-19     | 2019-09-25 | SAP    |
      | md5('1237\|\|12345684') | md5('1237') | 12345684           | 2019-09-19       | DR   | 3567.34  | 2019-09-19     | 2019-09-26 | SAP    |
