Feature: [SQLS-SAT-OOS] Out of Sequence Satellites
  ...
  Scenario: [SQLS-SAT-OOS-01] Inserts no new records if hashdiff matches previous loaddate hashdiff
  ...
  @fixture.out_of_sequence_satellite
  Scenario: [SQLS-SAT-OOS-02] Inserts a record if hashdiff does not matches previous loaddate hashdiff but matches the next loaddate hashdiff
    Given the XTS xts is already populated with data
      | CUSTOMER_PK | HASHDIFF                                              | SATELLITE_NAME   | LOAD_DATE  | SOURCE |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS | 1993-01-01 | *      |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS | 1993-01-02 | *      |
  ...
  @fixture.out_of_sequence_satellite
  Scenario: [SQLS-SAT-OOS-03] Inserts a record if hashdiff does not match previous loaddate hashdiff and the previous loaddate hashdiff matches the next loaddate hashdiff
    Given the XTS xts is already populated with data
      | CUSTOMER_PK | HASHDIFF                                              | SATELLITE_NAME   | LOAD_DATE  | SOURCE |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS | 1993-01-01 | *      |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS | 1993-01-02 | *      |
  ...
  @fixture.out_of_sequence_satellite
  Scenario: [SQLS-SAT-OOS-04] Empty xts, empty sat fed by staging should result in one line in sat.
  ...
  @fixture.out_of_sequence_satellite
  Scenario: [SQLS-SAT-OOS-05] Late arriving sat is on 1992-12-31 is the same, pre-populated sat as above. Row inserted.
    Given the XTS xts is already populated with data
      | CUSTOMER_PK | HASHDIFF                                              | SATELLITE_NAME         | LOAD_DATE  | SOURCE |
  ...
  @fixture.out_of_sequence_satellite
  Scenario: [SQLS-SAT-OOS-06] Late arriving sat is on 1992-12-31 is different, pre-populated sat as above. Row inserted.
    Given the XTS xts is already populated with data
      | CUSTOMER_PK | HASHDIFF                                              | SATELLITE_NAME         | LOAD_DATE  | SOURCE |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS_EARLY | 1993-01-01 | *      |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS_EARLY | 1993-01-02 | *      |
  ...
  @fixture.out_of_sequence_satellite
  Scenario: [SQLS-SAT-OOS-07] Late arriving sat is on 1993-01-09 is the same, pre-populated as above. No insert.
    Given the XTS xts is already populated with data
      | CUSTOMER_PK | HASHDIFF                                              | SATELLITE_NAME        | LOAD_DATE  | SOURCE |
  ...
  @fixture.out_of_sequence_satellite
  Scenario: [SQLS-SAT-OOS-08] Late arriving sat is on 1993-01-09 is different, pre-populated as above. Row inserted.
    Given the XTS xts is already populated with data
      | CUSTOMER_PK | HASHDIFF                                              | SATELLITE_NAME        | LOAD_DATE  | SOURCE |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS_LATE | 1993-01-01 | *      |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS_LATE | 1993-01-02 | *      |
  ...
  @fixture.out_of_sequence_satellite
  Scenario: [SQLS-SAT-OOS-09] Several customers mix and match.
    Given the XTS xts is already populated with data
      | CUSTOMER_PK | HASHDIFF                                              | SATELLITE_NAME   | LOAD_DATE  | SOURCE |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS | 1993-01-01 | *      |
      | md5('1001') | md5('1997-04-24\|\|1001\|\|ALICE\|\|17-214-233-1214') | SAT_CUSTOMER_OOS | 1993-01-02 | *      |
