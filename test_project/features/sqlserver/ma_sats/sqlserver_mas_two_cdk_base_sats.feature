@fixture.set_workdir
Feature: Multi Active Satellites - Base satellite behaviour with two CDKs (sqlserver)
  ...
  @fixture.multi_active_satellite_sqlserver
  Scenario: [BASE-LOAD-NULLS] Load data into an empty multi-active satellite where some records have NULL PK(s), CDK(s) and Attribute(s)
    Given the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is empty
    And the RAW_STAGE_TWO_CDK table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | EXTENSION | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 123       | 1993-01-01 | *      |
