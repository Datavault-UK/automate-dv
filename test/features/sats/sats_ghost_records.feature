Feature: [SAT-GR] Implementing ghost records
  ...
  Scenario: [SAT-GR-SHA-07] Load data and ghost record into non-existent satellite with SHA1 hash
    ...
    Then the SATELLITE table should contain expected data
      | CUSTOMER_PK          | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | HASHDIFF                                               | EFFECTIVE_FROM | LOAD_DATE  | SOURCE             |
      | 00000000000000000000 | <null>        | <null>          | <null>       | 00000000000000000000                                   | 1900-01-01     | 1900-01-01 | AUTOMATE_DV_SYSTEM |
  ...
  Scenario: [SAT-GR-12] Load data and ghost record into non-existent satellite with different source system
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 1997-04-24   | 17-214-233-1214 | 1993-01-01 | *      |
  ...
  @fixture.enable_ghost_records
  @fixture.system_record_value
  Scenario: [SAT-GR-13] Load data and ghost record into satellite already populated with a ghost record and change of source system
    Given the SATELLITE sat is already populated with data
      | CUSTOMER_PK                      | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | HASHDIFF                                              | EFFECTIVE_FROM | LOAD_DATE  | SOURCE             |
      | 00000000000000000000000000000000 | <null>        | <null>          | <null>       | 00000000000000000000000000000000                      | 1900-01-01     | 1900-01-01 | AUTOMATE_DV_SYSTEM |
      | md5('1004')                      | Dom           | 17-214-233-1217 | 2018-04-13   | md5('2018-04-13\|\|1004\|\|DOM\|\|17-214-233-1217')   | 1993-01-01     | 1993-01-01 | *                  |
  ...
  @fixture.satellite
  @fixture.enable_ghost_records
  Scenario: [SAT-GR-14] Load data and ghost record into non-existent satellite with Hashdiff alias
  ...
  @fixture.satellite
  @fixture.enable_ghost_records
  Scenario: [SAT-GR-15] Load data and ghost record into non-existent satellite with TIMESTAMP_TZ date types
