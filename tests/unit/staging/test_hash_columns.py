...
dbt_test = DBTTestUtils(model_directory=f'{macro_folder}/hash_columns')
...
def test_hash_columns_correctly_generates_hashed_columns_for_single_columns():
    model = 'test_hash_columns'
    expected_file_name = 'test_hash_columns_correctly_generates_hashed_columns_for_single_columns'
    var_dict = {'columns': {'BOOKING_PK': 'BOOKING_REF', 'CUSTOMER_PK': 'CUSTOMER_ID'}}
...
def test_hash_columns_correctly_generates_hashed_columns_for_composite_columns():
    model = 'test_hash_columns'
    expected_file_name = 'test_hash_columns_correctly_generates_hashed_columns_for_composite_columns'
    var_dict = {'columns': {'BOOKING_PK': 'BOOKING_REF', 'CUSTOMER_DETAILS': ['ADDRESS', 'PHONE', 'NAME']}}
...
def test_hash_columns_correctly_generates_sorted_hashed_columns_for_composite_columns():
    model = 'test_hash_columns'
...
def test_hash_columns_correctly_generates_sorted_hashed_columns_for_multiple_composite_columns():
    model = 'test_hash_columns'
    expected_file_name = 'test_hash_columns_correctly_generates_sorted_hashed_columns_for_multiple_composite_columns'
    var_dict = {
        'columns': {
            'BOOKING_PK'   : 'BOOKING_REF', 'CUSTOMER_DETAILS': {'columns': ['ADDRESS', 'PHONE', 'NAME'], 'sort': True},
...
def test_hash_columns_correctly_generates_unsorted_hashed_columns_for_composite_columns_mapping():
    model = 'test_hash_columns'
    expected_file_name = 'test_hash_columns_correctly_generates_unsorted_hashed_columns_for_composite_columns_mapping'
    var_dict = {
        'columns': {'BOOKING_PK': 'BOOKING_REF', 'CUSTOMER_DETAILS': {'columns': ['ADDRESS', 'PHONE', 'NAME']}}, }
...
def test_hash_columns_correctly_generates_sql_from_yaml():
    model = 'test_hash_columns'
...
def test_hash_columns_correctly_generates_sql_with_constants_from_yaml():
...
def test_hash_columns_raises_warning_if_mapping_without_sort():
    ...
    expected_sql = dbt_test.retrieve_expected_sql(expected_file_name)
    actual_sql = dbt_test.retrieve_compiled_model(model)
    warning_message = "You provided a list of columns under a 'column' key, "    "but did not provide the 'sort' flag. HASHDIFF columns should be sorted."
