Feature: [BQ-BRG-3L] Bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-01] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-02] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-03] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-04] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-05] Base load into a bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-3L-06] Base load into a bridge table
