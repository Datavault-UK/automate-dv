Feature: [SC] Satellites Loaded in cycles using separate manual loads

  @fixture.satellite_cycle
  Scenario: [SC-001] SATELLITE load over several cycles
  ...
  @fixture.satellite_cycle
  Scenario: [SC-002] SATELLITE load over several cycles with NULL records
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SC-003] SATELLITE load over several cycles no PK in HASHDIFF and NULL records
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SC-004] SATELLITE load over several cycles with a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SC-005] SATELLITE load over several cycles with no PK in HASHDIFF and a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  @fixture.enable_sha
  Scenario: [SC-006] SATELLITE load over several cycles
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
