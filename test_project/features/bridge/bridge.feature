...
# ------------------------ THREE LINKS ------------------------
  ...
  @fixture.bridge
  Scenario: [BASE-LOAD] Base load into a bridge table from one hub and three links with history and encompassing range of AS_OF dates
    Given the BRIDGE_CUSTOMER_ORDER_PRODUCT_COMPONENT table does not exist
    And the raw vault contains empty tables
      | HUB          | LINK                   | EFF_SAT                   | BRIDGE                                  |
      | HUB_CUSTOMER | LINK_PRODUCT_COMPONENT | EFF_SAT_PRODUCT_COMPONENT | BRIDGE_CUSTOMER_ORDER_PRODUCT_COMPONENT |
    ...
    And the RAW_PRODUCT_COMPONENT table contains data
      | PRODUCT_ID | COMPONENT_ID | LOAD_DATE               | END_DATE                | SOURCE |
      | AAA        | AAA-0        | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | AAA        | AAA-0        | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | AAB        | AAB-0        | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      ...
      | BBB        | BBB-0        | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | CCC        | CCC-0        | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | CCA        | CCA-0        | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | CCA        | CCA-1        | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | CCB        | CCB-0        | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | CCB        | CCB-1        | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | CCB        | CCB-2        | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.999 | *      |
      | DDD        | DDD-0        | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | DDD        | DDD-1        | 2018-06-01 00:00:00.001 | 9999-12-31 23:59:59.999 | *      |
    And I create the STG_PRODUCT_COMPONENT stage
    And the AS_OF_DATE table is created and populated with data
      | AS_OF_DATE              |
      | 2018-05-31 00:00:00.000 |
    ...
    Then the LINK_PRODUCT_COMPONENT table should contain expected data
      | PRODUCT_COMPONENT_PK | PRODUCT_FK  | COMPONENT_FK | LOAD_DATE               | SOURCE |
      | md5('AAA-0\|\|AAA')  | md5('AAA')  | md5('AAA-0') | 2018-06-01 00:00:00.000 | *      |
      | md5('AAB-0\|\|AAB')  | md5('AAB')  | md5('AAB-0') | 2018-06-01 12:00:00.000 | *      |
      ...
      | md5('BBB-0\|\|BBB')  | md5('BBB')  | md5('BBB-0') | 2018-06-01 00:00:00.000 | *      |
      | md5('CCC-0\|\|CCC')  | md5('CCC')  | md5('CCC-0') | 2018-06-01 00:00:00.000 | *      |
      | md5('CCA-0\|\|CCA')  | md5('CCA')  | md5('CCA-0') | 2018-06-01 09:00:00.000 | *      |
      | md5('CCA-1\|\|CCA')  | md5('CCA')  | md5('CCA-1') | 2018-06-01 09:00:00.000 | *      |
      | md5('CCB-0\|\|CCB')  | md5('CCB')  | md5('CCB-0') | 2018-06-01 18:00:00.000 | *      |
      | md5('CCB-1\|\|CCB')  | md5('CCB')  | md5('CCB-1') | 2018-06-01 18:00:00.000 | *      |
      | md5('CCB-2\|\|CCB')  | md5('CCB')  | md5('CCB-2') | 2018-06-01 18:00:00.000 | *      |
      | md5('DDD-0\|\|DDD')  | md5('DDD')  | md5('DDD-0') | 2018-06-01 00:00:00.000 | *      |
      | md5('DDD-1\|\|DDD')  | md5('DDD')  | md5('DDD-1') | 2018-06-01 00:00:00.001 | *      |
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      | CUSTOMER_ORDER_PK  | CUSTOMER_FK | ORDER_FK   | START_DATE              | END_DATE                | EFFECTIVE_FROM          | LOAD_DATE               | SOURCE |
      | md5('1001\|\|100') | md5('1001') | md5('100') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.999 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1001\|\|101') | md5('1001') | md5('101') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.999 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
    ...
    Then the EFF_SAT_PRODUCT_COMPONENT table should contain expected data
      | PRODUCT_COMPONENT_PK | PRODUCT_FK  | COMPONENT_FK | START_DATE              | END_DATE                | EFFECTIVE_FROM          | LOAD_DATE               | SOURCE |
      | md5('AAA-0\|\|AAA')  | md5('AAA')  | md5('AAA-0') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.999 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('AAA-0\|\|AAA')  | md5('AAA')  | md5('AAA-0') | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.999 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
      | md5('AAB-0\|\|AAB')  | md5('AAB')  | md5('AAB-0') | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.999 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
      ...
      | md5('CCA-0\|\|CCA')  | md5('CCA')  | md5('CCA-0') | 2018-06-01 09:00:00.000 | 2018-06-01 17:59:59.999 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      | md5('CCA-1\|\|CCA')  | md5('CCA')  | md5('CCA-1') | 2018-06-01 09:00:00.000 | 2018-06-01 17:59:59.999 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      | md5('CCB-0\|\|CCB')  | md5('CCB')  | md5('CCB-0') | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.999 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      | md5('CCB-1\|\|CCB')  | md5('CCB')  | md5('CCB-1') | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.999 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      | md5('CCB-2\|\|CCB')  | md5('CCB')  | md5('CCB-2') | 2018-06-01 18:00:00.000 | 9999-12-31 23:59:59.999 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
      | md5('DDD-0\|\|DDD')  | md5('DDD')  | md5('DDD-0') | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('DDD-1\|\|DDD')  | md5('DDD')  | md5('DDD-1') | 2018-06-01 00:00:00.001 | 9999-12-31 23:59:59.999 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
    Then the BRIDGE_CUSTOMER_ORDER_PRODUCT table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | LINK_CUSTOMER_ORDER_PK | EFF_SAT_CUSTOMER_ORDER_ENDDATE | LINK_ORDER_PRODUCT_PK | EFF_SAT_ORDER_PRODUCT_ENDDATE | LINK_PRODUCT_COMPONENT_PK | EFF_SAT_PRODUCT_COMPONENT_ENDDATE |
      | md5('1002') | 2018-06-01 00:00:00.000 | md5('1002\|\|200')     | 9999-12-31 23:59:59.999        | md5('200\|\|BBB')     | 9999-12-31 23:59:59.999       | md5('BBB-0\|\|BBB')       | 9999-12-31 23:59:59.999           |
      ...
      | md5('1001') | 2018-06-01 12:00:00.000 | md5('1001\|\|100')     | 9999-12-31 23:59:59.999        | md5('100\|\|AAAA')    | 9999-12-31 23:59:59.999       | md5('AAA-0\|\|AAAA'       | 9999-12-31 23:59:59.999           |
      | md5('1001') | 2018-06-01 12:00:00.000 | md5('1001\|\|100')     | 9999-12-31 23:59:59.999        | md5('100\|\|AAAA')    | 9999-12-31 23:59:59.999       | md5('AAA-1\|\|AAAA'       | 9999-12-31 23:59:59.999           |
      ...
      | md5('1004') | 2018-06-01 12:00:00.000 | md5('1004\|\|400')     | 9999-12-31 23:59:59.999        | md5('400\|\|DDD')     | 9999-12-31 23:59:59.999       | md5('DDD-1\|\|DDD')       | 9999-12-31 23:59:59.999           |
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001\|\|100')     | 9999-12-31 23:59:59.999        | md5('100\|\|AAA')     | 9999-12-31 23:59:59.999       | md5('AAA-0\|\|AAA'        | 9999-12-31 23:59:59.999           |
      ...
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001\|\|100')     | 9999-12-31 23:59:59.999        | md5('100\|\|AAAA')    | 9999-12-31 23:59:59.999       | md5('AAA-0\|\|AAAA'       | 9999-12-31 23:59:59.999           |
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001\|\|100')     | 9999-12-31 23:59:59.999        | md5('100\|\|AAAA')    | 9999-12-31 23:59:59.999       | md5('AAA-1\|\|AAAA'       | 9999-12-31 23:59:59.999           |
      | md5('1002') | 2018-06-02 00:00:00.000 | md5('1002\|\|200')     | 9999-12-31 23:59:59.999        | md5('200\|\|BBB')     | 9999-12-31 23:59:59.999       | md5('BBB-0\|\|BBB')       | 9999-12-31 23:59:59.999           |
      ...
      | md5('1004') | 2018-06-02 00:00:00.000 | md5('1004\|\|400')     | 9999-12-31 23:59:59.999        | md5('400\|\|DDD')     | 9999-12-31 23:59:59.999       | md5('DDD-1\|\|DDD')       | 9999-12-31 23:59:59.999           |
