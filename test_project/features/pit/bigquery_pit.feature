...
Feature: pit
  ...
  Scenario: Load into a pit table where the AS OF table is already established with increments of a day
    ...
    Then the SAT_CUSTOMER_LOGIN table should contain expected data
      ...
      | md5('1001') | 2019-01-01 02:00:00 | Phone       | md5('PHONE\|\|2019-01-01 02:00:00')  | 2019-01-02 00:00:00.000000 | 2019-01-02 00:00:00.000000 | *      |
      | md5('1001') | 2019-01-02 03:00:00 | Phone       | md5('PHONE\|\|2019-01-02 03:00:00')  | 2019-01-03 00:00:00.000000 | 2019-01-03 00:00:00.000000 | *      |
      | md5('1001') | 2019-01-03 01:00:00 | Laptop      | md5('LAPTOP\|\|2019-01-03 01:00:00') | 2019-01-04 00:00:00.000000 | 2019-01-04 00:00:00.000000 | *      |
      | md5('1002') | 2019-01-01 05:00:00 | Tablet      | md5('TABLET\|\|2019-01-01 05:00:00') | 2019-01-02 00:00:00.000000 | 2019-01-02 00:00:00.000000 | *      |
      | md5('1002') | 2019-01-02 06:00:00 | Tablet      | md5('TABLET\|\|2019-01-02 06:00:00') | 2019-01-03 00:00:00.000000 | 2019-01-03 00:00:00.000000 | *      |
      | md5('1002') | 2019-01-03 08:00:00 | Tablet      | md5('TABLET\|\|2019-01-03 08:00:00') | 2019-01-04 00:00:00.000000 | 2019-01-04 00:00:00.000000 | *      |
  ...
  Scenario: Load into a pit table where the AS OF table is already established but the final pit table will deal with NULL Values as ghosts
    ...
    Then the PIT_CUSTOMER table should contain expected data
      ...
      | md5('1001') | 2019-01-03 00:00:00.000000 | md5('1001')             | 2018-06-01 00:00:00.000000 | md5('1001')           | 2019-01-03 00:00:00.000000 | md5('1001')             | 2019-01-03 00:00:00.000000 |
      | md5('1001') | 2019-01-04 00:00:00.000000 | md5('1001')             | 2018-06-01 00:00:00.000000 | md5('1001')           | 2019-01-04 00:00:00.000000 | md5('1001')             | 2019-01-04 00:00:00.000000 |
      | md5('1002') | 2019-01-02 00:00:00.000000 | md5('1002')             | 2018-12-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | md5('1002')             | 2019-01-02 00:00:00.000000 |
      | md5('1002') | 2019-01-03 00:00:00.000000 | md5('1002')             | 2018-12-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | md5('1002')             | 2019-01-03 00:00:00.000000 |
      | md5('1002') | 2019-01-04 00:00:00.000000 | md5('1002')             | 2018-12-01 00:00:00.000000 | md5('1002')           | 2019-01-04 00:00:00.000000 | md5('1002')             | 2019-01-04 00:00:00.000000 |
  ...
  Scenario: Load into a pit table where the AS OF table is already established and the AS OF table has increments of 30 mins
    ...
    And the RAW_STAGE_LOGIN table contains data
      ...
      | 1001        | 2019-01-01 10:36:00 | Phone       | 2019-01-01 10:45:00 | *      |
  ...
  Scenario: Load into a pit table where the AS OF table dates are before the satellites have received any entry's
    ...
    Then the PIT_CUSTOMER table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE                 | SAT_CUSTOMER_DETAILS_PK | SAT_CUSTOMER_DETAILS_LDTS  | SAT_CUSTOMER_LOGIN_PK | SAT_CUSTOMER_LOGIN_LDTS    | SAT_CUSTOMER_PROFILE_PK | SAT_CUSTOMER_PROFILE_LDTS  |
      | md5('1001') | 2017-01-02 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 |
      | md5('1001') | 2017-01-03 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 |
      | md5('1001') | 2017-01-04 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 |
      | md5('1002') | 2017-01-02 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 |
      | md5('1002') | 2017-01-03 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 |
      | md5('1002') | 2017-01-04 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 |
  ...
  Scenario: Load into a pit table over several cycles where new record is introduced on the 3rd day
    ...
    Then the PIT_CUSTOMER table should contain expected data
      ...
      | md5('1003') | 2019-01-04 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 |
      | md5('1003') | 2019-01-05 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 | 0000000000      | 1900-01-01 00:00:00.000000 | 0000000000        | 1900-01-01 00:00:00.000000 |
