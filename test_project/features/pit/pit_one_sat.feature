...
# todo: Add the *complete* pit_one_sat fixture to fixtures.py (ask Norbert for that)
# todo: Change the names of the tables in the tests below in accordance to the table names defined in pit_two_sat
# todo: Add the new fixture to environment.py  # todo: Discuss with Neil the situation of the date/time format (of AS OF) or LDTSs;
