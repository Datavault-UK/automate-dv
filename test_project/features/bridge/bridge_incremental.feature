...
#    When I load the vault
    ...
    Then the BRIDGE_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1012') | 2018-06-01 09:00:00.001 | md5('1012\|\|200')     | 9999-12-31 23:59:59.999        |
...
#    When I load the vault
  ...
  # TODO: the eff_sat does not seem to deal with multiple Driven Keys (or SFKs) for the same Driving Key (DFK);
  #  e.g. an order gets either a new product on top of the existing one OR the existing one gets changed to more products (without keeping the old product)
  @fixture.enable_auto_end_date
  @fixture.bridge
