Feature: [SF-EFF-CLD] Effectivity Satellites without automatic end-dating
  Tests for eff_sat (without automatic end-dating) loading closed records

  @fixture.eff_satellite
  Scenario: [SF-EFF-CLD-01] Load data into a non-existent effectivity satellite
  ...
  @fixture.eff_satellite
  Scenario: [SF-EFF-CLD-02] Load data into an empty effectivity satellite
  ...
  @fixture.eff_satellite
  Scenario: [SF-EFF-CLD-03] One link is changed and the active link is end dated
  ...
  @fixture.eff_satellite
  Scenario: [SF-EFF-CLD-04] Two incremental loads - flip flop (CCC changes from 3000 to 4000, and then back to 3000)
    Given the EFF_SAT eff_sat is already populated with data
      | CUSTOMER_ORDER_PK  | CUSTOMER_PK | ORDER_PK   | START_DATE | END_DATE   | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1000\|\|AAA') | md5('1000') | md5('AAA') | 2020-01-09 | 9999-12-31 | 2020-01-09     | 2020-01-10 | orders |
      | md5('2000\|\|BBB') | md5('2000') | md5('BBB') | 2020-01-09 | 9999-12-31 | 2020-01-09     | 2020-01-10 | orders |
  ...
  @fixture.eff_satellite
  Scenario: [SF-EFF-CLD-05] Two incremental loads - no flip flop (CCC changes from 3000 to 4000, and then to 5000)
    Given the EFF_SAT eff_sat is already populated with data
      | CUSTOMER_ORDER_PK  | CUSTOMER_PK | ORDER_PK   | START_DATE | END_DATE   | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1000\|\|AAA') | md5('1000') | md5('AAA') | 2020-01-09 | 9999-12-31 | 2020-01-09     | 2020-01-10 | orders |
      | md5('2000\|\|BBB') | md5('2000') | md5('BBB') | 2020-01-09 | 9999-12-31 | 2020-01-09     | 2020-01-10 | orders |
  ...
  @fixture.eff_satellite
  Scenario: [SF-EFF-CLD-06] Two incremental loads - duplicate closed record
    Given the EFF_SAT eff_sat is already populated with data
      | CUSTOMER_ORDER_PK  | CUSTOMER_PK | ORDER_PK   | START_DATE | END_DATE   | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1000\|\|AAA') | md5('1000') | md5('AAA') | 2020-01-09 | 9999-12-31 | 2020-01-09     | 2020-01-10 | orders |
      | md5('2000\|\|BBB') | md5('2000') | md5('BBB') | 2020-01-09 | 9999-12-31 | 2020-01-09     | 2020-01-10 | orders |
