Feature: [MAS-PM] Multi Active Satellites
  ...
  Scenario: [MAS-PM-05] Load data into a populated multi-active satellite where sets of records have fewer records with period milliseconds
    Given the MULTI_ACTIVE_SATELLITE_TZ ma_sat is already populated with data
      ...
      | md5('1002') | Bob           | 17-214-233-1235 | md5('1002\|\|BOB\|\|17-214-233-1235')   | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1003') | Chad          | 17-214-233-1216 | md5('1003\|\|CHAD\|\|17-214-233-1216')  | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1003') | Chad          | 17-214-233-1226 | md5('1003\|\|CHAD\|\|17-214-233-1226')  | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1003') | Chad          | 17-214-233-1236 | md5('1003\|\|CHAD\|\|17-214-233-1236')  | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1004') | Dom           | 17-214-233-1217 | md5('1004\|\|DOM\|\|17-214-233-1217')   | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1004') | Dom           | 17-214-233-1227 | md5('1004\|\|DOM\|\|17-214-233-1227')   | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1004') | Dom           | 17-214-233-1237 | md5('1004\|\|DOM\|\|17-214-233-1237')   | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1006') | Frida         | 17-214-233-1214 | md5('1006\|\|FRIDA\|\|17-214-233-1214') | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1006') | Frida         | 17-214-233-1224 | md5('1006\|\|FRIDA\|\|17-214-233-1224') | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1006') | Frida         | 17-214-233-1234 | md5('1006\|\|FRIDA\|\|17-214-233-1234') | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
    And the RAW_STAGE_TZ table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE                  | SOURCE |
      | 1002        | Bob           | 17-214-233-1215 | 1993-01-01 00:00:00.002000 | *      |
    ...
    Then the MULTI_ACTIVE_SATELLITE_TZ table should contain expected data
      ...
      | md5('1006') | Frida         | 17-214-233-1224 | md5('1006\|\|FRIDA\|\|17-214-233-1224') | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1006') | Frida         | 17-214-233-1234 | md5('1006\|\|FRIDA\|\|17-214-233-1234') | 1993-01-01 00:00:00.001000 | 1993-01-01 00:00:00.001000 | *      |
      | md5('1002') | Bob           | 17-214-233-1215 | md5('1002\|\|BOB\|\|17-214-233-1215')   | 1993-01-01 00:00:00.002000 | 1993-01-01 00:00:00.002000 | *      |
      | md5('1002') | Bob           | 17-214-233-1235 | md5('1002\|\|BOB\|\|17-214-233-1235')   | 1993-01-01 00:00:00.002000 | 1993-01-01 00:00:00.002000 | *      |
      | md5('1004') | Dom           | 17-214-233-1217 | md5('1004\|\|DOM\|\|17-214-233-1217')   | 1993-01-01 00:00:00.002000 | 1993-01-01 00:00:00.002000 | *      |
  ...
  Scenario: [MAS-PM-06] Load data into a populated multi-active satellite where sets of records have fewer records with period hour
    Given the MULTI_ACTIVE_SATELLITE_TZ ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | HASHDIFF                                | EFFECTIVE_FROM             | LOAD_DATE                  | SOURCE |
      | md5('1002') | Bob           | 17-214-233-1215 | md5('1002\|\|BOB\|\|17-214-233-1215')   | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1002') | Bob           | 17-214-233-1225 | md5('1002\|\|BOB\|\|17-214-233-1225')   | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1002') | Bob           | 17-214-233-1235 | md5('1002\|\|BOB\|\|17-214-233-1235')   | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1003') | Chad          | 17-214-233-1216 | md5('1003\|\|CHAD\|\|17-214-233-1216')  | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1003') | Chad          | 17-214-233-1226 | md5('1003\|\|CHAD\|\|17-214-233-1226')  | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1003') | Chad          | 17-214-233-1236 | md5('1003\|\|CHAD\|\|17-214-233-1236')  | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1004') | Dom           | 17-214-233-1217 | md5('1004\|\|DOM\|\|17-214-233-1217')   | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1004') | Dom           | 17-214-233-1227 | md5('1004\|\|DOM\|\|17-214-233-1227')   | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1004') | Dom           | 17-214-233-1237 | md5('1004\|\|DOM\|\|17-214-233-1237')   | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1006') | Frida         | 17-214-233-1214 | md5('1006\|\|FRIDA\|\|17-214-233-1214') | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1006') | Frida         | 17-214-233-1224 | md5('1006\|\|FRIDA\|\|17-214-233-1224') | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1006') | Frida         | 17-214-233-1234 | md5('1006\|\|FRIDA\|\|17-214-233-1234') | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
    And the RAW_STAGE_TZ table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE                  | SOURCE |
      | 1002        | Bob           | 17-214-233-1215 | 1993-01-01 02:00:00.000000 | *      |
    ...
    Then the MULTI_ACTIVE_SATELLITE_TZ table should contain expected data
      ...
      | md5('1006') | Frida         | 17-214-233-1224 | md5('1006\|\|FRIDA\|\|17-214-233-1224') | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1006') | Frida         | 17-214-233-1234 | md5('1006\|\|FRIDA\|\|17-214-233-1234') | 1993-01-01 00:00:00.001000 | 1993-01-01 01:00:00.000000 | *      |
      | md5('1002') | Bob           | 17-214-233-1215 | md5('1002\|\|BOB\|\|17-214-233-1215')   | 1993-01-01 00:00:00.002000 | 1993-01-01 02:00:00.000000 | *      |
      | md5('1002') | Bob           | 17-214-233-1235 | md5('1002\|\|BOB\|\|17-214-233-1235')   | 1993-01-01 00:00:00.002000 | 1993-01-01 02:00:00.000000 | *      |
      | md5('1004') | Dom           | 17-214-233-1217 | md5('1004\|\|DOM\|\|17-214-233-1217')   | 1993-01-01 00:00:00.002000 | 1993-01-01 02:00:00.000000 | *      |
  ...
  Scenario: [MAS-PM-07] Load data into a populated multi-active satellite where sets of records have fewer records with period microsecond will fail
    Given the MULTI_ACTIVE_SATELLITE_TZ ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | HASHDIFF                                | EFFECTIVE_FROM | LOAD_DATE                  | SOURCE |
      | md5('1002') | Bob           | 17-214-233-1215 | md5('1002\|\|BOB\|\|17-214-233-1215')   | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1002') | Bob           | 17-214-233-1225 | md5('1002\|\|BOB\|\|17-214-233-1225')   | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1002') | Bob           | 17-214-233-1235 | md5('1002\|\|BOB\|\|17-214-233-1235')   | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1003') | Chad          | 17-214-233-1216 | md5('1003\|\|CHAD\|\|17-214-233-1216')  | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1003') | Chad          | 17-214-233-1226 | md5('1003\|\|CHAD\|\|17-214-233-1226')  | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1003') | Chad          | 17-214-233-1236 | md5('1003\|\|CHAD\|\|17-214-233-1236')  | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1004') | Dom           | 17-214-233-1217 | md5('1004\|\|DOM\|\|17-214-233-1217')   | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1004') | Dom           | 17-214-233-1227 | md5('1004\|\|DOM\|\|17-214-233-1227')   | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1004') | Dom           | 17-214-233-1237 | md5('1004\|\|DOM\|\|17-214-233-1237')   | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1006') | Frida         | 17-214-233-1214 | md5('1006\|\|FRIDA\|\|17-214-233-1214') | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1006') | Frida         | 17-214-233-1224 | md5('1006\|\|FRIDA\|\|17-214-233-1224') | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
      | md5('1006') | Frida         | 17-214-233-1234 | md5('1006\|\|FRIDA\|\|17-214-233-1234') | 1993-01-01     | 1993-01-01 00:00:00.000001 | *      |
    And the RAW_STAGE_TZ table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE                  | SOURCE |
      | 1002        | Bob           | 17-214-233-1215 | 1993-01-01 00:00:00.000002 | *      |
