Feature: [EFF-RM] Effectivity Satellites Loaded using Rank Materialization

  @fixture.eff_satellite
  Scenario: [EFF-RM-001] Load data into a non-existent effectivity satellite
  ...
  @fixture.eff_satellite
  Scenario: [EFF-RM-002] Load data into an empty effectivity satellite
  ...
  @fixture.eff_satellite
  Scenario: [EFF-RM-003] No New Eff Sat Added if Driving Foreign Key is NULL and Latest EFF Sat Remain Open
