Feature: [SQLS-SAT-CYC] Satellites Loaded in cycles using separate manual loads (sqlserver)
  ...
  Scenario: [SQLS-SAT-CYC-01] SATELLITE load over several cycles
  ...
  @fixture.satellite_cycle
  Scenario: [SQLS-SAT-CYC-02] SATELLITE load over several cycles with NULL records
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SQLS-SAT-CYC-03] SATELLITE load over several cycles no PK in HASHDIFF and NULL records
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SQLS-SAT-CYC-04] SATELLITE load over several cycles with a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SQLS-SAT-CYC-05] SATELLITE load over several cycles with no PK in HASHDIFF and a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
  ...
  @fixture.satellite_cycle
  @fixture.enable_sha
  Scenario: [SQLS-SAT-CYC-06] SATELLITE load over several cycles
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is empty
