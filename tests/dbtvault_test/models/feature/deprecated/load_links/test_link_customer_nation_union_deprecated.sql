{{- config(materialized='incremental', schema='vlt', enabled=true, tags=['load_links', 'deprecated'])     -}}

{%- set source = [ref('test_stg_sap_customer_hashed_links_deprecated'),
                  ref('test_stg_crm_customer_hashed_links_deprecated'),
                  ref('test_stg_web_customer_hashed_links_deprecated')]                                -%}
