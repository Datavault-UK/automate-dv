...
{% materialization vault_insert_by_period, adapter='bigquery' -%}
    ...
    {% else %}
        ...
        {% set period_boundaries = dbtvault_bq.get_period_boundaries(schema,
        ...
        {% for i in range(period_boundaries.num_periods) -%}
            ...
            {% set tmp_relation = make_temp_relation(this) %}
            {% set tmp_table_sql = dbtvault_bq.get_period_filter_sql(target_cols_csv, sql, timestamp_field, period,
