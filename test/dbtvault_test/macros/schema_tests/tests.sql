...
{%- for compare_col in compare_columns -%}
    ...
    {%- do compare_columns_processed.append("{}::VARCHAR AS {}".format(dbtvault.escape_column_name(compare_col), dbtvault.escape_column_name(compare_col))) -%}
    {%- do columns_processed.append(dbtvault.escape_column_name(compare_col)) -%}

{%- endfor %}

{%- for source_col in source_columns -%}

    {%- do source_columns_list.append(dbtvault.escape_column_name(source_col.column)) -%}
    {%- do source_columns_processed.append("{}::VARCHAR AS {}".format(dbtvault.escape_column_name(source_col.column), dbtvault.escape_column_name(source_col.column))) -%}
{%- endfor %}
...
{%  set compare_columns = dbtvault.escape_column_name(compare_columns) %}
