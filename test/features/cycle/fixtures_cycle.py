...
@fixture
def cycle_custom_null_key_postgres(context):
    """
    Define the structures and metadata to perform vault load cycles
    """
...
@fixture
def cycle_custom_null_key_databricks(context):
    """
    Define the structures and metadata to perform vault load cycles
    """
