Feature: [REF] Reference Tables

  @fixture.single_source_ref_table
  Scenario: [REF-01] Simple load of reference data into a non-existent reference table
  ...
  @fixture.single_source_ref_table
  Scenario: [REF-02] Simple load of distinct reference data into an empty reference table
    Given the REF_TABLE table does not exist
    And the RAW_REF_TABLE table contains data
      | DATE_PK    | YEAR | MONTH | DAY | DAY_OF_WEEK | LOAD_DATE  | SOURCE |
      | 2022-11-01 | 2022 | 11    | 1   | Tuesday     | 2022-11-01 | MDS    |
  ...
  @fixture.single_source_ref_table
  Scenario: [REF-03] Keys with NULL or empty values are not loaded into empty reference table that does not exist
  ...
  @fixture.single_source_ref_table
  Scenario: [REF-04] Load of reference data into a reference table
  ...
  @fixture.single_source_ref_table
  Scenario: [REF-05] Load of more reference data into a reference table
    Given the REF_TABLE ref_table is already populated with data
      | DATE_PK    | YEAR | MONTH | DAY | DAY_OF_WEEK | LOAD_DATE  | SOURCE |
      | 2018-11-01 | 2018 | 11    | 1   | Tuesday     | 2021-11-01 | MDS    |
      | 2020-11-02 | 2020 | 11    | 2   | Wednesday   | 2021-11-01 | MDS    |
      | 2021-11-03 | 2021 | 11    | 3   | Thursday    | 2021-11-01 | MDS    |
      | 2021-11-04 | 2021 | 11    | 4   | Friday      | 2021-11-01 | MDS    |
    And the RAW_REF_TABLE table contains data
      | DATE_PK    | YEAR | MONTH | DAY | DAY_OF_WEEK | LOAD_DATE  | SOURCE |
      | 2022-11-01 | 2022 | 11    | 1   | Tuesday     | 2022-11-30 | MDS    |
      | 2022-11-02 | 2022 | 11    | 2   | Wednesday   | 2022-11-30 | MDS    |
      | 2022-11-03 | 2022 | 11    | 3   | Thursday    | 2022-11-30 | MDS    |
      | 2022-11-04 | 2022 | 11    | 4   | Friday      | 2022-11-30 | MDS    |
