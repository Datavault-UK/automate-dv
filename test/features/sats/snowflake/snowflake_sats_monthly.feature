Feature: [SF-SAT-PM-M] Satellites Loaded using Period Materialization with monthly interval

  @fixture.satellite_cycle
  Scenario: [SF-SAT-PM-M-01] Satellite load over several monthly cycles with insert_by_period into
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-PM-M-02] Satellite load with monthly interval and intra-batch duplicates.
    ...
    Then the SATELLITE table should contain expected data
      | CUSTOMER_PK | HASHDIFF                            | CUSTOMER_NAME | CUSTOMER_DOB | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT') | Albert        | 1990-02-03   | 2019-05-04     | 2019-06-03 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH')   | Beth          | 1995-08-07   | 2019-05-05     | 2019-06-03 | *      |

  @fixture.satellite_cycle
  Scenario: [SF-SAT-PM-M-03] Satellite load with monthly interval and intra-load duplicates.
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_DOB | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | 1001        | Albert        | 1990-02-03   | 2019-05-04     | 2019-05-03 | *      |
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-PM-M-04] Satellite load with monthly interval and intra-batch and intra-load duplicates
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_DOB | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | 1001        | Albert        | 1990-02-03   | 2019-05-04     | 2019-05-03 | *      |
