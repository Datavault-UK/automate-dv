@fixture.set_workdir
Feature: Out of Sequence Satellites (sqlserver)
  ...
  @fixture.out_of_sequence_satellite_sqlserver
  Scenario: Several customers mix and match with datetime instead of date..
    ...
    And the SAT_CUSTOMER_OOS_TIMESTAMP oos_sat is already populated with data
    ...
    When I load the SAT_CUSTOMER_OOS_TIMESTAMP oos_sat
