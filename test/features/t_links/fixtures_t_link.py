...
@fixture
def t_link_databricks(context):
    """
    Define the structures and metadata to load transactional links for databricks
    """
...
@fixture
def t_link_comp_pk_databricks(context):
    """
    Define the structures and metadata to load transactional links with composite src_pk for databricks
    """
