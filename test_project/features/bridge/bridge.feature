...
# ------------------------ ONE LINK ------------------------
  ...
  Scenario: [BASE-LOAD] Base load into a bridge table from one hub and one link with the AS_OF date and LDTS equal
    ...
    Then the BRIDGE_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1001') | 2018-06-01 00:00:00.000000 | md5('1001\|\|100')     | 9999-12-31 23:59:59.999999     |
      | md5('1002') | 2018-06-01 00:00:00.000000 | md5('1002\|\|200')     | 9999-12-31 23:59:59.999999     |
      | md5('1003') | 2018-06-01 00:00:00.000000 | md5('1003\|\|300')     | 9999-12-31 23:59:59.999999     |
      | md5('1004') | 2018-06-01 00:00:00.000000 | md5('1004\|\|400')     | 9999-12-31 23:59:59.999999     |
  ...
  Scenario: [BASE-LOAD] Base load into a bridge table from one hub and one link with AS_OF dates in the future and multiple loads in the stage
    ...
    Then the BRIDGE_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1003') | 2018-06-01 00:00:00.000000 | md5('1003\|\|300')     | 9999-12-31 23:59:59.999999     |
      | md5('1004') | 2018-06-01 00:00:00.000000 | md5('1004\|\|400')     | 9999-12-31 23:59:59.999999     |
      | md5('1001') | 2018-06-02 00:00:00.000000 | md5('1001\|\|100')     | 9999-12-31 23:59:59.999999     |
      | md5('1002') | 2018-06-02 00:00:00.000000 | md5('1002\|\|200')     | 9999-12-31 23:59:59.999999     |
      | md5('1003') | 2018-06-02 00:00:00.000000 | md5('1003\|\|300')     | 9999-12-31 23:59:59.999999     |
      | md5('1004') | 2018-06-02 00:00:00.000000 | md5('1004\|\|400')     | 9999-12-31 23:59:59.999999     |
...
# ------------------------ TWO LINKS ------------------------
  ...
  @fixture.bridge
  Scenario: [BASE-LOAD] Base load into a bridge table from one hub and two links with AS_OF dates in the future and multiple loads in the stage
    Given the BRIDGE_CUSTOMER table does not exist
    And the raw vault contains empty tables
      | HUB          | LINK                | EFF_SAT                | BRIDGE          |
      | HUB_CUSTOMER | LINK_ORDER_PRODUCT  | EFF_SAT_ORDER_PRODUCT  | BRIDGE_CUSTOMER |
