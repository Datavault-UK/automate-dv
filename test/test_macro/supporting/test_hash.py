...
@pytest.mark.macro
def test_hash_single_column_is_successful(request):
...
@pytest.mark.macro
def test_hash_single_item_list_column_for_pk_is_successful(request):
    var_dict = {'columns': ["CUSTOMER_ID"], 'alias': 'CUSTOMER_PK'}
...
@pytest.mark.macro
def test_hash_single_item_list_column_for_hashdiff_is_successful(request):
...
@pytest.mark.macro
def test_hash_multi_column_as_pk_is_successful(request):
...
@pytest.mark.macro
def test_hash_multi_column_as_hashdiff_is_successful(request):
