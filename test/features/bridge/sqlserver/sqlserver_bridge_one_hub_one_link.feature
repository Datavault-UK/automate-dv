Feature: [SQLS-BRG-1L] Bridge table
  ...
  Scenario: [SQLS-BRG-1L-002] Base load into a bridge table from one hub and one link with AS_OF dates in the past
    ...
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1003\|\|300') | md5('1003') | md5('300') | 2018-06-02 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-02 00:00:00.000 | 2018-06-02 00:00:00.000 | *      |
      | md5('1004\|\|400') | md5('1004') | md5('400') | 2018-06-02 12:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-02 12:00:00.000 | 2018-06-02 12:00:00.000 | *      |
  ...
  Scenario: [SQLS-BRG-1L-004] Base load into a bridge table from one hub and one link with multiple loads and an encompassing range of AS OF dates
    ...
    Then the EFF_SAT_CUSTOMER_ORDER table should contain expected data
      ...
      | md5('1001\|\|100') | md5('1001') | md5('100') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1002\|\|200') | md5('1002') | md5('200') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1002\|\|201') | md5('1002') | md5('201') | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
      | md5('1003\|\|300') | md5('1003') | md5('300') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1003\|\|301') | md5('1003') | md5('301') | 2018-06-01 12:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 12:00:00.000 | 2018-06-01 12:00:00.000 | *      |
    Then the BRIDGE_CUSTOMER_ORDER table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | LINK_CUSTOMER_ORDER_PK |
      | md5('1001') | 2018-06-01 00:00:00.000 | md5('1001\|\|100')     |
      | md5('1002') | 2018-06-01 00:00:00.000 | md5('1002\|\|200')     |
