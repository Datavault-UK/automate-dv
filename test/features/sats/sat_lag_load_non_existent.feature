Feature: [SAT-LL-N] Previously non existent Sats loaded using LAG() loading scheme


  @fixture.satellite
  Scenario: [SAT-LL-N-01] Incremental load into non existent sat, with first and only record same as latest
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-02] Incremental load into non existent sat, with first record same as latest, with a new PK record
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-03] Incremental load into non existent sat, with first record same as latest, with a new record with a changed hashdiff
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-04] Incremental load into non existent sat, with first record same as latest, with new records changed hashdiffs
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-05] Incremental load into non existent sat, with first record same as latest, with new records with flip flop hashdiff
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-05] Incremental load into non existent sat, with first record same as latest, with new records with mix of same and changed hashdiffs
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-06] Incremental load into non existent sat, with first and only record different to latest
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-07] Incremental load into non existent sat, with first record different to latest, with a new PK record
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-08] Incremental load into non existent sat, with first record different to latest, with a new record with a changed hashdiff
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-09] Incremental load into non existent sat, with first record different to latest, with new records changed hashdiffs
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-10] Incremental load into non existent sat, with first record different to latest, with new records with flip flop hashdiff
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
  ...
  @fixture.satellite
  Scenario: [SAT-LL-N-11] Incremental load into empty sat, with first record different to latest, with new records with mix of same and changed hashdiffs
    Given the SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | CUSTOMER_DOB | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1997-04-24   | 1993-01-01 | *      |
