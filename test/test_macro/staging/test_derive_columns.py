...
def test_derive_columns_correctly_generates_sql_with_source_columns_concat(request, generate_model):
    var_dict = {'source_model': 'raw_source', 'columns': {'CUSTOMER_DETAILS': ['CUSTOMER_NAME', 'CUSTOMER_DOB', 'PHONE'], 'SOURCE': "!STG_BOOKING", 'EFFECTIVE_FROM': 'LOAD_DATE'}}
...
def test_derive_columns_correctly_generates_sql_with_source_columns_concat_including_constant(request, generate_model):
    var_dict = {'source_model': 'raw_source', 'columns': {'CUSTOMER_DETAILS': ['CUSTOMER_NAME', 'CUSTOMER_DOB', 'PHONE', '!PRIMARY'], 'SOURCE': "!STG_BOOKING", 'EFFECTIVE_FROM': 'LOAD_DATE'}}
...
def test_derive_columns_correctly_generates_sql_without_source_columns_concat(request, generate_model):
    var_dict = {'columns': {'CUSTOMER_DETAILS': ['CUSTOMER_NAME', 'CUSTOMER_DOB', 'PHONE'], 'SOURCE': "!STG_BOOKING", 'EFFECTIVE_FROM': 'LOAD_DATE'}}
...
def test_derive_columns_correctly_generates_sql_without_source_columns_concat_escaped1(request, generate_model):
    var_dict = {'columns': {'CUSTOMER_DETAILS': {'source_column': ['CUSTOMER_NAME', 'CUSTOMER DOB', 'PHONE'], 'escape': True}, 'SOURCE': "!STG_BOOKING", 'EFFECTIVE_FROM': 'LOAD_DATE'}}
...
def test_derive_columns_correctly_generates_sql_without_source_columns_concat_escaped2(request, generate_model):
    var_dict = {'columns': {'CUSTOMER_DETAILS': {'source_column': ['CUSTOMER_NAME', 'CUSTOMER_DOB', 'PHONE'], 'escape': False}, 'SOURCE': "!STG_BOOKING", 'EFFECTIVE_FROM': 'LOAD_DATE'}}
...
def test_derive_columns_correctly_generates_sql_without_source_columns_concat_escaped3(request, generate_model):
    var_dict = {'columns': {'CUSTOMER_DETAILS': {'source_column': ['CUSTOMER_NAME', 'CUSTOMER DOB', 'PHONE', '!WEBSITE'], 'escape': True}, 'SOURCE': "!STG_BOOKING", 'EFFECTIVE_FROM': 'LOAD_DATE'}}
...
def test_derive_columns_correctly_generates_sql_with_escaped_column1(request, generate_model):
    var_dict = {'source_model': 'raw_source', 'columns': {'BOOKING_TYPE': {'source_column': 'BOOKING TYPE', 'escape': True}, 'BOOKING_SOURCE': {'source_column': '!WEBSITE', 'escape': False}}}
...
def test_derive_columns_correctly_generates_sql_with_escaped_column2(request, generate_model):
    var_dict = {'source_model': 'raw_source', 'columns': {'BOOKING_TYPE': {'source_column': 'BOOKING TYPE', 'escape': True}, 'BOOKING_SOURCE': {'source_column': '!WEBSITE', 'escape': True}}}
...
def test_derive_columns_correctly_generates_sql_without_escaped_column(request, generate_model):
    var_dict = {'source_model': 'raw_source', 'columns': {'BOOKING_TYPE': 'BOOKING_TYPE_ORIGINAL', 'BOOKING_SOURCE': '!WEBSITE'}}
...
def test_derive_columns_correctly_generates_sql_mixed_escaped_column(request, generate_model):
    var_dict = {'source_model': 'raw_source', 'columns': {'BOOKING_TYPE': {'source_column': 'BOOKING TYPE', 'escape': True}, 'BOOKING_SOURCE': '!WEBSITE'}}
