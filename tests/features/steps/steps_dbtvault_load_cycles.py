...
def step_impl(context):
    ...
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_customer",
...
def step_impl(context):
    context.dbutils.create_schema("DV_PROTOTYPE_DB", "DEMO_TEST_STG", context.connection)
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_booking",
...
def step_impl(context, day_number):
    ...
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_customer",
                                    ["CUSTOMER_ID VARCHAR(38)", "CUSTOMER_NAME VARCHAR(60)", "CUSTOMER_DOB DATE",
                                     "LOADDATE DATE", "EFFECTIVE_FROM DATE"],
                                    connection=context.connection)

    context.dbutils.insert_data_from_ct(context.table, "test_stg_customer", "DEMO_TEST_STG", connection=context.connection)
...
def step_impl(context, day_number):
    ...
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_booking",
                                    ["BOOKING_REF NUMBER(38,0)", "CUSTOMER_ID VARCHAR(38)", "BOOKING_DATE DATE",
                                     ...
                                     "PHONE VARCHAR(15)", "NATIONALITY VARCHAR(30)", "LOADDATE DATE"],
                                    connection=context.connection)
    context.dbutils.insert_data_from_ct(context.table, "test_stg_booking", "DEMO_TEST_STG", connection=context.connection)
...
def step_impl(context):
    ...
    result_df = context.dbutils.get_table_data(full_table_name="DV_PROTOTYPE_DB.DEMO_TEST_VLT.test_hub_customer",
...
def step_impl(context):
    ...
    result_df = context.dbutils.get_table_data(full_table_name="DV_PROTOTYPE_DB.DEMO_TEST_VLT.test_hub_booking",
