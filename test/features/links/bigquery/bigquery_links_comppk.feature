Feature: [BQ-LNK-COMPPK] Links with composite src_pk

  @fixture.single_source_comppk_link
  Scenario: [BQ-LNK-COMPPK-01] Load a simple stage table into a non-existent link table
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-LNK-COMPPK-02] Load a simple stage table into an empty link table
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-LNK-COMPPK-03] Load a simple stage table into a populated link table
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-LNK-COMPPK-04] Load a stage table where a primary keys components are all NULL, no link is inserted
    Given the LINK link is already populated with data
      | CUSTOMER_NATION_PK | COMP_PK     | CUSTOMER_FK | NATION_FK  | LOAD_DATE  | SOURCE |
      | md5('1001\|\|GBR') | md5('1001') | md5('1001') | md5('GBR') | 1993-01-01 | CRM    |
      | md5('1002\|\|POL') | md5('1002') | md5('1002') | md5('POL') | 1993-01-01 | CRM    |
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-LNK-COMPPK-05] Load a simple stage table into a non-existent link table, period load
    Given the LINK table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | NATION_ID | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | GBR       | Alice         | 1997-04-24   | 17-214-233-1214 | 1993-01-01 | CRM    |
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-LNK-COMPPK-06] Load a simple stage table into a non-existent link table, rank load
    Given the LINK table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | NATION_ID | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | GBR       | Alice         | 1997-04-24   | 17-214-233-1214 | 1993-01-01 | CRM    |
  ...
  @fixture.single_source_comppk_link
  Scenario: [BQ-LNK-COMPPK-07] Load a simple stage table into a non-existent link table, incremental load
    Given the LINK table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | NATION_ID | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | GBR       | Alice         | 1997-04-24   | 17-214-233-1214 | 1993-01-01 | CRM    |
