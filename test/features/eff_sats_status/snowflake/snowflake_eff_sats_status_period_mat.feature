Feature: [SF-SEF-PM] Effectivity Satellites Loaded using Period Materialization
  ...
  @fixture.enable_auto_end_date
  @fixture.eff_satellite_status
  Scenario: [SF-SEF-PM-05] Loading data into a populated eff sat; driving key is ORDER_PK
  ...
  Scenario: [SF-SEF-PM-06] One load; going from an empty table to the same CUSTOMER for 3 different ORDERS
    ...
    Then the EFF_SAT table should contain expected data
      | CUSTOMER_ORDER_PK  | CUSTOMER_PK | ORDER_PK   | STATUS | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1000\|\|AAA') | md5('1000') | md5('AAA') | TRUE   | 2020-01-01     | 2020-01-01 | *      |
      | md5('1000\|\|BBB') | md5('1000') | md5('BBB') | TRUE   | 2020-01-02     | 2020-01-02 | *      |
      | md5('1000\|\|CCC') | md5('1000') | md5('CCC') | TRUE   | 2020-01-03     | 2020-01-03 | *      |
  ...
  Scenario: [SF-SEF-PM-07] One load; and different number of CUSTOMERS per ldts; going from an empty table to 3 CUSTOMERS per ORDER
    ...
    Then the EFF_SAT table should contain expected data
      | CUSTOMER_ORDER_PK  | CUSTOMER_PK | ORDER_PK   | STATUS | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1000\|\|AAA') | md5('1000') | md5('AAA') | TRUE   | 2020-01-01     | 2020-01-01 | *      |
      | md5('1000\|\|AAA') | md5('1000') | md5('AAA') | FALSE  | 2020-01-02     | 2020-01-02 | *      |
      | md5('2000\|\|AAA') | md5('2000') | md5('AAA') | TRUE   | 2020-01-02     | 2020-01-02 | *      |
      | md5('3000\|\|AAA') | md5('3000') | md5('AAA') | TRUE   | 2020-01-02     | 2020-01-02 | *      |
      | md5('2000\|\|AAA') | md5('2000') | md5('AAA') | FALSE  | 2020-01-03     | 2020-01-03 | *      |
      | md5('3000\|\|AAA') | md5('3000') | md5('AAA') | FALSE  | 2020-01-03     | 2020-01-03 | *      |
      | md5('4000\|\|AAA') | md5('4000') | md5('AAA') | TRUE   | 2020-01-03     | 2020-01-03 | *      |
      | md5('5000\|\|AAA') | md5('5000') | md5('AAA') | TRUE   | 2020-01-03     | 2020-01-03 | *      |
      | md5('6000\|\|AAA') | md5('6000') | md5('AAA') | TRUE   | 2020-01-03     | 2020-01-03 | *      |
  ...
  Scenario: [SF-SEF-PM-08] One load; going from an empty table to 1 CUSTOMER per ORDER + flip-flop situation
    ...
    Then the EFF_SAT table should contain expected data
      ...
      | md5('2000\|\|AAA') | md5('2000') | md5('AAA') | TRUE   | 2020-01-02     | 2020-01-02 | *      |
      | md5('2000\|\|AAA') | md5('2000') | md5('AAA') | FALSE  | 2020-01-03     | 2020-01-03 | *      |
      | md5('1000\|\|AAA') | md5('1000') | md5('AAA') | TRUE   | 2020-01-03     | 2020-01-03 | *      |
