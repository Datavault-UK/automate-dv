...
Feature: pit
  ...
  Scenario: Load into a pit table where the AS OF table is already established with increments of a day
    ...
    And the RAW_STAGE_LOGIN table contains data
      ...
      | 1001        | 2019-01-01 02:00:00.000 | Phone       | 2019-01-02 00:00:00.000000 | *      |
      | 1001        | 2019-01-02 03:00:00.000 | Phone       | 2019-01-03 00:00:00.000000 | *      |
      | 1001        | 2019-01-03 01:00:00.000 | Laptop      | 2019-01-04 00:00:00.000000 | *      |
      | 1002        | 2019-01-01 05:00:00.000 | Tablet      | 2019-01-02 00:00:00.000000 | *      |
      | 1002        | 2019-01-02 06:00:00.000 | Tablet      | 2019-01-03 00:00:00.000000 | *      |
      | 1002        | 2019-01-03 08:00:00.000 | Tablet      | 2019-01-04 00:00:00.000000 | *      |
    ...
    Then the SAT_CUSTOMER_LOGIN table should contain expected data
      ...
      | md5('1001') | 2019-01-01 02:00:00.000 | Phone       | md5('PHONE\|\|2019-01-01 02:00:00.000')  | 2019-01-02 00:00:00.000000 | 2019-01-02 00:00:00.000000 | *      |
      | md5('1001') | 2019-01-02 03:00:00.000 | Phone       | md5('PHONE\|\|2019-01-02 03:00:00.000')  | 2019-01-03 00:00:00.000000 | 2019-01-03 00:00:00.000000 | *      |
      | md5('1001') | 2019-01-03 01:00:00.000 | Laptop      | md5('LAPTOP\|\|2019-01-03 01:00:00.000') | 2019-01-04 00:00:00.000000 | 2019-01-04 00:00:00.000000 | *      |
      | md5('1002') | 2019-01-01 05:00:00.000 | Tablet      | md5('TABLET\|\|2019-01-01 05:00:00.000') | 2019-01-02 00:00:00.000000 | 2019-01-02 00:00:00.000000 | *      |
      | md5('1002') | 2019-01-02 06:00:00.000 | Tablet      | md5('TABLET\|\|2019-01-02 06:00:00.000') | 2019-01-03 00:00:00.000000 | 2019-01-03 00:00:00.000000 | *      |
      | md5('1002') | 2019-01-03 08:00:00.000 | Tablet      | md5('TABLET\|\|2019-01-03 08:00:00.000') | 2019-01-04 00:00:00.000000 | 2019-01-04 00:00:00.000000 | *      |
