...
{%- set src_cols = 'CUSTOMER_NATION_PK, CUSTOMER_PK, NATION_PK, LOADDATE, SOURCE' -%}
{%- set src_pk = ['LINK_CUSTOMER_NATION_PK']                                                    -%}
{%- set src_fk = ['CUSTOMER_PK', 'CUSTOMER_NATION_PK']                                          -%}
{%- set src_ldts = 'LOADDATE'                                                                   -%}
{%- set src_source = 'SOURCE'                                                                   -%}

{%- set tgt_pk = ['CUSTOMER_NATION_PK', 'BINARY(16)', 'CUSTOMER_NATION_PK']                     -%}
{%- set tgt_fk = [['CUSTOMER_PK', 'BINARY(16)', 'CUSTOMER_PK'],
                  ['NATION_PK', 'BINARY(16)', 'CUSTOMER_NATION_PK']]                            -%}
