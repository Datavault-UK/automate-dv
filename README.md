...
stable [![Documentation Status](https://readthedocs.org/projects/dbtvault/badge/?version=v0.2-pre)](https://dbtvault.readthedocs.io/en/v0.2-pre/?badge=v0.2-pre)
...
packages:
  ...
  - git: "https://github.com/Datavault-UK/dbtvault"
    revision: v0.2-pre # Latest stable version
```
And run 
```dbt deps```
