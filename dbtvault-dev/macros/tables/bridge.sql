{%- macro bridge(src_pk, as_of_dates_table, bridge_walk, stage_tables, source_model) -%}
...
{%- macro default__bridge(src_pk, as_of_dates_table, bridge_walk, stage_tables, source_model) -%}
