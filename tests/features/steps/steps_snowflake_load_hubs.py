...
@step("I run the hub history load sql script")
def step_impl(context):
...
def step_impl(context):
    bindings.compare_ct_to_db_table(context, "DV_PROTOTYPE_DB.TEST_VLT.HUB_CUSTOMER")
...
def step_impl(context):
    ...
    sql = "SELECT * FROM DV_PROTOTYPE_DB.TEST_VLT.HUB_CUSTOMER AS hub ORDER BY hub.CUSTOMERKEY;"
