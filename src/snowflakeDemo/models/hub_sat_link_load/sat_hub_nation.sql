...
{% set sat_columns = 'CAST(stg.NATION_HASHDIFF AS BINARY(16)) AS NATION_HASHDIFF, 
CAST(stg.NATION_PK AS BINARY(16)) AS NATION_PK, 
CAST(stg.NATION_NAME AS VARCHAR(25)) AS NATION_NAME, 
CAST(stg.NATION_COMMENT AS VARCHAR(152)) AS NATION_COMMENT, 
...
{% set stg_columns1 = 'b.NATION_HASHDIFF, 
b.NATION_PK, 
b.NATION_NAME, 
b.NATION_COMMENT, 
b.LOADDATE, 
b.EFFECTIVE_FROM, 
b.SOURCE' %}
{% set stg_columns2 = 'a.NATION_HASHDIFF, 
a.NATION_PK, 
a.NATION_NAME, 
a.NATION_COMMENT, 
a.LOADDATE, 
