...
Feature: [HASH] Check the hash string length for postgres
  ...
  @fixture.enable_sha1
  @fixture.disable_hashing_upper_case
  Scenario: [HASH-07] Check hash value length for SHA1 hashing in postgres with upper casing disabled
    Given there is data available
      | VALUE_STRING    |
      | postgres_hash   |
      | snowflake_hash  |
    ...
    @fixture.hashing
  @fixture.enable_sha1
  Scenario: [HASH-08] Check hash value length for SHA1 hashing in postgres
    Given there is data available
      | VALUE_STRING    |
      | postgres_hash   |
      | snowflake_hash  |
    ...
    Then the SAMPLE_DATA table should contain the following data
      ...
      | sqlserver_hash  | 16                |
        ...
        @fixture.hashing
  @fixture.enable_sha1
  Scenario: [HASH-09] Check hash value length for SHA1 hashing in postgres
    Given there is data available
      | VALUE_STRING    |
      | postgres_hash   |
      | snowflake_hash  |
