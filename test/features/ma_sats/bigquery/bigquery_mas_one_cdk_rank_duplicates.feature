Feature: [BQ-MAS-1CD-RM-D] Multi Active Satellites
  ...
  Scenario: [BQ-MAS-1CD-RM-D-01] Load over several cycles with a mix of duplicate record change cases
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-RM-D-02] Load over several cycles with no CDK in HASHDIFF and a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-RM-D-03] Load over several cycles with no PK nor CDK in HASHDIFF and a mix of duplicate record change cases
    Given the RAW_STAGE stage is empty
