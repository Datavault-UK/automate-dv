Feature: [SF-EFH-AUB] Effectivity Satellites
  ...
  Scenario: [SF-EFH-AUB-01] One load; going from an empty table to 1 CUSTOMER per ORDER
    ...
    Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
      ...
      | md5('1003\|\|300') | md5('1003') | md5('300') | TRUE   | md5('1') | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
  ...
  Scenario: [SF-EFH-AUB-02] One load; going from an empty table to the same CUSTOMER for 3 different ORDERS
    ...
    Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
      ...
      | md5('1001\|\|102') | md5('1001') | md5('102') | TRUE   | md5('1') | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
  ...
  Scenario: [SF-EFH-AUB-03] One load; going from an empty table to 3 CUSTOMERS per ORDER
    ...
    Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
      ...
      | md5('1003\|\|100') | md5('1003') | md5('100') | TRUE   | md5('1') | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
