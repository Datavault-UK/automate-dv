Feature: [SQLS-EFF-AUI] Effectivity Satellites
  ...
  Scenario: [SQLS-EFF-AUI-01] Three loads; adding (completely) new relationships in each load
    ...
    Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
      | ORDER_CUSTOMER_PK  | CUSTOMER_PK | ORDER_PK   | START_DATE              | END_DATE                | EFFECTIVE_FROM          | LOAD_DATETIME           | SOURCE |
      | md5('1001\|\|100') | md5('1001') | md5('100') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1002\|\|200') | md5('1002') | md5('200') | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      | md5('1003\|\|300') | md5('1003') | md5('300') | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      | md5('1004\|\|400') | md5('1004') | md5('400') | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
    Given the RAW_STAGE_ORDER_CUSTOMER table contains data
      | CUSTOMER_ID | ORDER_ID | START_DATE              | END_DATE                | EFFECTIVE_FROM          | LOAD_DATETIME           | SOURCE |
  ...
  Scenario: [SQLS-EFF-AUI-02] Three loads; the same CUSTOMER placing a varying number of ORDERS at different times
    ...
    Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
      ...
      | md5('1001\|\|102') | md5('1001') | md5('102') | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
    Given the RAW_STAGE_ORDER_CUSTOMER table contains data
      | CUSTOMER_ID | ORDER_ID | START_DATE              | END_DATE                | EFFECTIVE_FROM          | LOAD_DATETIME           | SOURCE |
  ...
  Scenario: [SQLS-EFF-AUI-04] Three loads; the last load will bring new open, new reopen and closed records in the eff sat
    ...
    Then the EFF_SAT_ORDER_CUSTOMER table should contain expected data
      ...
      | md5('1001\|\|100') | md5('1001') | md5('100') | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 00:00:00.000 | 2018-06-01 00:00:00.000 | *      |
      | md5('1001\|\|100') | md5('1001') | md5('100') | 2018-06-01 00:00:00.000 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      | md5('1011\|\|100') | md5('1011') | md5('100') | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
      | md5('1002\|\|200') | md5('1002') | md5('200') | 2018-06-01 09:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 09:00:00.000 | 2018-06-01 09:00:00.000 | *      |
    Given the RAW_STAGE_ORDER_CUSTOMER table contains data
      | CUSTOMER_ID | ORDER_ID | START_DATE              | END_DATE                | EFFECTIVE_FROM          | LOAD_DATETIME           | SOURCE |
      | 1001        | 100      | 2018-06-01 00:00:00.000 | 9999-12-31 23:59:59.996 | 2018-06-01 18:00:00.000 | 2018-06-01 18:00:00.000 | *      |
