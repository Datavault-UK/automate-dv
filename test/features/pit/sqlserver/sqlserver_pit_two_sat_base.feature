Feature: [SQLS-PIT-2SB] Point in Time
  ...
  Scenario: [SQLS-PIT-2SB-01] Base load into a pit table from two satellites with dates with an encompassing range of AS OF dates
  ...
  # TIMESTAMPS
  @fixture.pit_two_sats
  Scenario: [SQLS-PIT-2SB-02] Base load into a pit table from two satellites with timestamps with an encompassing range of AS OF timestamps
  ...
  @fixture.pit_two_sats
  Scenario: [SQLS-PIT-2SB-03] Base load into a pit table from two satellites with timestamps with an encompassing range of AS OF dates
  ...
  @fixture.pit_two_sats
  Scenario: [SQLS-PIT-2SB-04] Base load into a pit table from two satellites with dates with an encompassing range of AS OF timestamps
