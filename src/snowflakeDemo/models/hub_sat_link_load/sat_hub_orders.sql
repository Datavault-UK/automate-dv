...
{% set sat_columns = 'CAST(stg.ORDER_HASHDIFF AS BINARY(16)) AS ORDER_HASHDIFF, 
CAST(stg.ORDER_PK AS BINARY(16)) AS ORDER_PK, 
CAST(stg.ORDERSTATUS AS VARCHAR(1)) AS ORDERSTATUS, 
CAST(stg.TOTALPRICE AS NUMBER(12,2)) AS TOTALPRICE, 
CAST(stg.ORDERDATE AS DATE) AS ORDERDATE, 
CAST(stg.ORDERPRIORITY AS VARCHAR(15)) AS ORDERPRIORITY, 
CAST(stg.CLERK AS VARCHAR(15)) AS CLERK, 
CAST(stg.SHIPPRIORITY AS NUMBER(38,0)) AS SHIPPRIORITY, 
CAST(stg.ORDER_COMMENT AS VARCHAR(79)) AS ORDER_COMMENT, 
...
{% set stg_columns1 = 'b.ORDER_HASHDIFF, 
b.ORDER_PK, 
b.ORDERSTATUS, 
b.TOTALPRICE, 
b.ORDERDATE, 
...
b.EFFECTIVE_FROM, 
b.SOURCE' %}
{% set stg_columns2 = 'a.ORDER_HASHDIFF, 
a.ORDER_PK, 
a.ORDERSTATUS, 
a.TOTALPRICE, 
a.ORDERDATE, 
