Feature: [SF-EFF-RM] Effectivity Satellites Loaded using Rank Materialization
  ...
  Scenario: [SF-EFF-RM-01] Load data into a non-existent effectivity satellite
  ...
  @fixture.eff_satellite
  Scenario: [SF-EFF-RM-02] Load data into an empty effectivity satellite
  ...
  @fixture.eff_satellite
  Scenario: [SF-EFF-RM-03] No New Eff Sat Added if Driving Foreign Key is NULL and Latest EFF Sat Remain Open
