...
#TODO: [SF-MAS-1CD-INC-03] failing at loading of the stage in the second cycle.
  ...
  Scenario: [SF-MAS-1CD-INC-03] Load mixed data into a non existent multi-active satellite - two cycles
    ...
    When the RAW_STAGE is loaded
      ...
      | 1001        | Alicia        | 17-214-233-1214 | 1993-01-03       | 1993-01-03 | *      |
      | 1001        | Alice         | 17-214-233-1224 | 1993-01-03       | 1993-01-03 | *      |
      | 1001        | Alice         | 17-214-233-1234 | 1993-01-03       | 1993-01-03 | *      |
      | 1007        | Darshan       | 17-214-233-1251 | 1993-01-03       | 1993-01-03 | *      |
      | 1007        | Darshan       | 17-214-233-1251 | 1993-01-03       | 1993-01-03 | *      |
      | 1007        | Darshan       | 17-214-233-1261 | 1993-01-03       | 1993-01-03 | *      |
      | 1007        | Darshan       | 17-214-233-1271 | 1993-01-03       | 1993-01-03 | *      |
    And I stage the STG_CUSTOMER data
    When I load the MULTI_ACTIVE_SATELLITE ma_sat
    Then the MULTI_ACTIVE_SATELLITE table should contain expected data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | HASHDIFF                                  | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      ...
      | md5('1005') | Erik          | 17-214-233-1237 | md5('1005\|\|ERIC\|\|17-214-233-1237')    | 1993-01-03     | 1993-01-03 | *      |
      | md5('1006') | Dan           | 17-214-233-1250 | md5('1006\|\|DAN\|\|17-214-233-1250')     | 1993-01-02     | 1993-01-02 | *      |
      | md5('1006') | Danny         | 17-214-233-1250 | md5('1006\|\|DANNY\|\|17-214-233-1250')   | 1993-01-02     | 1993-01-02 | *      |
      | md5('1006') | Dan           | 17-214-233-1260 | md5('1006\|\|DAN\|\|17-214-233-1260')     | 1993-01-02     | 1993-01-02 | *      |
      | md5('1007') | Darshan       | 17-214-233-1251 | md5('1007\|\|DARSHAN\|\|17-214-233-1251') | 1993-01-03     | 1993-01-03 | *      |
      | md5('1007') | Darshan       | 17-214-233-1261 | md5('1007\|\|DARSHAN\|\|17-214-233-1261') | 1993-01-03     | 1993-01-03 | *      |
      | md5('1007') | Darshan       | 17-214-233-1271 | md5('1007\|\|DARSHAN\|\|17-214-233-1271') | 1993-01-03     | 1993-01-03 | *      |