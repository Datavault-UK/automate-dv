...
def step_impl(context):
    ...
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_STG", "test_stg_customer_details",
    ...
    context.dbutils.insert_data_from_ct(context.table, "test_stg_customer_details", "DEMO_TEST_STG")


@given("I have an empty TEST_SAT_CUSTOMER_DETAILS table")
def step_impl(context):
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_VLT", "test_sat_customer_details",
...
def step_impl(context):
    ...
    context.dbutils.insert_data_from_ct(context.table, "test_sat_customer_details", "DEMO_TEST_VLT")
...
def step_impl(context):
    ...
    result_df = context.dbutils.get_table_data(full_table_name="DV_PROTOTYPE_DB.DEMO_TEST_VLT.test_sat_customer_details",
...
def step_impl(context):
    context.dbutils.drop_and_create("DV_PROTOTYPE_DB", "DEMO_TEST_VLT", "test_sat_cust_customer_details",
