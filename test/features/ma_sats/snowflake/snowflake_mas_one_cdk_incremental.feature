Feature: [SF-MAS-1CD-INC] Multi Active Satellites
  ...
  Scenario: [SF-MAS-1CD-INC-03] Load mixed data into a non existent multi-active satellite - two cycles
    ...
    And the RAW_STAGE table contains data
      ...
      | 1003        | Chad          | 17-214-233-1226 | 1993-01-03 | *      |
      | 1003        | Chad          | 17-214-233-1236 | 1993-01-03 | *      |
      | 1005        | Eric          | 17-214-233-1217 | 1993-01-03 | *      |
      | 1005        | Eric          | 17-214-233-1227 | 1993-01-03 | *      |
      | 1005        | Erik          | 17-214-233-1237 | 1993-01-03 | *      |
      | 1007        | Sam           | 17-214-233-1251 | 1993-01-03 | *      |
      | 1007        | Sam           | 17-214-233-1261 | 1993-01-03 | *      |
      | 1007        | Sam           | 17-214-233-1271 | 1993-01-03 | *      |
      | 1007        | Sam           | 17-214-233-1271 | 1993-01-03 | *      |
    And I stage the STG_CUSTOMER data
    When I load the MULTI_ACTIVE_SATELLITE ma_sat
    Then the MULTI_ACTIVE_SATELLITE table should contain expected data
