...
WHERE a.CUSTOMER_PK IS NOT NULL
    ...
    , latest_records AS (
SELECT current_records.CUSTOMER_PK, current_records.HASHDIFF, current_records.TEST_COLUMN_1, current_records.TEST_COLUMN_2, current_records.EFFECTIVE_FROM, current_records.LOAD_DATE, current_records.RECORD_SOURCE, RANK() OVER (
...
SELECT
    sd.CUSTOMER_PK, sd.HASHDIFF, sd.TEST_COLUMN_1, sd.TEST_COLUMN_2, sd.EFFECTIVE_FROM, sd.LOAD_DATE, sd.RECORD_SOURCE, RANK() OVER (
