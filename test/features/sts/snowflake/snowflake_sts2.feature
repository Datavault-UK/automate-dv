Feature: [SF-STS2] Status Tracking Satellites
  ...
  @fixture.sts2
  Scenario: [SF-STS2-02] Load data into a non-existent status tracking satellite
  ...
  @fixture.sts2
  Scenario: [SF-STS2-03] Load data into a populated status tracking satellite where some records overlap
