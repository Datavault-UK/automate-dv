Feature: Effectivity Satellites
    ...
    Scenario: Empty Load
      ...
      | LDTS       | Source | Customer_PK | Customer_ID | Order_PK | Order_ID | Effective_Date |
      | 10.01.2020 | orders | md5(1000)   | 1000        | md5(AAA) | AAA      | 09.01.2020     |
      | 10.01.2020 | orders | md5(2000)   | 2000        | md5(BBB) | BBB      | 09.01.2020     |
      | 10.01.2020 | orders | md5(3000)   | 3000        | md5(CCC) | CCC      | 09.01.2020     |
      ...
      | CUSTOMER_ORDER_PK         | CUSTOMER_FK | ORDER_FK | LDTS       | SOURCE |
      | md5(concat('1000','AAA')) | md5(1000)   | md5(AAA) | 10.01.2020 | orders |
      | md5(concat('2000','BBB')) | md5(2000)   | md5(BBB) | 10.01.2020 | orders |
      | md5(concat('3000','CCC')) | md5(3000)   | md5(CCC) | 10.01.2020 | orders |
      And the following EFF_CUSTOMER_ORDER
      | CUSTOMER_ORDER_PK             | LDTS       | SOURCE | HASHDIFF                                     | EFFECTIVE_FROM | EFFECTIVE_TO |
      | md5(concat('1000','|','AAA')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      | md5(concat('2000','|','BBB')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      | md5(concat('3000','|','CCC')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |


    Scenario: Subsequent Load, No Effectivity Change
      Given Link_Customer_Order
      | CUSTOMER_ORDER_PK         | CUSTOMER_FK | ORDER_FK | LDTS       | SOURCE |
      | md5(concat('1000','AAA')) | md5(1000)   | md5(AAA) | 11.01.2020 | orders |
      | md5(concat('2000','BBB')) | md5(2000)   | md5(BBB) | 11.01.2020 | orders |
      | md5(concat('3000','CCC')) | md5(3000)   | md5(CCC) | 11.01.2020 | orders |
      ...
      | LDTS       | Source | Customer_PK | Customer_ID | Order_PK | Order_ID | Effective_Date |
      | 11.01.2020 | orders | md5(1000)   | 1000        | md5(AAA) | AAA      | 10.01.2020     |
      | 11.01.2020 | orders | md5(2000)   | 2000        | md5(BBB) | BBB      | 10.01.2020     |
      | 11.01.2020 | orders | md5(3000)   | 3000        | md5(CCC) | CCC      | 10.01.2020     |
      And mapping configuration from stage to vault
    ...
    Scenario: Subsequent Load, New Link Added
      ...
      And staging_data for 11.01.2020
      | LDTS       | Source | Customer_PK | Customer_ID | Order_PK | Order_ID | Effective_Date |
      | 11.01.2020 | orders | md5(1000)   | 1000        | md5(AAA) | AAA      | 09.01.2020     |
      | 11.01.2020 | orders | md5(2000)   | 2000        | md5(BBB) | BBB      | 09.01.2020     |
      | 11.01.2020 | orders | md5(3000)   | 3000        | md5(CCC) | CCC      | 09.01.2020     |
      | 11.01.2020 | orders | md5(4000)   | 4000        | md5(DDD) | DDD      | 10.01.2020     |
      | 11.01.2020 | orders | md5(5000)   | 5000        | md5(EEE) | EEE      | 10.01.2020     |
      And mapping configuration from stage to vault
      When I run a Load Cycle for 11.01.2020
      Then I expect the following CUSTOMER_ORDER_LINK
      | CUSTOMER_ORDER_PK         | CUSTOMER_FK | ORDER_FK | LDTS       | SOURCE |
      ...
      | md5(concat('2000','BBB')) | md5(2000)   | md5(BBB) | 10.01.2020 | orders |
      | md5(concat('3000','CCC')) | md5(3000)   | md5(CCC) | 10.01.2020 | orders |
      | md5(concat('4000','DDD')) | md5(4000)   | md5(DDD) | 11.01.2020 | orders |
      | md5(concat('5000','EEE')) | md5(5000)   | md5(EEE) | 11.01.2020 | orders |
      And the following EFF_CUSTOMER_ORDER
      | CUSTOMER_ORDER_PK             | LDTS       | SOURCE | HASHDIFF                                     | EFFECTIVE_FROM | EFFECTIVE_TO |
      | md5(concat('1000','|','AAA')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      | md5(concat('2000','|','BBB')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      | md5(concat('3000','|','CCC')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      | md5(concat('4000','|','DDD')) | 11.01.2020 | orders | md5(concat('10.01.2020', '|', '31.12.9999')) | 10.01.2020     | 31.12.9999   |
      | md5(concat('5000','|','EEE')) | 11.01.2020 | orders | md5(concat('10.01.2020', '|', '31.12.9999')) | 10.01.2020     | 31.12.9999   |
    ...
    Scenario: Subsequent Load, Link is Changed
      ...
      | LDTS       | Source | Customer_PK | Customer_ID | Order_PK | Order_ID | Effective_Date |
      | 12.01.2020 | orders | md5(1000)   | 1000        | md5(AAA) | AAA      | 11.01.2020     |
      | 12.01.2020 | orders | md5(2000)   | 2000        | md5(BBB) | BBB      | 11.01.2020     |
      | 12.01.2020 | orders | md5(3000)   | 3000        | md5(CCC) | CCC      | 11.01.2020     |
      | 12.01.2020 | orders | md5(4000)   | 4000        | md5(FFF) | FFF      | 11.01.2020     |
      | 12.01.2020 | orders | md5(5000)   | 5000        | md5(GGG) | GGG      | 11.01.2020     |
      And mapping configuration from stage to vault
      ...
      | md5(concat('4000','DDD')) | md5(4000)   | md5(DDD) | 11.01.2020 | orders |
      | md5(concat('5000','EEE')) | md5(5000)   | md5(EEE) | 11.01.2020 | orders |
      | md5(concat('4000','DDD')) | md5(4000)   | md5(FFF) | 12.01.2020 | orders |
      | md5(concat('5000','EEE')) | md5(5000)   | md5(GGG) | 12.01.2020 | orders |
      And the following EFF_CUSTOMER_ORDER
      | CUSTOMER_ORDER_PK             | LDTS       | SOURCE | HASHDIFF                                     | EFFECTIVE_FROM | EFFECTIVE_TO |
      | md5(concat('1000','|','AAA')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      | md5(concat('2000','|','BBB')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      ...
      | md5(concat('4000','|','DDD')) | 11.01.2020 | orders | md5(concat('10.01.2020', '|', '31.12.9999')) | 10.01.2020     | 31.12.9999   |
      | md5(concat('5000','|','EEE')) | 11.01.2020 | orders | md5(concat('10.01.2020', '|', '31.12.9999')) | 10.01.2020     | 31.12.9999   |
      | md5(concat('4000','|','DDD')) | 12.01.2020 | orders | md5(concat('10.01.2020', '|', '11-01-2020')) | 10.01.2020     | 11.01.2020   |
      | md5(concat('5000','|','EEE')) | 12.01.2020 | orders | md5(concat('10.01.2020', '|', '11-01-2020')) | 10.01.2020     | 11.01.2020   |
      | md5(concat('4000','|','FFF')) | 12.01.2020 | orders | md5(concat('11.01.2020', '|', '31.12.9999')) | 11.01.2020     | 31.12.9999   |
      | md5(concat('5000','|','GGG')) | 12.01.2020 | orders | md5(concat('11.01.2020', '|', '31.12.9999')) | 11.01.2020     | 31.12.9999   |
    ...
    Scenario: Subsequent 2 Loads, Link is Changed Back Again
      ...
      | md5(concat('3000','CCC')) | md5(3000)   | md5(CCC) | 10.01.2020 | orders |
      | md5(concat('4000','DDD')) | md5(4000)   | md5(DDD) | 11.01.2020 | orders |
      | md5(concat('4000','FFF')) | md5(4000)   | md5(FFF) | 12.01.2020 | orders |
      | md5(concat('5000','EEE')) | md5(5000)   | md5(EEE) | 11.01.2020 | orders |
      | md5(concat('5000','GGG')) | md5(5000)   | md5(GGG) | 12.01.2020 | orders |
      And Eff_Customer_Order
      | CUSTOMER_ORDER_PK             | LDTS       | SOURCE | HASHDIFF                                     | EFFECTIVE_FROM | EFFECTIVE_TO |
      | md5(concat('1000','|','AAA')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      | md5(concat('2000','|','BBB')) | 10.01.2020 | orders | md5(concat('09.01.2020', '|', '31.12.9999')) | 09.01.2020     | 31.12.9999   |
      ...
      | LDTS       | Source | Customer_PK | Customer_ID | Order_PK | Order_ID | Effective_Date |
      | 13.01.2020 | orders | md5(1000)   | 1000        | md5(AAA) | AAA      | 12.01.2020     |
      | 13.01.2020 | orders | md5(2000)   | 2000        | md5(BBB) | BBB      | 12.01.2020     |
      | 13.01.2020 | orders | md5(3000)   | 3000        | md5(CCC) | CCC      | 12.01.2020     |
      | 13.01.2020 | orders | md5(4000)   | 4000        | md5(DDD) | DDD      | 12.01.2020     |
      | 13.01.2020 | orders | md5(5000)   | 5000        | md5(EEE) | EEE      | 12.01.2020     |
      And mapping configuration from stage to vault
      ...
      | md5(concat('4000','|','DDD')) | 12.01.2020 | orders | md5(concat('10.01.2020', '|', '11-01-2020')) | 10.01.2020     | 11.01.2020   |
      | md5(concat('4000','|','FFF')) | 12.01.2020 | orders | md5(concat('11.01.2020', '|', '31.12.9999')) | 11.01.2020     | 31.12.9999   |
      | md5(concat('4000','|','FFF')) | 13.01.2020 | orders | md5(concat('11.01.2020', '|', '12-01-2020')) | 11.01.2020     | 12.01.2020   |
      | md5(concat('4000','|','DDD')) | 13.01.2020 | orders | md5(concat('12.01.2020', '|', '31.12.9999')) | 12.01.2020     | 31.12.9999   |
      | md5(concat('5000','|','EEE')) | 11.01.2020 | orders | md5(concat('10.01.2020', '|', '31.12.9999')) | 10.01.2020     | 31.12.9999   |
      | md5(concat('5000','|','EEE')) | 12.01.2020 | orders | md5(concat('10.01.2020', '|', '11-01-2020')) | 10.01.2020     | 11.01.2020   |
      | md5(concat('5000','|','GGG')) | 12.01.2020 | orders | md5(concat('11.01.2020', '|', '31.12.9999')) | 11.01.2020     | 31.12.9999   |
      | md5(concat('5000','|','GGG')) | 13.01.2020 | orders | md5(concat('11.01.2020', '|', '12-01-2020')) | 11.01.2020     | 11.01.2020   |
      | md5(concat('5000','|','EEE')) | 13.01.2020 | orders | md5(concat('12.01.2020', '|', '31.12.9999')) | 12.01.2020     | 31.12.9999   |
