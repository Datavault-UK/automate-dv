Feature: [BQ-BRG] Bridge table
  ...
  @fixture.bridge
  Scenario: [BQ-BRG-01] Bridge on one hub and one link
  ...
  @fixture.enable_auto_end_date
  @fixture.bridge
  Scenario: [BQ-BRG-02] Bridge on one hub and one link
  ...
  @fixture.enable_auto_end_date
  @fixture.bridge
  Scenario: [BQ-BRG-03] Bridge on one hub and one link
  ...
  @fixture.enable_auto_end_date
  @fixture.bridge
  Scenario: [BQ-BRG-04] Bridge on one hub and one link
  ...
  @fixture.enable_auto_end_date
  @fixture.bridge
  Scenario: [BQ-BRG-05] Bridge on one hub and two links
    Incremental load with auto end-dating with more recent AS OF dates and new/changed orders
    New orders or changed orders are assigned to existing customers, as well as to new ones
  ...
  @fixture.enable_auto_end_date
  @fixture.bridge
  Scenario: [BQ-BRG-06] Bridge on one hub and two links; Test 6
