...
SELECT 
	...
	CASE WHEN SNOWFLAKE_SAMPLE_DATA.TPCH_SF10.LINEITEM.L_SHIPDATE > 'DATE' THEN NULL ELSE SNOWFLAKE_SAMPLE_DATA.TPCH_SF10.LINEITEM.L_SHIPDATE END AS L_SHIPDATE,
	SNOWFLAKE_SAMPLE_DATA.TPCH_SF10.LINEITEM.L_COMMITDATE,
	CASE WHEN SNOWFLAKE_SAMPLE_DATA.TPCH_SF10.LINEITEM.L_RECEIPTDATE > 'DATE' THEN NULL ELSE SNOWFLAKE_SAMPLE_DATA.TPCH_SF10.LINEITEM.L_RECEIPTDATE END AS L_RECEIPTDATE,
...
WHERE SNOWFLAKE_SAMPLE_DATA.TPCH_SF10.ORDERS.O_ORDERDATE < 'DATE';