...
#      | md5('1001') | 2018-06-01 00:00:00.000 | Tablet      | md5('TABLET\|\|2018-06-01 00:00:00.000') | 2018-06-01 00:00:00.020 | 2018-06-01 00:00:00.020 | *      |
#      | md5('1001') | 2018-06-01 00:00:00.010 | Laptop      | md5('LAPTOP\|\|2018-06-01 00:00:00.010') | 2018-06-01 00:00:00.020 | 2018-06-01 00:00:00.020 | *      |
#      | md5('1001') | 2018-06-01 00:00:00.020 | Phone       | md5('PHONE\|\|2018-06-01 00:00:00.020')  | 2018-06-01 12:00:00.010 | 2018-06-01 12:00:00.010 | *      |
#      | md5('1002') | 2018-06-01 00:00:00.000 | Tablet      | md5('TABLET\|\|2018-06-01 00:00:00.000') | 2018-06-01 00:00:00.010 | 2018-06-01 00:00:00.010 | *      |
#      | md5('1002') | 2018-06-01 00:00:00.010 | Phone       | md5('PHONE\|\|2018-06-01 00:00:00.010')  | 2018-06-01 12:00:00.010 | 2018-06-01 12:00:00.010 | *      |
#      | md5('1002') | 2018-06-01 00:00:00.020 | Tablet      | md5('TABLET\|\|2018-06-01 00:00:00.020')  | 2018-06-02 00:00:00.000 | 2018-06-02 00:00:00.000 | *      |
#      | md5('1003') | 2018-06-01 00:00:00.000 | Phone       | md5('PHONE\|\|2018-06-01 00:00:00.000')  | 2018-06-01 23:59:59.996 | 2018-06-01 23:59:59.996 | *      |
#      | md5('1003') | 2018-06-01 00:00:00.010 | Tablet      | md5('TABLET\|\|2018-06-01 00:00:00.010') | 2018-06-01 23:59:59.996 | 2018-06-01 23:59:59.996 | *      |
#      | md5('1003') | 2018-06-01 00:00:00.020 | Laptop      | md5('LAPTOP\|\|2018-06-01 00:00:00.020') | 2018-06-01 23:59:59.996 | 2018-06-01 23:59:59.996 | *      |
...
#      | md5('1003') | 2018-06-01 00:00:00.000000 | Phone       | md5('PHONE\|\|2018-06-01 00:00:00.000000')  | 2018-06-01 23:59:59.996996 | 2018-06-01 23:59:59.996996 | *      |
#      | md5('1003') | 2018-06-01 00:00:00.000001 | Tablet      | md5('TABLET\|\|2018-06-01 00:00:00.000001') | 2018-06-01 23:59:59.996996 | 2018-06-01 23:59:59.996996 | *      |
#      | md5('1003') | 2018-06-01 00:00:00.000002 | Laptop      | md5('LAPTOP\|\|2018-06-01 00:00:00.000002') | 2018-06-01 23:59:59.996996 | 2018-06-01 23:59:59.996996 | *      |
    And the AS_OF_DATE table is created and populated with data
      | AS_OF_DATE              |
...
#      | md5('1002') | 1002        | 2018-06-01 00:00:00.000000 | *      |
#      | md5('1003') | 1003        | 2018-06-01 00:00:00.000000 | *      |
#      | md5('1004') | 1004        | 2018-06-02 23:59:59.996996 | *      |
#    Then the SAT_CUSTOMER_DETAILS_TS table should contain expected data
#      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_ADDRESS          | CUSTOMER_DOB | HASHDIFF                                               | EFFECTIVE_FROM             | LOAD_DATE                  | SOURCE |
#      | md5('1001') | Alice         | 1 Forrest road Hampshire  | 1997-04-24   | md5('1 FORREST ROAD HAMPSHIRE\|\|1997-04-24\|\|ALICE') | 2018-06-01 00:00:00.000000 | 2018-06-01 00:00:00.000000 | *      |
#      | md5('1002') | Bob           | 2 Forrest road Hampshire  | 2006-04-17   | md5('2 FORREST ROAD HAMPSHIRE\|\|2006-04-17\|\|BOB')   | 2018-06-01 00:00:00.000000 | 2018-06-01 00:00:00.000000 | *      |
...
#      | md5('1004') | Dom           | 4 Forrest road Hampshire  | 1950-01-01   | md5('4 FORREST ROAD HAMPSHIRE\|\|1950-01-01\|\|DOM')   | 2018-06-02 23:59:59.996996 | 2018-06-02 23:59:59.996996 | *      |
#    Then the SAT_CUSTOMER_LOGIN_TS table should contain expected data
#      | CUSTOMER_PK | LAST_LOGIN_DATE            | DEVICE_USED | HASHDIFF                                    | EFFECTIVE_FROM             | LOAD_DATE                  | SOURCE |
#      | md5('1001') | 2018-06-01 00:00:00.000000 | Tablet      | md5('TABLET\|\|2018-06-01 00:00:00.000000') | 2018-06-01 00:00:00.000002 | 2018-06-01 00:00:00.000002 | *      |
#      | md5('1001') | 2018-06-01 00:00:00.000001 | Laptop      | md5('LAPTOP\|\|2018-06-01 00:00:00.000001') | 2018-06-01 00:00:00.000002 | 2018-06-01 00:00:00.000002 | *      |
...
#      | md5('1004') | 2018-06-02 12:00:00.000002 | Phone       | md5('PHONE\|\|2018-06-02 12:00:00.000002')  | 2018-06-02 23:59:59.996996 | 2018-06-02 23:59:59.996996 | *      |
    Then the PIT_CUSTOMER_TS table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_TS_PK | SAT_CUSTOMER_DETAILS_TS_LDTS | SAT_CUSTOMER_LOGIN_TS_PK | SAT_CUSTOMER_LOGIN_TS_LDTS |
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001')                | 2018-06-01 00:00:00.000      | md5('1001')              | 2018-06-01 12:00:00.010    |
      | md5('1001') | 2018-06-02 12:00:00.000 | md5('1001')                | 2018-06-01 00:00:00.000      | md5('1001')              | 2018-06-01 12:00:00.010    |
