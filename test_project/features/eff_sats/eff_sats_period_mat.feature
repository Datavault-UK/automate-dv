...
#    And I insert by period into the EFF_SAT eff_sat by day
  ...
  # TODO: failing; instead of creating a 4000/CCC closing record (with the new 5000/CCC) it creates a 3000/CCC closing record
  # Dates are correct, but CUSTOMER_ORDER_PK, CUSTOMER_PK and ORDER_PK are wrongly inferred
  @fixture.enable_auto_end_date
  @fixture.eff_satellite
  Scenario: [INCREMENTAL-LOAD] Loading data into a populated eff sat; driving key is ORDER_PK
