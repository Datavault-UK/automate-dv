Feature: [SF-EFH-DAU] Effectivity Satellites without automatic end-dating

  @fixture.eff_satellite_hashdiff
  Scenario: [SF-EFH-DAU-01] Link is Changed with auto end-dating off
  ...
  @fixture.eff_satellite_hashdiff
  Scenario: [SF-EFH-DAU-02] 2 loads, Link is Changed Back Again with auto end-dating off
    Given the EFF_SAT eff_sat_hashdiff is already populated with data
