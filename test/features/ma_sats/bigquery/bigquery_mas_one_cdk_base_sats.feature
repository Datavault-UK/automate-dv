Feature: [BQ-MAS-1CD] Multi Active Satellites
  Base satellite behaviour with one CDK

  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-001] Load data into a non-existent multi-active satellite
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-002] Load duplicated data into a non-existent multi-active satellite
    Given the MULTI_ACTIVE_SATELLITE table does not exist
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-003] Load data into an empty multi-active satellite
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-004] Load data into an empty multi-active satellite where some records have NULL PK(s), CDK(s) and Attribute(s)
    Given the MULTI_ACTIVE_SATELLITE ma_sat is empty
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-005] Load duplicated data into an empty multi-active satellite
    Given the MULTI_ACTIVE_SATELLITE ma_sat is empty
    And the RAW_STAGE table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-006] Load data into a populated multi-active satellite where all records load
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-007] Load data into a populated satellite where either the PK(s) or the CDK(s) are NULL - with existent PK(s)/CDK(s)
    Given the MULTI_ACTIVE_SATELLITE ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | HASHDIFF                                | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-008] Load data into a populated satellite where either the PK(s) or the CDK(s) are NULL - with new PK(s)/CDK(s)
    Given the MULTI_ACTIVE_SATELLITE ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | HASHDIFF                                | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1004') | Dom           | 17-214-233-1214 | md5('1004\|\|DOM\|\|17-214-233-1214')   | 1993-01-01     | 1993-01-01 | *      |
      | md5('1006') | Frida         | 17-214-233-1216 | md5('1006\|\|FRIDA\|\|17-214-233-1216') | 1993-01-01     | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-009] Load data into a populated satellite where the stage records include NULL PK(s) and NULL CDK(s)
    Given the MULTI_ACTIVE_SATELLITE ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | HASHDIFF                                | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1004') | Dom           | 17-214-233-1214 | md5('1004\|\|DOM\|\|17-214-233-1214')   | 1993-01-01     | 1993-01-01 | *      |
      | md5('1006') | Frida         | 17-214-233-1216 | md5('1006\|\|FRIDA\|\|17-214-233-1216') | 1993-01-01     | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [BQ-MAS-1CD-010] Load data into a populated multi-active satellite where some records overlap
    Given the MULTI_ACTIVE_SATELLITE ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | HASHDIFF                                | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1002') | Bob           | 17-214-233-1215 | md5('1002\|\|BOB\|\|17-214-233-1215')   | 1993-01-01     | 1993-01-01 | *      |
      | md5('1003') | Chad          | 17-214-233-1216 | md5('1003\|\|CHAD\|\|17-214-233-1216')  | 1993-01-01     | 1993-01-01 | *      |
