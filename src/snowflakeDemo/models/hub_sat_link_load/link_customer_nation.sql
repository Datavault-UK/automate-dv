...
{% set link_columns = 'CAST(stg.LINK_CUSTOMER_NATION_PK AS BINARY(16)) AS LINK_CUSTOMER_NATION_PK, 
...
{% set stg_columns1 = 'b.LINK_CUSTOMER_NATION_PK, 
b.CUSTOMER_PK, 
b.CUSTOMER_NATION_PK, 
b.LOADDATE, 
b.SOURCE' %}
{% set stg_columns2 = 'a.LINK_CUSTOMER_NATION_PK, 
a.CUSTOMER_PK, 
