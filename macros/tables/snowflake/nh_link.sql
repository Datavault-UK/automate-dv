...
{%- macro nh_link(src_pk, src_fk, src_payload, src_extra_columns, src_eff, src_ldts, src_source, source_model) -%}
    ...
    {{ adapter.dispatch('nh_link', 'automate_dv')(src_pk=src_pk, src_fk=src_fk, src_payload=src_payload,
...
{%- macro default__nh_link(src_pk, src_fk, src_payload, src_extra_columns, src_eff, src_ldts, src_source, source_model) -%}
