Feature: [MAS-1CD-C] Multi Active Satellites
  ...
  Scenario: [MAS-1CD-C-001] Load over several cycles
  ...
  @fixture.multi_active_satellite_cycle
  @fixture.enable_sha
  Scenario: [MAS-1CD-C-002] Load over several cycles
    Given the RAW_STAGE stage is empty
    And the MULTI_ACTIVE_SATELLITE ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-003] Load over several cycles with sets of records keeping the group size the same while having one or more records changed
    Given the RAW_STAGE stage is empty
    And the MULTI_ACTIVE_SATELLITE ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-004] Load over several cycles with NULL records
    Given the RAW_STAGE stage is empty
    And the MULTI_ACTIVE_SATELLITE ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-005] Load over several cycles with a mix of record change cases
    Given the RAW_STAGE stage is empty
    And the MULTI_ACTIVE_SATELLITE ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  @fixture.enable_sha
  Scenario: [MAS-1CD-C-006] Load over several cycles
    Given the RAW_STAGE stage is empty
    And the MULTI_ACTIVE_SATELLITE ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-007] 1-day cycle
    Given the RAW_STAGE stage is empty
    And the MULTI_ACTIVE_SATELLITE ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-008] 2-day cycle
    Given the RAW_STAGE stage is empty
    And the MULTI_ACTIVE_SATELLITE ma_sat is empty
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [MAS-1CD-C-009] 3-day cycle
    Given the RAW_STAGE stage is empty
    And the MULTI_ACTIVE_SATELLITE ma_sat is empty
