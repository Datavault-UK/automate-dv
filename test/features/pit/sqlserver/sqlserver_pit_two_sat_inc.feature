Feature: [SQLS-PIT-2SI] Point in Time
  Base PIT behaviour with one hub and two satellites - Incremental Loads

  # DATES
  @fixture.pit_two_sats
  Scenario: [SQLS-PIT-2SI-01] Incremental load with the more recent AS OF dates into an already populated pit table from two satellites with dates
  ...
  # TIMESTAMPS
  @fixture.pit_two_sats
  Scenario: [SQLS-PIT-2SI-02] Incremental load with the more recent AS OF timestamps into an already populated pit table from two satellites with timestamps
    ...
    Then the PIT_CUSTOMER_TS table should contain expected data
      ...
      | md5('1001') | 2018-06-01 12:00:00.000 | md5('1001')                | 2018-06-01 00:00:00.000      | md5('1001')              | 2018-06-01 00:00:00.020    |
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001')                | 2018-06-01 00:00:00.000      | md5('1001')              | 2018-06-01 12:00:00.010    |
      | md5('1001') | 2018-06-02 12:00:00.000 | md5('1001')                | 2018-06-01 00:00:00.000      | md5('1001')              | 2018-06-01 12:00:00.010    |
      ...
      | md5('1002') | 2018-06-01 12:00:00.000 | md5('1002')                | 2018-06-01 00:00:00.000      | md5('1002')              | 2018-06-01 00:00:00.010    |
      | md5('1002') | 2018-06-02 00:00:00.000 | md5('1002')                | 2018-06-01 23:59:59.996      | md5('1002')              | 2018-06-02 00:00:00.000    |
      | md5('1002') | 2018-06-02 12:00:00.000 | md5('1002')                | 2018-06-01 23:59:59.996      | md5('1002')              | 2018-06-02 00:00:00.000    |
      ...
      | md5('1003') | 2018-06-02 12:00:00.000 | md5('1003')                | 2018-06-01 23:59:59.996      | md5('1003')              | 2018-06-01 23:59:59.996    |
    ...
    Then the PIT_CUSTOMER_TS table should contain expected data
      ...
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001')                | 2018-06-01 00:00:00.000      | md5('1001')              | 2018-06-01 12:00:00.010    |
      | md5('1001') | 2018-06-02 12:00:00.000 | md5('1001')                | 2018-06-01 00:00:00.000      | md5('1001')              | 2018-06-01 12:00:00.010    |
      | md5('1001') | 2018-06-03 00:00:00.000 | md5('1001')                | 2018-06-02 12:00:00.010      | md5('1001')              | 2018-06-02 12:00:00.010    |
      | md5('1002') | 2018-06-02 00:00:00.000 | md5('1002')                | 2018-06-01 23:59:59.996      | md5('1002')              | 2018-06-02 00:00:00.000    |
      | md5('1002') | 2018-06-02 12:00:00.000 | md5('1002')                | 2018-06-01 23:59:59.996      | md5('1002')              | 2018-06-02 00:00:00.000    |
      | md5('1002') | 2018-06-03 00:00:00.000 | md5('1002')                | 2018-06-01 23:59:59.996      | md5('1002')              | 2018-06-02 00:00:00.000    |
      | md5('1003') | 2018-06-02 00:00:00.000 | md5('1003')                | 2018-06-01 23:59:59.996      | md5('1003')              | 2018-06-02 00:00:00.000    |
      | md5('1003') | 2018-06-02 12:00:00.000 | md5('1003')                | 2018-06-01 23:59:59.996      | md5('1003')              | 2018-06-02 00:00:00.000    |
      | md5('1003') | 2018-06-03 00:00:00.000 | md5('1003')                | 2018-06-01 23:59:59.996      | md5('1003')              | 2018-06-02 00:00:00.000    |
  ...
  @fixture.pit_two_sats
  Scenario: [SQLS-PIT-2SI-03] Incremental load with the more recent AS OF dates into an already populated pit table from two satellites with timestamps
    ...
    Then the PIT_CUSTOMER_LG table should contain expected data
      | CUSTOMER_PK | AS_OF_DATE              | SAT_CUSTOMER_DETAILS_TS_PK | SAT_CUSTOMER_DETAILS_TS_LDTS | SAT_CUSTOMER_LOGIN_TS_PK | SAT_CUSTOMER_LOGIN_TS_LDTS |
      | md5('1001') | 2018-06-01 00:00:00.000 | md5('1001')                | 2018-06-01 00:00:00.000      | 0000000000000000         | 1900-01-01 00:00:00.000    |
      | md5('1001') | 2018-06-02 00:00:00.000 | md5('1001')                | 2018-06-01 12:00:00.010      | md5('1001')              | 2018-06-01 12:00:00.010    |
      | md5('1001') | 2018-06-03 00:00:00.000 | md5('1001')                | 2018-06-01 12:00:00.010      | md5('1001')              | 2018-06-02 00:00:00.010    |
      | md5('1002') | 2018-06-01 00:00:00.000 | md5('1002')                | 2018-06-01 00:00:00.000      | 0000000000000000         | 1900-01-01 00:00:00.000    |
      | md5('1002') | 2018-06-02 00:00:00.000 | md5('1002')                | 2018-06-01 23:59:59.996      | md5('1002')              | 2018-06-02 00:00:00.000    |
      | md5('1002') | 2018-06-03 00:00:00.000 | md5('1002')                | 2018-06-01 23:59:59.996      | md5('1002')              | 2018-06-02 00:00:00.000    |
      | md5('1003') | 2018-06-01 00:00:00.000 | md5('1003')                | 2018-06-01 00:00:00.000      | 0000000000000000         | 1900-01-01 00:00:00.000    |
  ...
  @fixture.pit_two_sats
  Scenario: [SQLS-PIT-2SI-04] Incremental load with the more recent AS OF timestamps into an already populated pit table from two satellites with dates
    ...
    Then the PIT_CUSTOMER_HG table should contain expected data
      ...
      | md5('1001') | 2018-06-02 23:59:59.996 | md5('1001')             | 2018-06-01 00:00:00.000   | md5('1001')           | 2018-06-02 00:00:00.000 |
      ...
      | md5('1002') | 2018-06-02 23:59:59.996 | md5('1002')             | 2018-06-01 00:00:00.000   | md5('1002')           | 2018-06-02 00:00:00.000 |
      ...
      | md5('1003') | 2018-06-02 23:59:59.996 | md5('1003')             | 2018-06-02 00:00:00.000   | md5('1003')           | 2018-06-01 00:00:00.000 |
