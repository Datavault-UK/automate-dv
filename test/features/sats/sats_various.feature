Feature: [SAT-PM-V] Satellite loads with period materialization using various time scales
  ...
  Scenario: [SAT-PM-V-01] Satellite load with microsecond interval will return an error.
    ...
    And if I insert by period into the SATELLITE_TZ sat by microsecond with LDTS LOAD_DATE_TZ this will fail with "This datepart" error
  ...
  Scenario: [SAT-PM-V-02] Satellite load with millisecond interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by millisecond with date range: 2019-05-03 01:00:00.000000 to 2019-05-03 01:00:00.009000 and LDTS LOAD_DATE_TZ
  ...
  Scenario: [SAT-PM-V-03] Satellite load with second interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by second with date range: 2019-05-03 01:00:00.000000 to 2019-05-03 01:00:10.000000 and LDTS LOAD_DATE_TZ
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-04] Satellite load with minute interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by minute with date range: 2019-05-03 01:00:00.000000 to 2019-05-03 01:11:00.000000 and LDTS LOAD_DATE_TZ
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-05] Satellite load with week interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by week with date range: 2019-05-03 01:00:00.000000 to 2019-05-24 01:10:00.000000 and LDTS LOAD_DATE_TZ
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
    And I insert by period into the SATELLITE_TZ sat by week with date range: 2019-05-03 01:00:00.000000 to 2019-05-24 01:00:00.000000 and LDTS LOAD_DATE_TZ
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                                | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214')  | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')    | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-06] Satellite load with month interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by month with date range: 2019-05-03 01:00:00.000000 to 2019-07-03 01:00:00.000000 and LDTS LOAD_DATE_TZ
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-07] Satellite load with quarter interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by quarter with date range: 2019-05-03 01:00:00.000000 to 2020-05-03 01:00:00.000000 and LDTS LOAD_DATE_TZ
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
  ...
  Scenario: [SAT-PM-V-08] Satellite load with yearly interval and intra-load duplicates.
    ...
    And I stage the STG_CUSTOMER_TZ data
    And I insert by period into the SATELLITE_TZ sat by year with date range: 2019-05-03 01:00:00.000000 to 2022-05-03 01:00:00.000000 and LDTS LOAD_DATE_TZ
    Then the SATELLITE_TZ table should contain expected data
      | CUSTOMER_PK | HASHDIFF                                               | CUSTOMER_NAME | CUSTOMER_DOB | CUSTOMER_PHONE  | EFFECTIVE_FROM_TZ          | LOAD_DATE_TZ               | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT\|\|17-214-233-1214') | Albert        | 1990-02-03   | 17-214-233-1214 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
      | md5('1002') | md5('1995-08-07\|\|1002\|\|BETH\|\|17-214-233-1215')   | Beth          | 1995-08-07   | 17-214-233-1215 | 2019-05-03 01:00:00.000000 | 2019-05-03 01:00:00.000000 | *      |
