Feature: [SF-SAT-PMI] Satellites Loaded using Period Materialization and inferred date ranges

  @fixture.satellite_cycle
  Scenario: [SF-SAT-PMI-001] Satellite load over several daily cycles with insert_by_period into non-existent satellite
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-PMI-002] Satellite load over several daily cycles with insert_by_period into empty satellite.
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-PMI-003] Satellite load over several daily cycles with insert_by_period into populated satellite, with partial duplicates.
    Given the RAW_STAGE stage is empty
  ...
  @fixture.satellite_cycle
  Scenario: [SF-SAT-PMI-004] Satellite load over several daily cycles with insert_by_period into populated satellite, with all duplicates.
    Given the RAW_STAGE stage is empty
    And the SATELLITE sat is already populated with data
      | CUSTOMER_PK | HASHDIFF                             | CUSTOMER_NAME | CUSTOMER_DOB | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1001') | md5('1990-02-03\|\|1001\|\|ALBERT')  | Albert        | 1990-02-03   | 2019-05-04     | 2019-05-04 | *      |
