Feature: [BQ-MAS-2CD-BSC] Multi Active Satellites
  ...
  Scenario: [BQ-MAS-2CD-BSC-01] Load over several cycles
  ...
  @fixture.multi_active_satellite_cycle
  Scenario: [BQ-MAS-2CD-BSC-02] Load over several cycles with Timestamps
  ...
  @fixture.multi_active_satellite_cycle
  @fixture.enable_sha
  Scenario: [BQ-MAS-2CD-BSC-03] Load over several cycles
    Given the RAW_STAGE_TWO_CDK stage is empty
    And the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is empty
