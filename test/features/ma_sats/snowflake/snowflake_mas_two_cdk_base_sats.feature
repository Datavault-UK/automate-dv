Feature: [SF-MAS-2CD] Multi Active Satellites
  ...
  Scenario: [SF-MAS-2CD-01] Load data into a non-existent multi-active satellite
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-02] Load duplicated data into a non-existent multi-active satellite
    Given the MULTI_ACTIVE_SATELLITE_TWO_CDK table does not exist
    And the RAW_STAGE_TWO_CDK table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | EXTENSION | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 123       | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-03] Load data into an empty multi-active satellite
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-04] Load duplicated data into an empty multi-active satellite
    Given the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is empty
    And the RAW_STAGE_TWO_CDK table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | EXTENSION | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 123       | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-05] Load data into an empty multi-active satellite where some records have NULL PK(s), CDK(s) and Attribute(s)
    Given the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is empty
    And the RAW_STAGE_TWO_CDK table contains data
      | CUSTOMER_ID | CUSTOMER_NAME | CUSTOMER_PHONE  | EXTENSION | LOAD_DATE  | SOURCE |
      | 1001        | Alice         | 17-214-233-1214 | 123       | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-06] Load data into a populated multi-active satellite where all records load
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-07] Load data into a populated multi-active satellite where some records overlap
    Given the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | EXTENSION | HASHDIFF                                       | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1002') | Bob           | 17-214-233-1215 | 123       | md5('1002\|\|BOB\|\|17-214-233-1215\|\|123')   | 1993-01-01     | 1993-01-01 | *      |
      | md5('1003') | Chad          | 17-214-233-1216 | 123       | md5('1003\|\|CHAD\|\|17-214-233-1216\|\|123')  | 1993-01-01     | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-08] Load data into a populated satellite where either the PK(s) or the CDK(s) are NULL - with existent PK(s)/CDK(s)
    Given the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | EXTENSION | HASHDIFF                                       | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-09] Load data into a populated satellite where either the PK(s) or the CDK(s) are NULL - with new PK(s)/CDK(s)
    Given the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | EXTENSION | HASHDIFF                                       | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1004') | Dom           | 17-214-233-1214 | 123       | md5('1004\|\|DOM\|\|17-214-233-1214\|\|123')   | 1993-01-01     | 1993-01-01 | *      |
      | md5('1006') | Frida         | 17-214-233-1216 | 123       | md5('1006\|\|FRIDA\|\|17-214-233-1216\|\|123') | 1993-01-01     | 1993-01-01 | *      |
  ...
  @fixture.multi_active_satellite
  Scenario: [SF-MAS-2CD-010] Load data into a populated satellite where the stage records include NULL PK(s) and NULL CDK(s)
    Given the MULTI_ACTIVE_SATELLITE_TWO_CDK ma_sat is already populated with data
      | CUSTOMER_PK | CUSTOMER_NAME | CUSTOMER_PHONE  | EXTENSION | HASHDIFF                                       | EFFECTIVE_FROM | LOAD_DATE  | SOURCE |
      | md5('1004') | Dom           | 17-214-233-1214 | 123       | md5('1004\|\|DOM\|\|17-214-233-1214\|\|123')   | 1993-01-01     | 1993-01-01 | *      |
      | md5('1006') | Frida         | 17-214-233-1216 | 123       | md5('1006\|\|FRIDA\|\|17-214-233-1216\|\|123') | 1993-01-01     | 1993-01-01 | *      |
