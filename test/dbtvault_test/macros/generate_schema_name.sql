...
{% macro default__get_schema_name() -%}
    ...
    {%- set schema_name = "{}_{}{}".format(target.schema, target.user, dbtvault.pipeline_string()) -%}
...
{%- macro bigquery__get_schema_name() -%}
    ...
    {%- set schema_name = "{}_{}{}".format(target.dataset, target.project, dbtvault.pipeline_string())  -%}
