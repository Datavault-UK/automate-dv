...
latest_open AS (
    ...
    WHERE {{ dbtvault.cast_date(dbtvault.alias(src_end_date, 'c')) }} = {{ dbtvault.cast_date(dbtvault.cast_datetime(max_datetime, as_string=true)) }}
),
...
latest_closed AS (
    ...
    WHERE {{ dbtvault.cast_date(dbtvault.alias(src_end_date, 'd')) }} != {{ dbtvault.cast_date(dbtvault.cast_datetime(max_datetime, as_string=true)) }}
),
...
new_reopened_records AS (
    ...
    WHERE {{ dbtvault.cast_date(dbtvault.alias(src_end_date, 'g')) }} = {{ dbtvault.cast_date(dbtvault.cast_datetime(max_datetime, as_string=true)) }}
),
...
new_closed_records AS (
    ...
    WHERE {{ dbtvault.cast_date(dbtvault.alias(src_end_date, 'h')) }} != {{ dbtvault.cast_date(dbtvault.cast_datetime(max_datetime, as_string=true)) }}
