...
{% set sat_columns = 'CAST(stg.CUSTOMER_HASHDIFF AS BINARY(16)) AS CUSTOMER_HASHDIFF, 
CAST(stg.CUSTOMER_PK AS BINARY(16)) AS CUSTOMER_PK, 
CAST(stg.CUSTOMER_NAME AS VARCHAR(25)) AS CUSTOMER_NAME, 
CAST(stg.CUSTOMER_ADDRESS AS VARCHAR(40)) AS CUSTOMER_ADDRESS, 
CAST(stg.CUSTOMER_PHONE AS VARCHAR(15)) AS CUSTOMER_PHONE, 
CAST(stg.CUSTOMER_ACCBAL AS NUMBER(12,2)) AS CUSTOMER_ACCBAL, 
CAST(stg.CUSTOMER_MKTSEGMENT AS VARCHAR(10)) AS CUSTOMER_MKTSEGMENT, 
CAST(stg.CUSTOMER_COMMENT AS VARCHAR(117)) AS CUSTOMER_COMMENT, 
...
{% set stg_columns1 = 'b.CUSTOMER_HASHDIFF, 
b.CUSTOMER_PK, 
b.CUSTOMER_NAME, 
b.CUSTOMER_ADDRESS, 
b.CUSTOMER_PHONE, 
...
b.EFFECTIVE_FROM, 
b.SOURCE' %}
{% set stg_columns2 = 'a.CUSTOMER_HASHDIFF, 
a.CUSTOMER_PK, 
a.CUSTOMER_NAME, 
a.CUSTOMER_ADDRESS, 
a.CUSTOMER_PHONE, 
