...
, MD5_BINARY(CONCAT(
    IFNULL(UPPER(TRIM(CAST(a.SUPPLIER_NATION_KEY AS VARCHAR))), '^^'), '||',
    IFNULL(UPPER(TRIM(CAST(a.SUPPLIER_REGION_KEY AS VARCHAR))), '^^'))) AS LINK_SUPPLIER_NATION_REGION_PK
, MD5_BINARY(CONCAT(
    IFNULL(UPPER(TRIM(CAST(a.SUPPLIERKEY AS VARCHAR))), '^^'), '||',
    IFNULL(UPPER(TRIM(CAST(a.SUPPLIER_NATION_KEY AS VARCHAR))), '^^'))) AS LINK_SUPPLIER_NATION_PK
, MD5_BINARY(CONCAT(
