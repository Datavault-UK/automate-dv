...
{% set sat_columns = 'CAST(stg.REGION_HASHDIFF AS BINARY(16)) AS REGION_HASHDIFF, 
CAST(stg.REGION_PK AS BINARY(16)) AS REGION_PK, 
CAST(stg.REGION_NAME AS VARCHAR(25)) AS REGION_NAME, 
CAST(stg.REGION_COMMENT AS VARCHAR(152)) AS REGION_COMMENT, 
...
{% set stg_columns1 = 'b.REGION_HASHDIFF, 
b.REGION_PK, 
b.REGION_NAME, 
b.REGION_COMMENT, 
b.LOADDATE, 
b.EFFECTIVE_FROM, 
b.SOURCE' %}
{% set stg_columns2 = 'a.REGION_HASHDIFF, 
a.REGION_PK, 
a.REGION_NAME, 
a.REGION_COMMENT, 
a.LOADDATE, 
